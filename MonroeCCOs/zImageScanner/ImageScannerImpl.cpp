...
char g_ControlDescription[] = "OPOS ImageScanner Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSImageScanner::s_nInstances = 0;
...
// Release 1.11 methods
    ...
    "StartSession",
        #define nDIStartSession 18
    "StopSession",
        #define nDIStopSession 19
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS ImageScanner.
//===========================================================================
...
const int MinorReleaseInitial = 11;
...
COPOSImageScanner::COPOSImageScanner()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSImageScanner >(this) )
{
}

//===========================================================================

HRESULT COPOSImageScanner::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSImageScanner::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSImageScanner::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSIMAGESCANNER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSImageScanner::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSImageScanner::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSImageScanner::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSImageScanner::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSImageScanner::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_IMG );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_IMG), hRC );
...
STDMETHODIMP COPOSImageScanner::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSImageScanner::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSImageScanner::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSImageScanner::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSImageScanner::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSImageScanner::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSImageScanner::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSImageScanner::ResetStatistics( 
...
STDMETHODIMP COPOSImageScanner::RetrieveStatistics( 
...
STDMETHODIMP COPOSImageScanner::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSImageScanner::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSImageScanner::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSImageScanner::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSImageScanner::StartSession( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("StartSession") S_OK, NULL, 0, nDIStartSession, pRC );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::StopSession( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("StopSession") S_OK, NULL, 0, nDIStopSession, pRC );
}
...
STDMETHODIMP COPOSImageScanner::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSImageScanner::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSImageScanner::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSImageScanner::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSImageScanner::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSImageScanner::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSImageScanner::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSImageScanner::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
    return GetOposProp( DEBUGPARAM("AutoDisable") PIDX_AutoDisable, pAutoDisable, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
    return SetOposProp( DEBUGPARAM("AutoDisable") PIDX_AutoDisable, AutoDisable, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
    return GetOposProp( DEBUGPARAM("BinaryConversion") PIDX_BinaryConversion, pBinaryConversion, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
    IFDEBUG( _nBinaryConversion = BinaryConversion);
    return SetOposProp( DEBUGPARAM("BinaryConversion") PIDX_BinaryConversion, BinaryConversion, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
    return GetOposProp( DEBUGPARAM("CapPowerReporting") PIDX_CapPowerReporting, pCapPowerReporting, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
    return GetOposProp( DEBUGPARAM("CheckHealthText") PIDX_CheckHealthText, pCheckHealthText, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
    return GetOposProp( DEBUGPARAM("Claimed") PIDX_Claimed, pClaimed, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
    return GetOposProp( DEBUGPARAM("DataCount") PIDX_DataCount, pDataCount, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
    return GetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, pDataEventEnabled, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
    return SetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, DataEventEnabled, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
    return GetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, pDeviceEnabled, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
    return SetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, DeviceEnabled, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
    return GetOposProp( DEBUGPARAM("PowerNotify") PIDX_PowerNotify, pPowerNotify, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
    return SetOposProp( DEBUGPARAM("PowerNotify") PIDX_PowerNotify, PowerNotify, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
    return GetOposProp( DEBUGPARAM("PowerState") PIDX_PowerState, pPowerState, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
    return GetOposProp( DEBUGPARAM("ResultCodeExtended") PIDX_ResultCodeExtended, pResultCodeExtended, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectDescription") PIDX_ServiceObjectDescription, pServiceObjectDescription, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectVersion") PIDX_ServiceObjectVersion, pServiceObjectVersion, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
    return GetOposProp( DEBUGPARAM("DeviceDescription") PIDX_DeviceDescription, pDeviceDescription, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
    return GetOposProp( DEBUGPARAM("DeviceName") PIDX_DeviceName, pDeviceName, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
    return GetOposProp( DEBUGPARAM("CapStatisticsReporting") PIDX_CapStatisticsReporting, pCapStatisticsReporting, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
    return GetOposProp( DEBUGPARAM("CapUpdateStatistics") PIDX_CapUpdateStatistics, pCapUpdateStatistics, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
    return GetOposProp( DEBUGPARAM("CapCompareFirmwareVersion") PIDX_CapCompareFirmwareVersion, pCapCompareFirmwareVersion, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
    return GetOposProp( DEBUGPARAM("CapUpdateFirmware") PIDX_CapUpdateFirmware, pCapUpdateFirmware, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapAim( /*[out, retval]*/ VARIANT_BOOL* pCapAim )
{
    return GetOposProp( DEBUGPARAM("CapAim") PIDXImg_CapAim, pCapAim, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapDecodeData( /*[out, retval]*/ VARIANT_BOOL* pCapDecodeData )
{
    return GetOposProp( DEBUGPARAM("CapDecodeData") PIDXImg_CapDecodeData, pCapDecodeData, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapHostTriggered( /*[out, retval]*/ VARIANT_BOOL* pCapHostTriggered )
{
    return GetOposProp( DEBUGPARAM("CapHostTriggered") PIDXImg_CapHostTriggered, pCapHostTriggered, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapIlluminate( /*[out, retval]*/ VARIANT_BOOL* pCapIlluminate )
{
    return GetOposProp( DEBUGPARAM("CapIlluminate") PIDXImg_CapIlluminate, pCapIlluminate, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapImageData( /*[out, retval]*/ VARIANT_BOOL* pCapImageData )
{
    return GetOposProp( DEBUGPARAM("CapImageData") PIDXImg_CapImageData, pCapImageData, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapImageQuality( /*[out, retval]*/ VARIANT_BOOL* pCapImageQuality )
{
    return GetOposProp( DEBUGPARAM("CapImageQuality") PIDXImg_CapImageQuality, pCapImageQuality, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_CapVideoData( /*[out, retval]*/ VARIANT_BOOL* pCapVideoData )
{
    return GetOposProp( DEBUGPARAM("CapVideoData") PIDXImg_CapVideoData, pCapVideoData, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_AimMode( /*[out, retval]*/ VARIANT_BOOL* pAimMode )
{
    return GetOposProp( DEBUGPARAM("AimMode") PIDXImg_AimMode, pAimMode, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_AimMode( /*[in]*/ VARIANT_BOOL AimMode )
{
    return SetOposProp( DEBUGPARAM("AimMode") PIDXImg_AimMode, AimMode, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_BitsPerPixel( /*[out, retval]*/ LONG* pBitsPerPixel )
{
    return GetOposProp( DEBUGPARAM("BitsPerPixel") PIDXImg_BitsPerPixel, pBitsPerPixel, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_FrameData( /*[out, retval]*/ BSTR* pFrameData )
{
    return GetOposProp( DEBUGPARAM("FrameData") PIDXImg_FrameData, pFrameData, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_FrameType( /*[out, retval]*/ LONG* pFrameType )
{
    return GetOposProp( DEBUGPARAM("FrameType") PIDXImg_FrameType, pFrameType, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_IlluminateMode( /*[out, retval]*/ VARIANT_BOOL* pIlluminateMode )
{
    return GetOposProp( DEBUGPARAM("IlluminateMode") PIDXImg_IlluminateMode, pIlluminateMode, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_IlluminateMode( /*[in]*/ VARIANT_BOOL IlluminateMode )
{
    return SetOposProp( DEBUGPARAM("IlluminateMode") PIDXImg_IlluminateMode, IlluminateMode, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ImageHeight( /*[out, retval]*/ LONG* pImageHeight )
{
    return GetOposProp( DEBUGPARAM("ImageHeight") PIDXImg_ImageHeight, pImageHeight, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ImageLength( /*[out, retval]*/ LONG* pImageLength )
{
    return GetOposProp( DEBUGPARAM("ImageLength") PIDXImg_ImageLength, pImageLength, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ImageMode( /*[out, retval]*/ LONG* pImageMode )
{
    return GetOposProp( DEBUGPARAM("ImageMode") PIDXImg_ImageMode, pImageMode, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_ImageMode( /*[in]*/ LONG ImageMode )
{
    return SetOposProp( DEBUGPARAM("ImageMode") PIDXImg_ImageMode, ImageMode, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ImageQuality( /*[out, retval]*/ LONG* pImageQuality )
{
    return GetOposProp( DEBUGPARAM("ImageQuality") PIDXImg_ImageQuality, pImageQuality, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_ImageQuality( /*[in]*/ LONG ImageQuality )
{
    return SetOposProp( DEBUGPARAM("ImageQuality") PIDXImg_ImageQuality, ImageQuality, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ImageType( /*[out, retval]*/ LONG* pImageType )
{
    return GetOposProp( DEBUGPARAM("ImageType") PIDXImg_ImageType, pImageType, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_ImageWidth( /*[out, retval]*/ LONG* pImageWidth )
{
    return GetOposProp( DEBUGPARAM("ImageWidth") PIDXImg_ImageWidth, pImageWidth, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_VideoCount( /*[out, retval]*/ LONG* pVideoCount )
{
    return GetOposProp( DEBUGPARAM("VideoCount") PIDXImg_VideoCount, pVideoCount, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_VideoCount( /*[in]*/ LONG VideoCount )
{
    return SetOposProp( DEBUGPARAM("VideoCount") PIDXImg_VideoCount, VideoCount, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSImageScanner::get_VideoRate( /*[out, retval]*/ LONG* pVideoRate )
{
    return GetOposProp( DEBUGPARAM("VideoRate") PIDXImg_VideoRate, pVideoRate, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSImageScanner::put_VideoRate( /*[in]*/ LONG VideoRate )
{
    return SetOposProp( DEBUGPARAM("VideoRate") PIDXImg_VideoRate, VideoRate, 11 /*MinorVersion*/ );
}
...
void COPOSImageScanner::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_ImageScanner.log");
...
#define OPOSCCOCLASS COPOSImageScanner
#define RCSTRACENAME "OposCCO_ImageScanner"
...
void COPOSImageScanner::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSImageScanner::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSImageScanner::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSImageScanner::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
