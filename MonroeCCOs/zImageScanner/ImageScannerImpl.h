/****************************************************************************
**
** ImageScannerImpl.h -- Main control header file.
**
...
#ifndef __IMAGESCANNERIMPL_H__
#define __IMAGESCANNERIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_ImageScanner.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_ImageScanner.log")
...
// The class...
class ATL_NO_VTABLE COPOSImageScanner :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSImageScanner, &IID_IOPOSImageScanner, &LIBID_OposImageScanner_CCO>,
    public CComControl<COPOSImageScanner>,
    public IPersistStreamInitImpl<COPOSImageScanner>,
    public IOleControlImpl<COPOSImageScanner>,
    public IOleObjectImpl<COPOSImageScanner>,
    public IOleInPlaceActiveObjectImpl<COPOSImageScanner>,
    public IViewObjectExImpl<COPOSImageScanner>,
    public IOleInPlaceObjectWindowlessImpl<COPOSImageScanner>,
    public IConnectionPointContainerImpl<COPOSImageScanner>,
    public IPersistStorageImpl<COPOSImageScanner>,
    public ISpecifyPropertyPagesImpl<COPOSImageScanner>,
    public IQuickActivateImpl<COPOSImageScanner>,
    public IDataObjectImpl<COPOSImageScanner>,
    public IProvideClassInfo2Impl<&CLSID_OPOSImageScanner, &DIID__IOPOSImageScannerEvents, &LIBID_OposImageScanner_CCO>,
    public IObjectSafetyImpl<COPOSImageScanner, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSImageScanner>,
    public CComCoClass<COPOSImageScanner, &CLSID_OPOSImageScanner>,
    public CProxy_IOPOSEvents< COPOSImageScanner >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSIMAGESCANNER)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSImageScanner)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSImageScanner)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSImageScanner, IOPOSImageScanner)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSImageScanner_1_11, IOPOSImageScanner)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSImageScanner)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSImageScanner)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSImageScannerEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSImageScanner)
    CHAIN_MSG_MAP(CComControl<COPOSImageScanner>)
...
// Release 1.11
    ...
    STDMETHOD(ClearInputProperties)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapAim)( /*[out, retval]*/ VARIANT_BOOL* pCapAim );
    STDMETHOD(get_CapDecodeData)( /*[out, retval]*/ VARIANT_BOOL* pCapDecodeData );
    STDMETHOD(get_CapHostTriggered)( /*[out, retval]*/ VARIANT_BOOL* pCapHostTriggered );
    STDMETHOD(get_CapIlluminate)( /*[out, retval]*/ VARIANT_BOOL* pCapIlluminate );
    STDMETHOD(get_CapImageData)( /*[out, retval]*/ VARIANT_BOOL* pCapImageData );
    STDMETHOD(get_CapImageQuality)( /*[out, retval]*/ VARIANT_BOOL* pCapImageQuality );
    STDMETHOD(get_CapVideoData)( /*[out, retval]*/ VARIANT_BOOL* pCapVideoData );
    STDMETHOD(get_AimMode)( /*[out, retval]*/ VARIANT_BOOL* pAimMode );
    STDMETHOD(put_AimMode)( /*[in]*/ VARIANT_BOOL AimMode );
    STDMETHOD(get_BitsPerPixel)( /*[out, retval]*/ LONG* pBitsPerPixel );
    STDMETHOD(get_FrameData)( /*[out, retval]*/ BSTR* pFrameData );
    STDMETHOD(get_FrameType)( /*[out, retval]*/ LONG* pFrameType );
    STDMETHOD(get_IlluminateMode)( /*[out, retval]*/ VARIANT_BOOL* pIlluminateMode );
    STDMETHOD(put_IlluminateMode)( /*[in]*/ VARIANT_BOOL IlluminateMode );
    STDMETHOD(get_ImageHeight)( /*[out, retval]*/ LONG* pImageHeight );
    STDMETHOD(get_ImageLength)( /*[out, retval]*/ LONG* pImageLength );
    STDMETHOD(get_ImageMode)( /*[out, retval]*/ LONG* pImageMode );
    STDMETHOD(put_ImageMode)( /*[in]*/ LONG ImageMode );
    STDMETHOD(get_ImageQuality)( /*[out, retval]*/ LONG* pImageQuality );
    STDMETHOD(put_ImageQuality)( /*[in]*/ LONG ImageQuality );
    STDMETHOD(get_ImageType)( /*[out, retval]*/ LONG* pImageType );
    STDMETHOD(get_ImageWidth)( /*[out, retval]*/ LONG* pImageWidth );
    STDMETHOD(get_VideoCount)( /*[out, retval]*/ LONG* pVideoCount );
    STDMETHOD(put_VideoCount)( /*[in]*/ LONG VideoCount );
    STDMETHOD(get_VideoRate)( /*[out, retval]*/ LONG* pVideoRate );
    STDMETHOD(put_VideoRate)( /*[in]*/ LONG VideoRate );
    STDMETHOD(StartSession)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StopSession)( 
        /*[out, retval]*/ long* pRC );
// Release 1.12
// Release 1.13
// Release 1.14
...
#endif //__IMAGESCANNERIMPL_H__

// End ImageScannerImpl.h
