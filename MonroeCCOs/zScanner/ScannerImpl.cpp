...
TCHAR g_WindowName[] = _T("HW_OPOSScanner");

// Control Object description and version.
char g_ControlDescription[] = "OPOS Scanner Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSScanner::s_nInstances = 0;
...
//   for each release.
// Followed by the initial minor release of the OPOS Scanner.
//===========================================================================
...
COPOSScanner::COPOSScanner()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSScanner >(this) )
{
}

//===========================================================================

HRESULT COPOSScanner::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSScanner::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSScanner::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSSCANNER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSScanner::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSScanner::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSScanner::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSScanner::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSScanner::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_SCAN );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_SCAN), hRC );
...
STDMETHODIMP COPOSScanner::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSScanner::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSScanner::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSScanner::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSScanner::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSScanner::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSScanner::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSScanner::ResetStatistics( 
...
STDMETHODIMP COPOSScanner::RetrieveStatistics( 
...
STDMETHODIMP COPOSScanner::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSScanner::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSScanner::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSScanner::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSScanner::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSScanner::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSScanner::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSScanner::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSScanner::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSScanner::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSScanner::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSScanner::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSScanner::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSScanner::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSScanner::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSScanner::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSScanner::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSScanner::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSScanner::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSScanner::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSScanner::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSScanner::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSScanner::get_ScanData( /*[out, retval]*/ BSTR* pScanData )
{
    return GetOposProp( DEBUGPARAM("ScanData") PIDXScan_ScanData, pScanData, 0 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSScanner::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSScanner::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSScanner::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSScanner::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSScanner::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSScanner::get_DecodeData( /*[out, retval]*/ VARIANT_BOOL* pDecodeData )
{
    return GetOposProp( DEBUGPARAM("DecodeData") PIDXScan_DecodeData, pDecodeData, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSScanner::put_DecodeData( /*[in]*/ VARIANT_BOOL DecodeData )
{
    return SetOposProp( DEBUGPARAM("DecodeData") PIDXScan_DecodeData, DecodeData, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScanner::get_ScanDataLabel( /*[out, retval]*/ BSTR* pScanDataLabel )
{
    return GetOposProp( DEBUGPARAM("ScanDataLabel") PIDXScan_ScanDataLabel, pScanDataLabel, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScanner::get_ScanDataType( /*[out, retval]*/ LONG* pScanDataType )
{
    return GetOposProp( DEBUGPARAM("ScanDataType") PIDXScan_ScanDataType, pScanDataType, 2 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSScanner::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSScanner::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSScanner::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSScanner::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSScanner::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSScanner::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSScanner::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSScanner::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSScanner::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_Scanner.log");
...
#define OPOSCCOCLASS COPOSScanner
#define RCSTRACENAME "OposCCO_Scanner"
...
void COPOSScanner::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSScanner::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSScanner::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSScanner::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
