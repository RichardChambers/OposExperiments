...
TCHAR g_WindowName[] = _T("HW_OPOSGate");

// Control Object description and version.
char g_ControlDescription[] = "OPOS Gate Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
// Release 1.12 methods
    ...
    "OpenGate",
        #define nDIOpenGate 16
    "WaitForGateClose",
        #define nDIWaitForGateClose 17
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS Gate.
//===========================================================================
...
COPOSGate::COPOSGate()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSGate >(this) )
{
}

//===========================================================================

HRESULT COPOSGate::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSGate::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSGate::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSGATE2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSGate::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSGate::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSGate::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSGate::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSGate::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_GATE );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_GATE), hRC );
...
STDMETHODIMP COPOSGate::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGate::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGate::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGate::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSGate::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGate::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSGate::ResetStatistics( 
...
STDMETHODIMP COPOSGate::RetrieveStatistics( 
...
STDMETHODIMP COPOSGate::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGate::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSGate::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGate::OpenGate( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("OpenGate") S_OK, NULL, 0, nDIOpenGate, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGate::WaitForGateClose( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Timeout );
    return DoInvoke( DEBUGPARAM("WaitForGateClose") S_OK, &Var, 1, nDIWaitForGateClose, pRC );
}
...
STDMETHODIMP COPOSGate::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSGate::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSGate::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSGate::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSGate::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSGate::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSGate::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSGate::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSGate::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSGate::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSGate::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSGate::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSGate::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSGate::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSGate::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSGate::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSGate::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSGate::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSGate::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSGate::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSGate::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSGate::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSGate::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSGate::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSGate::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSGate::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSGate::get_CapGateStatus( /*[out, retval]*/ VARIANT_BOOL* pCapGateStatus )
{
    return GetOposProp( DEBUGPARAM("CapGateStatus") PIDXGate_CapGateStatus, pCapGateStatus, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGate::get_GateStatus( /*[out, retval]*/ LONG* pGateStatus )
{
    return GetOposProp( DEBUGPARAM("GateStatus") PIDXGate_GateStatus, pGateStatus, 12 /*MinorVersion*/ );
}
...
void COPOSGate::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_Gate.log");
...
#define OPOSCCOCLASS COPOSGate
#define RCSTRACENAME "OposCCO_Gate"
...
void COPOSGate::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSGate::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSGate::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSGate::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
