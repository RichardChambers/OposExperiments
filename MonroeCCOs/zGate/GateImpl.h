/****************************************************************************
**
** GateImpl.h -- Main control header file.
**
...
#ifndef __GATEIMPL_H__
#define __GATEIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_Gate.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_Gate.log")
...
// The class...
class ATL_NO_VTABLE COPOSGate :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSGate, &IID_IOPOSGate, &LIBID_OposGate_CCO>,
    public CComControl<COPOSGate>,
    public IPersistStreamInitImpl<COPOSGate>,
    public IOleControlImpl<COPOSGate>,
    public IOleObjectImpl<COPOSGate>,
    public IOleInPlaceActiveObjectImpl<COPOSGate>,
    public IViewObjectExImpl<COPOSGate>,
    public IOleInPlaceObjectWindowlessImpl<COPOSGate>,
    public IConnectionPointContainerImpl<COPOSGate>,
    public IPersistStorageImpl<COPOSGate>,
    public ISpecifyPropertyPagesImpl<COPOSGate>,
    public IQuickActivateImpl<COPOSGate>,
    public IDataObjectImpl<COPOSGate>,
    public IProvideClassInfo2Impl<&CLSID_OPOSGate, &DIID__IOPOSGateEvents, &LIBID_OposGate_CCO>,
    public IObjectSafetyImpl<COPOSGate, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSGate>,
    public CComCoClass<COPOSGate, &CLSID_OPOSGate>,
    public CProxy_IOPOSEvents< COPOSGate >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSGATE)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSGate)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSGate)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSGate, IOPOSGate)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSGate_1_12, IOPOSGate)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSGate)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSGate)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSGateEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSGate)
    CHAIN_MSG_MAP(CComControl<COPOSGate>)
...
// Release 1.12
    ...
    STDMETHOD(UpdateFirmware)( 
        /*[in]*/ BSTR FirmwareFileName, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapGateStatus)( /*[out, retval]*/ VARIANT_BOOL* pCapGateStatus );
    STDMETHOD(get_GateStatus)( /*[out, retval]*/ LONG* pGateStatus );
    STDMETHOD(OpenGate)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(WaitForGateClose)( 
        /*[in]*/ LONG Timeout, 
        /*[out, retval]*/ long* pRC );
// Release 1.13
// Release 1.14
