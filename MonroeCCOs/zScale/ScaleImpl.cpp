/****************************************************************************
**
** ScaleImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSScale");

// Control Object description and version.
char g_ControlDescription[] = "OPOS Scale Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
// Release 1.0 methods
    ...
    "ReadWeight",
        #define nDIReadWeight 11
// Release 1.1 methods
// Release 1.2 methods
// Release 1.3 methods
    "ClearInput",
        #define nDIClearInput 12
    "GetSalesPrice",
        #define nDIGetSalesPrice 13
    "GetUnitPrice",
        #define nDIGetUnitPrice 14
    "SetUnitPrice",
        #define nDISetUnitPrice 15
    "DisplayText",
        #define nDIDisplayText 16
    "ZeroScale",
        #define nDIZeroScale 17
// Release 1.4 methods
// Release 1.5 methods
// Release 1.6 methods
// Release 1.7 methods
// Release 1.8 methods
    "ResetStatistics",
        #define nDIResetStatistics 18
    "RetrieveStatistics",
        #define nDIRetrieveStatistics 19
    "UpdateStatistics",
        #define nDIUpdateStatistics 20
// Release 1.9 methods
    "CompareFirmwareVersion",
        #define nDICompareFirmwareVersion 21
    "UpdateFirmware",
        #define nDIUpdateFirmware 22
...
// Release 1.14 methods
    "DoPriceCalculating",
        #define nDIDoPriceCalculating 23
    "FreezeValue",
        #define nDIFreezeValue 24
    "ReadLiveWeightWithTare",
        #define nDIReadLiveWeightWithTare 25
    "SetPriceCalculationMode",
        #define nDISetPriceCalculationMode 26
    "SetSpecialTare",
        #define nDISetSpecialTare 27
    "SetTarePriority",
        #define nDISetTarePriority 28
    "SetUnitPriceWithWeightUnit",
        #define nDISetUnitPriceWithWeightUnit 29
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS Scale.
//===========================================================================
...
COPOSScale::COPOSScale()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSScale >(this) )
{
}

//===========================================================================

HRESULT COPOSScale::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSScale::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSScale::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSSCALE2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSScale::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSScale::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSScale::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSScale::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSScale::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_SCAL );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_SCAL), hRC );
...
STDMETHODIMP COPOSScale::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSScale::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSScale::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSScale::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSScale::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSScale::ReadWeight( 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetLONG_Ptr( pWeightData, hRC );
    Vars[0].SetLONG( Timeout );
    return DoInvoke( DEBUGPARAM("ReadWeight") hRC, Vars, 2, nDIReadWeight, pRC );
}
...
STDMETHODIMP COPOSScale::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSScale::DisplayText( 
    /*[in]*/ BSTR Data, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    ...
    return DoInvoke( DEBUGPARAM("DisplayText") hRC, &Var, 1, nDIDisplayText, pRC );
}

//===========================================================================

STDMETHODIMP COPOSScale::ZeroScale( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("ZeroScale") S_OK, NULL, 0, nDIZeroScale, pRC );
}
...
STDMETHODIMP COPOSScale::ResetStatistics( 
...
STDMETHODIMP COPOSScale::RetrieveStatistics( 
...
STDMETHODIMP COPOSScale::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSScale::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSScale::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSScale::DoPriceCalculating( 
    /*[out]*/ LONG* pWeightData, 
    /*[out]*/ LONG* pTare, 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[9];
    HRESULT hRC = S_OK;
    Vars[8].SetLONG_Ptr( pWeightData, hRC );
    Vars[7].SetLONG_Ptr( pTare, hRC );
    Vars[6].SetCURRENCY_Ptr( pUnitPrice, hRC );
    Vars[5].SetCURRENCY_Ptr( pUnitPriceX, hRC );
    Vars[4].SetLONG_Ptr( pWeightUnitX, hRC );
    Vars[3].SetLONG_Ptr( pWeightNumeratorX, hRC );
    Vars[2].SetLONG_Ptr( pWeightDenominatorX, hRC );
    Vars[1].SetCURRENCY_Ptr( pPrice, hRC );
    Vars[0].SetLONG( Timeout );
    return DoInvoke( DEBUGPARAM("DoPriceCalculating") hRC, Vars, 9, nDIDoPriceCalculating, pRC );
}

//===========================================================================

STDMETHODIMP COPOSScale::FreezeValue( 
    /*[in]*/ LONG Item, 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    Vars[1].SetLONG( Item );
    Vars[0].SetVARIANT_BOOL( Freeze );
    return DoInvoke( DEBUGPARAM("FreezeValue") S_OK, Vars, 2, nDIFreezeValue, pRC );
}

//===========================================================================

STDMETHODIMP COPOSScale::ReadLiveWeightWithTare( 
    /*[out]*/ LONG* pWeightData, 
    /*[out]*/ LONG* pTare, 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[3];
    HRESULT hRC = S_OK;
    Vars[2].SetLONG_Ptr( pWeightData, hRC );
    Vars[1].SetLONG_Ptr( pTare, hRC );
    Vars[0].SetLONG( Timeout );
    return DoInvoke( DEBUGPARAM("ReadLiveWeightWithTare") hRC, Vars, 3, nDIReadLiveWeightWithTare, pRC );
}

//===========================================================================

STDMETHODIMP COPOSScale::SetPriceCalculationMode( 
    /*[in]*/ LONG Mode, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Mode );
    return DoInvoke( DEBUGPARAM("SetPriceCalculationMode") S_OK, &Var, 1, nDISetPriceCalculationMode, pRC );
}

//===========================================================================

STDMETHODIMP COPOSScale::SetSpecialTare( 
    /*[in]*/ LONG Mode, 
    /*[in]*/ LONG Data, 
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[1].SetLONG( Mode );
    Vars[0].SetLONG( Data );
    return DoInvoke( DEBUGPARAM("SetSpecialTare") S_OK, Vars, 2, nDISetSpecialTare, pRC );
}

//===========================================================================

STDMETHODIMP COPOSScale::SetTarePriority( 
    /*[in]*/ LONG Priority, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Priority );
    return DoInvoke( DEBUGPARAM("SetTarePriority") S_OK, &Var, 1, nDISetTarePriority, pRC );
}

//===========================================================================

STDMETHODIMP COPOSScale::SetUnitPriceWithWeightUnit( 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[2].SetLONG( WeightUnit );
    Vars[1].SetLONG( WeightNumerator );
    Vars[0].SetLONG( WeightDenominator );
    return DoInvoke( DEBUGPARAM("SetUnitPriceWithWeightUnit") S_OK, Vars, 4, nDISetUnitPriceWithWeightUnit, pRC );
}
...
STDMETHODIMP COPOSScale::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSScale::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSScale::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSScale::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSScale::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSScale::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSScale::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSScale::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSScale::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSScale::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSScale::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSScale::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSScale::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSScale::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSScale::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSScale::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSScale::get_MaximumWeight( /*[out, retval]*/ LONG* pMaximumWeight )
{
    return GetOposProp( DEBUGPARAM("MaximumWeight") PIDXScal_MaximumWeight, pMaximumWeight, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_WeightUnit( /*[out, retval]*/ LONG* pWeightUnit )
{
    return GetOposProp( DEBUGPARAM("WeightUnit") PIDXScal_WeightUnit, pWeightUnit, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_WeightUnits( /*[out, retval]*/ LONG* pWeightUnits )
{
    return GetOposProp( DEBUGPARAM("WeightUnits") PIDXScal_WeightUnit, pWeightUnits, 0 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSScale::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSScale::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSScale::get_CapDisplay( /*[out, retval]*/ VARIANT_BOOL* pCapDisplay )
{
    return GetOposProp( DEBUGPARAM("CapDisplay") PIDXScal_CapDisplay, pCapDisplay, 2 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSScale::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
    return GetOposProp( DEBUGPARAM("AutoDisable") PIDX_AutoDisable, pAutoDisable, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSScale::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
    return SetOposProp( DEBUGPARAM("AutoDisable") PIDX_AutoDisable, AutoDisable, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSScale::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSScale::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSScale::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSScale::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSScale::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSScale::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSScale::get_AsyncMode( /*[out, retval]*/ VARIANT_BOOL* pAsyncMode )
{
    return GetOposProp( DEBUGPARAM("AsyncMode") PIDXScal_AsyncMode, pAsyncMode, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSScale::put_AsyncMode( /*[in]*/ VARIANT_BOOL AsyncMode )
{
    return SetOposProp( DEBUGPARAM("AsyncMode") PIDXScal_AsyncMode, AsyncMode, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapDisplayText( /*[out, retval]*/ VARIANT_BOOL* pCapDisplayText )
{
    return GetOposProp( DEBUGPARAM("CapDisplayText") PIDXScal_CapDisplayText, pCapDisplayText, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapPriceCalculating( /*[out, retval]*/ VARIANT_BOOL* pCapPriceCalculating )
{
    return GetOposProp( DEBUGPARAM("CapPriceCalculating") PIDXScal_CapPriceCalculating, pCapPriceCalculating, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapTareWeight( /*[out, retval]*/ VARIANT_BOOL* pCapTareWeight )
{
    return GetOposProp( DEBUGPARAM("CapTareWeight") PIDXScal_CapTareWeight, pCapTareWeight, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapZeroScale( /*[out, retval]*/ VARIANT_BOOL* pCapZeroScale )
{
    return GetOposProp( DEBUGPARAM("CapZeroScale") PIDXScal_CapZeroScale, pCapZeroScale, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_MaxDisplayTextChars( /*[out, retval]*/ LONG* pMaxDisplayTextChars )
{
    return GetOposProp( DEBUGPARAM("MaxDisplayTextChars") PIDXScal_MaxDisplayTextChars, pMaxDisplayTextChars, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_SalesPrice( /*[out, retval]*/ CURRENCY* pSalesPrice )
{
    DOTRACEV( ( _T("+SalesPrice [Get]") ) );
    ...
    // If open and SO version support's property...
    if ( _bOpened && _nSOMinor >= 3 /*MinorVersion*/ )
    {
        // Set up and call the SO method that gets the currency property.
        OposVariant VarResult;
        DISPPARAMS Disp = { NULL, NULL, 0, 0 };
        hRC = _pService->Invoke(
                _DispIDs[nDIGetSalesPrice], IID_NULL, LOCALE_USER_DEFAULT,
                DISPATCH_METHOD, &Disp, &VarResult, NULL, NULL );

        // If success, then set return result.
        if ( hRC == S_OK )
            VarResult.ChangeCURRENCY( pSalesPrice, hRC );
    }
    ...
    if ( !_bOpened )
        pInfo = _T(" -- Closed");
    else if ( _nSOMinor < 3 /*MinorVersion*/ )
    ...
    DOTRACEV( ( _T("-SalesPrice [Get]: %s%s"), FormatCurrency(*pSalesPrice), pInfo ) );
#endif
...
STDMETHODIMP COPOSScale::get_TareWeight( /*[out, retval]*/ LONG* pTareWeight )
{
    return GetOposProp( DEBUGPARAM("TareWeight") PIDXScal_TareWeight, pTareWeight, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSScale::put_TareWeight( /*[in]*/ LONG TareWeight )
{
    return SetOposProp( DEBUGPARAM("TareWeight") PIDXScal_TareWeight, TareWeight, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_UnitPrice( /*[out, retval]*/ CURRENCY* pUnitPrice )
{
    DOTRACEV( ( _T("+UnitPrice [Get]") ) );
    ...
    if ( _bOpened && _nSOMinor >= 3 /*MinorVersion*/ )
    {
        ...
        DISPPARAMS Disp = { NULL, NULL, 0, 0 };
        hRC = _pService->Invoke(
                _DispIDs[nDIGetUnitPrice], IID_NULL, LOCALE_USER_DEFAULT,
                DISPATCH_METHOD, &Disp, &VarResult, NULL, NULL );

        // If success, then set return result.
        if ( hRC == S_OK )
            VarResult.ChangeCURRENCY( pUnitPrice, hRC );
    }
    ...
    DOTRACEV( ( _T("-UnitPrice [Get]: %s%s"), FormatCurrency(*pUnitPrice), pInfo ) );
#endif
...
STDMETHODIMP COPOSScale::put_UnitPrice( /*[in]*/ CURRENCY UnitPrice )
{
    DOTRACEV( ( _T("+UnitPrice [Set]: %s"), FormatCurrency(UnitPrice) ) );
    HRESULT hRC = 0;
    ...
    if ( _bOpened && _nSOMinor >= 3 /*MinorVersion*/ )
    {
        ...
        OposVariant VarResult;
        OposVariant Var;
        Var.SetCURRENCY( UnitPrice );
        DISPPARAMS Disp = { &Var, NULL, 1, 0 };
        hRC = _pService->Invoke(
                _DispIDs[nDISetUnitPrice], IID_NULL, LOCALE_USER_DEFAULT,
                DISPATCH_METHOD, &Disp, &VarResult, NULL, NULL );
    }
    ...
    DOTRACEV( ( _T("-UnitPrice [Set]%s"), pInfo ) );
#endif
...
STDMETHODIMP COPOSScale::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSScale::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSScale::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSScale::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSScale::get_CapStatusUpdate( /*[out, retval]*/ VARIANT_BOOL* pCapStatusUpdate )
{
    return GetOposProp( DEBUGPARAM("CapStatusUpdate") PIDXScal_CapStatusUpdate, pCapStatusUpdate, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_ScaleLiveWeight( /*[out, retval]*/ LONG* pScaleLiveWeight )
{
    return GetOposProp( DEBUGPARAM("ScaleLiveWeight") PIDXScal_ScaleLiveWeight, pScaleLiveWeight, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_StatusNotify( /*[out, retval]*/ LONG* pStatusNotify )
{
    return GetOposProp( DEBUGPARAM("StatusNotify") PIDXScal_StatusNotify, pStatusNotify, 9 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSScale::put_StatusNotify( /*[in]*/ LONG StatusNotify )
{
    return SetOposProp( DEBUGPARAM("StatusNotify") PIDXScal_StatusNotify, StatusNotify, 9 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSScale::get_ZeroValid( /*[out, retval]*/ VARIANT_BOOL* pZeroValid )
{
    return GetOposProp( DEBUGPARAM("ZeroValid") PIDXScal_ZeroValid, pZeroValid, 13 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSScale::put_ZeroValid( /*[in]*/ VARIANT_BOOL ZeroValid )
{
    return SetOposProp( DEBUGPARAM("ZeroValid") PIDXScal_ZeroValid, ZeroValid, 13 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSScale::get_CapFreezeValue( /*[out, retval]*/ VARIANT_BOOL* pCapFreezeValue )
{
    return GetOposProp( DEBUGPARAM("CapFreezeValue") PIDXScal_CapFreezeValue, pCapFreezeValue, 14 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapReadLiveWeightWithTare( /*[out, retval]*/ VARIANT_BOOL* pCapReadLiveWeightWithTare )
{
    return GetOposProp( DEBUGPARAM("CapReadLiveWeightWithTare") PIDXScal_CapReadLiveWeightWithTare, pCapReadLiveWeightWithTare, 14 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapSetPriceCalculationMode( /*[out, retval]*/ VARIANT_BOOL* pCapSetPriceCalculationMode )
{
    return GetOposProp( DEBUGPARAM("CapSetPriceCalculationMode") PIDXScal_CapSetPriceCalculationMode, pCapSetPriceCalculationMode, 14 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapSetUnitPriceWithWeightUnit( /*[out, retval]*/ VARIANT_BOOL* pCapSetUnitPriceWithWeightUnit )
{
    return GetOposProp( DEBUGPARAM("CapSetUnitPriceWithWeightUnit") PIDXScal_CapSetUnitPriceWithWeightUnit, pCapSetUnitPriceWithWeightUnit, 14 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapSpecialTare( /*[out, retval]*/ VARIANT_BOOL* pCapSpecialTare )
{
    return GetOposProp( DEBUGPARAM("CapSpecialTare") PIDXScal_CapSpecialTare, pCapSpecialTare, 14 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_CapTarePriority( /*[out, retval]*/ VARIANT_BOOL* pCapTarePriority )
{
    return GetOposProp( DEBUGPARAM("CapTarePriority") PIDXScal_CapTarePriority, pCapTarePriority, 14 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSScale::get_MinimumWeight( /*[out, retval]*/ LONG* pMinimumWeight )
{
    return GetOposProp( DEBUGPARAM("MinimumWeight") PIDXScal_MinimumWeight, pMinimumWeight, 14 /*MinorVersion*/ );
}
...
void COPOSScale::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_Scale.log");
...
#define OPOSCCOCLASS COPOSScale
#define RCSTRACENAME "OposCCO_Scale"
...
void COPOSScale::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSScale::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSScale::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSScale::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
...
//              123     => "0.0123"
//              -1      => "-0.0001"
LPCTSTR COPOSScale::FormatCurrency( CY cyCurrency )
{
