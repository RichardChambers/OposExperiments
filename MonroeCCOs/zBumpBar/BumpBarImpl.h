/****************************************************************************
**
** BumpBarImpl.h -- Main control header file.
**
...
#ifndef __BUMPBARIMPL_H__
#define __BUMPBARIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_BumpBar.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_BumpBar.log")
...
// The class...
class ATL_NO_VTABLE COPOSBumpBar :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSBumpBar, &IID_IOPOSBumpBar, &LIBID_OposBumpBar_CCO>,
    public CComControl<COPOSBumpBar>,
    public IPersistStreamInitImpl<COPOSBumpBar>,
    public IOleControlImpl<COPOSBumpBar>,
    public IOleObjectImpl<COPOSBumpBar>,
    public IOleInPlaceActiveObjectImpl<COPOSBumpBar>,
    public IViewObjectExImpl<COPOSBumpBar>,
    public IOleInPlaceObjectWindowlessImpl<COPOSBumpBar>,
    public IConnectionPointContainerImpl<COPOSBumpBar>,
    public IPersistStorageImpl<COPOSBumpBar>,
    public ISpecifyPropertyPagesImpl<COPOSBumpBar>,
    public IQuickActivateImpl<COPOSBumpBar>,
    public IDataObjectImpl<COPOSBumpBar>,
    public IProvideClassInfo2Impl<&CLSID_OPOSBumpBar, &DIID__IOPOSBumpBarEvents, &LIBID_OposBumpBar_CCO>,
    public IObjectSafetyImpl<COPOSBumpBar, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSBumpBar>,
    public CComCoClass<COPOSBumpBar, &CLSID_OPOSBumpBar>,
    public CProxy_IOPOSEvents< COPOSBumpBar >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSBUMPBAR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSBumpBar)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSBumpBar)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSBumpBar, IOPOSBumpBar)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSBumpBar_1_9, IOPOSBumpBar)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSBumpBar_1_8, IOPOSBumpBar)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSBumpBar_1_5, IOPOSBumpBar)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSBumpBar)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSBumpBar)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSBumpBarEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSBumpBar)
    CHAIN_MSG_MAP(CComControl<COPOSBumpBar>)
...
// Release 1.3
    ...
    STDMETHOD(get_BumpBarDataCount)( /*[out, retval]*/ LONG* pBumpBarDataCount );
    ...
    STDMETHOD(get_Keys)( /*[out, retval]*/ LONG* pKeys );
