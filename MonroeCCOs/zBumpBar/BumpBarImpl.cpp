...
TCHAR g_WindowName[] = _T("HW_OPOSBumpBar");

// Control Object description and version.
char g_ControlDescription[] = "OPOS BumpBar Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSBumpBar::s_nInstances = 0;
...
// Release 1.3 methods
    ...
    "BumpBarSound",
        #define nDIBumpBarSound 13
    "SetKeyTranslation",
        #define nDISetKeyTranslation 14
// Release 1.4 methods
// Release 1.5 methods
// Release 1.6 methods
// Release 1.7 methods
// Release 1.8 methods
    "ResetStatistics",
        #define nDIResetStatistics 15
    "RetrieveStatistics",
        #define nDIRetrieveStatistics 16
    "UpdateStatistics",
        #define nDIUpdateStatistics 17
// Release 1.9 methods
    "CompareFirmwareVersion",
        #define nDICompareFirmwareVersion 18
    "UpdateFirmware",
        #define nDIUpdateFirmware 19
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS BumpBar.
//===========================================================================
...
COPOSBumpBar::COPOSBumpBar()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSBumpBar >(this) )
{
}

//===========================================================================

HRESULT COPOSBumpBar::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSBumpBar::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSBumpBar::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSBUMPBAR2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSBumpBar::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSBumpBar::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSBumpBar::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSBumpBar::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSBumpBar::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_BB );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_BB), hRC );
...
STDMETHODIMP COPOSBumpBar::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBumpBar::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBumpBar::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBumpBar::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSBumpBar::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBumpBar::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSBumpBar::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSBumpBar::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSBumpBar::BumpBarSound( 
    /*[in]*/ LONG Units, 
    /*[in]*/ LONG Frequency, 
    /*[in]*/ LONG Duration, 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    return DoInvoke( DEBUGPARAM("BumpBarSound") S_OK, Vars, 5, nDIBumpBarSound, pRC );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::SetKeyTranslation( 
    /*[in]*/ LONG Units, 
    /*[in]*/ LONG ScanCode, 
    /*[in]*/ LONG LogicalKey, 
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[1].SetLONG( ScanCode );
    Vars[0].SetLONG( LogicalKey );
    return DoInvoke( DEBUGPARAM("SetKeyTranslation") S_OK, Vars, 3, nDISetKeyTranslation, pRC );
}
...
STDMETHODIMP COPOSBumpBar::ResetStatistics( 
...
STDMETHODIMP COPOSBumpBar::RetrieveStatistics( 
...
STDMETHODIMP COPOSBumpBar::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBumpBar::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSBumpBar::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBumpBar::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSBumpBar::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSBumpBar::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSBumpBar::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSBumpBar::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSBumpBar::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSBumpBar::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSBumpBar::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSBumpBar::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSBumpBar::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSBumpBar::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSBumpBar::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSBumpBar::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSBumpBar::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSBumpBar::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSBumpBar::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSBumpBar::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSBumpBar::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
...
STDMETHODIMP COPOSBumpBar::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSBumpBar::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSBumpBar::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSBumpBar::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSBumpBar::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSBumpBar::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSBumpBar::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSBumpBar::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSBumpBar::get_AsyncMode( /*[out, retval]*/ VARIANT_BOOL* pAsyncMode )
{
    return GetOposProp( DEBUGPARAM("AsyncMode") PIDXBb_AsyncMode, pAsyncMode, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBumpBar::put_AsyncMode( /*[in]*/ VARIANT_BOOL AsyncMode )
{
    return SetOposProp( DEBUGPARAM("AsyncMode") PIDXBb_AsyncMode, AsyncMode, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_AutoToneDuration( /*[out, retval]*/ LONG* pAutoToneDuration )
{
    return GetOposProp( DEBUGPARAM("AutoToneDuration") PIDXBb_AutoToneDuration, pAutoToneDuration, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBumpBar::put_AutoToneDuration( /*[in]*/ LONG AutoToneDuration )
{
    return SetOposProp( DEBUGPARAM("AutoToneDuration") PIDXBb_AutoToneDuration, AutoToneDuration, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_AutoToneFrequency( /*[out, retval]*/ LONG* pAutoToneFrequency )
{
    return GetOposProp( DEBUGPARAM("AutoToneFrequency") PIDXBb_AutoToneFrequency, pAutoToneFrequency, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBumpBar::put_AutoToneFrequency( /*[in]*/ LONG AutoToneFrequency )
{
    return SetOposProp( DEBUGPARAM("AutoToneFrequency") PIDXBb_AutoToneFrequency, AutoToneFrequency, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_BumpBarDataCount( /*[out, retval]*/ LONG* pBumpBarDataCount )
{
    return GetOposProp( DEBUGPARAM("BumpBarDataCount") PIDXBb_BumpBarDataCount, pBumpBarDataCount, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_CapTone( /*[out, retval]*/ VARIANT_BOOL* pCapTone )
{
    return GetOposProp( DEBUGPARAM("CapTone") PIDXBb_CapTone, pCapTone, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_CurrentUnitID( /*[out, retval]*/ LONG* pCurrentUnitID )
{
    return GetOposProp( DEBUGPARAM("CurrentUnitID") PIDXBb_CurrentUnitID, pCurrentUnitID, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBumpBar::put_CurrentUnitID( /*[in]*/ LONG CurrentUnitID )
{
    return SetOposProp( DEBUGPARAM("CurrentUnitID") PIDXBb_CurrentUnitID, CurrentUnitID, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_ErrorString( /*[out, retval]*/ BSTR* pErrorString )
{
    return GetOposProp( DEBUGPARAM("ErrorString") PIDXBb_ErrorString, pErrorString, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_ErrorUnits( /*[out, retval]*/ LONG* pErrorUnits )
{
    return GetOposProp( DEBUGPARAM("ErrorUnits") PIDXBb_ErrorUnits, pErrorUnits, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_EventString( /*[out, retval]*/ BSTR* pEventString )
{
    return GetOposProp( DEBUGPARAM("EventString") PIDXBb_EventString, pEventString, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_EventUnitID( /*[out, retval]*/ LONG* pEventUnitID )
{
    return GetOposProp( DEBUGPARAM("EventUnitID") PIDXBb_EventUnitID, pEventUnitID, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_EventUnits( /*[out, retval]*/ LONG* pEventUnits )
{
    return GetOposProp( DEBUGPARAM("EventUnits") PIDXBb_EventUnits, pEventUnits, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_Keys( /*[out, retval]*/ LONG* pKeys )
{
    return GetOposProp( DEBUGPARAM("Keys") PIDXBb_Keys, pKeys, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_Timeout( /*[out, retval]*/ LONG* pTimeout )
{
    return GetOposProp( DEBUGPARAM("Timeout") PIDXBb_Timeout, pTimeout, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBumpBar::put_Timeout( /*[in]*/ LONG Timeout )
{
    return SetOposProp( DEBUGPARAM("Timeout") PIDXBb_Timeout, Timeout, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBumpBar::get_UnitsOnline( /*[out, retval]*/ LONG* pUnitsOnline )
{
    return GetOposProp( DEBUGPARAM("UnitsOnline") PIDXBb_UnitsOnline, pUnitsOnline, 3 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSBumpBar::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSBumpBar::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSBumpBar::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSBumpBar::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSBumpBar::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_BumpBar.log");
...
#define OPOSCCOCLASS COPOSBumpBar
#define RCSTRACENAME "OposCCO_BumpBar"
...
void COPOSBumpBar::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSBumpBar::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSBumpBar::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSBumpBar::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
