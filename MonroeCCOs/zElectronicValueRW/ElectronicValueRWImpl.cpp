...
char g_ControlDescription[] = "OPOS ElectronicValueRW Control 1.14.100 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
STDMETHODIMP COPOSElectronicValueRW::Open( BSTR DeviceName, long *pRC )
{
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
	...
	//++CRMMod++Begin
	//      Special handling for 1.14.100: If SO version is >= 1.14.100, then set minor to 15.
	if ( nSOVersion >= 1014100 )
		_nSOMinor = 15;
	//++CRMMod++End
