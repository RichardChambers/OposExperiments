...
TCHAR g_WindowName[] = _T("HW_OPOSLineDisplay");

// Control Object description and version.
char g_ControlDescription[] = "OPOS LineDisplay Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSLineDisplay::s_nInstances = 0;
...
// Release 1.0 methods
    ...
    "ClearDescriptors",
        #define nDIClearDescriptors 11
    "ClearText",
        #define nDIClearText 12
    "CreateWindow",
        #define nDICreateWindow 13
    "DestroyWindow",
        #define nDIDestroyWindow 14
    "DisplayText",
        #define nDIDisplayText 15
    "DisplayTextAt",
        #define nDIDisplayTextAt 16
    "RefreshWindow",
        #define nDIRefreshWindow 17
    "ScrollText",
        #define nDIScrollText 18
    "SetDescriptor",
        #define nDISetDescriptor 19
// Release 1.1 methods
// Release 1.2 methods
// Release 1.3 methods
// Release 1.4 methods
...
// Release 1.6 methods
    "DefineGlyph",
        #define nDIDefineGlyph 20
    "ReadCharacterAtCursor",
        #define nDIReadCharacterAtCursor 21
// Release 1.7 methods
    "DisplayBitmap",
        #define nDIDisplayBitmap 22
    "SetBitmap",
        #define nDISetBitmap 23
// Release 1.8 methods
    "ResetStatistics",
        #define nDIResetStatistics 24
    "RetrieveStatistics",
        #define nDIRetrieveStatistics 25
    "UpdateStatistics",
        #define nDIUpdateStatistics 26
// Release 1.9 methods
    "CompareFirmwareVersion",
        #define nDICompareFirmwareVersion 27
    "UpdateFirmware",
        #define nDIUpdateFirmware 28
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS LineDisplay.
//===========================================================================
...
COPOSLineDisplay::COPOSLineDisplay()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSLineDisplay >(this) )
{
}

//===========================================================================

HRESULT COPOSLineDisplay::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSLineDisplay::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSLineDisplay::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSLINEDISPLAY2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSLineDisplay::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSLineDisplay::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSLineDisplay::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSLineDisplay::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSLineDisplay::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_DISP );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_DISP), hRC );
...
STDMETHODIMP COPOSLineDisplay::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSLineDisplay::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSLineDisplay::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSLineDisplay::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSLineDisplay::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSLineDisplay::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSLineDisplay::ClearDescriptors( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("ClearDescriptors") S_OK, NULL, 0, nDIClearDescriptors, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::ClearText( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("ClearText") S_OK, NULL, 0, nDIClearText, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::CreateWindow( 
    /*[in]*/ LONG ViewportRow, 
...
{
    OposVariant Vars[6];
    Vars[5].SetLONG( ViewportRow );
    Vars[4].SetLONG( ViewportColumn );
    Vars[3].SetLONG( ViewportHeight );
    Vars[2].SetLONG( ViewportWidth );
    Vars[1].SetLONG( WindowHeight );
    Vars[0].SetLONG( WindowWidth );
    return DoInvoke( DEBUGPARAM("CreateWindow") S_OK, Vars, 6, nDICreateWindow, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::DestroyWindow( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("DestroyWindow") S_OK, NULL, 0, nDIDestroyWindow, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::DisplayText( 
    /*[in]*/ BSTR Data, 
    /*[in]*/ LONG Attribute, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( Data, hRC );
    Vars[0].SetLONG( Attribute );
    return DoInvoke( DEBUGPARAM("DisplayText") hRC, Vars, 2, nDIDisplayText, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::DisplayTextAt( 
    /*[in]*/ LONG Row, 
    /*[in]*/ LONG Column, 
    /*[in]*/ BSTR Data, 
    /*[in]*/ LONG Attribute, 
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[1].SetBSTR( Data, hRC );
    Vars[0].SetLONG( Attribute );
    return DoInvoke( DEBUGPARAM("DisplayTextAt") hRC, Vars, 4, nDIDisplayTextAt, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::RefreshWindow( 
    /*[in]*/ LONG Window, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Window );
    return DoInvoke( DEBUGPARAM("RefreshWindow") S_OK, &Var, 1, nDIRefreshWindow, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::ScrollText( 
    /*[in]*/ LONG Direction, 
    /*[in]*/ LONG Units, 
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[0].SetLONG( Units );
    return DoInvoke( DEBUGPARAM("ScrollText") S_OK, Vars, 2, nDIScrollText, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::SetDescriptor( 
    /*[in]*/ LONG Descriptor, 
    /*[in]*/ LONG Attribute, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    Vars[1].SetLONG( Descriptor );
    Vars[0].SetLONG( Attribute );
    return DoInvoke( DEBUGPARAM("SetDescriptor") S_OK, Vars, 2, nDISetDescriptor, pRC );
}
...
STDMETHODIMP COPOSLineDisplay::DefineGlyph( 
    /*[in]*/ LONG GlyphCode, 
    /*[in]*/ BSTR Glyph, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetLONG( GlyphCode );
    Vars[0].SetBSTR( Glyph, hRC );
    return DoInvoke( DEBUGPARAM("DefineGlyph") hRC, Vars, 2, nDIDefineGlyph, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::ReadCharacterAtCursor( 
    /*[out]*/ LONG* pChar, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetLONG_Ptr( pChar, hRC );
    return DoInvoke( DEBUGPARAM("ReadCharacterAtCursor") hRC, &Var, 1, nDIReadCharacterAtCursor, pRC );
}
...
STDMETHODIMP COPOSLineDisplay::DisplayBitmap( 
    /*[in]*/ BSTR FileName, 
    /*[in]*/ LONG Width, 
    /*[in]*/ LONG AlignmentX, 
    /*[in]*/ LONG AlignmentY, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[4];
    HRESULT hRC = S_OK;
    Vars[3].SetBSTR( FileName, hRC );
    Vars[2].SetLONG( Width );
    Vars[1].SetLONG( AlignmentX );
    Vars[0].SetLONG( AlignmentY );
    return DoInvoke( DEBUGPARAM("DisplayBitmap") hRC, Vars, 4, nDIDisplayBitmap, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::SetBitmap( 
...
STDMETHODIMP COPOSLineDisplay::ResetStatistics( 
...
STDMETHODIMP COPOSLineDisplay::RetrieveStatistics( 
...
STDMETHODIMP COPOSLineDisplay::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSLineDisplay::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSLineDisplay::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSLineDisplay::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSLineDisplay::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSLineDisplay::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSLineDisplay::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSLineDisplay::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSLineDisplay::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSLineDisplay::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSLineDisplay::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSLineDisplay::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSLineDisplay::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSLineDisplay::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSLineDisplay::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSLineDisplay::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSLineDisplay::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSLineDisplay::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSLineDisplay::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSLineDisplay::get_CapBlink( /*[out, retval]*/ LONG* pCapBlink )
{
    return GetOposProp( DEBUGPARAM("CapBlink") PIDXDisp_CapBlink, pCapBlink, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapBrightness( /*[out, retval]*/ VARIANT_BOOL* pCapBrightness )
{
    return GetOposProp( DEBUGPARAM("CapBrightness") PIDXDisp_CapBrightness, pCapBrightness, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapCharacterSet( /*[out, retval]*/ LONG* pCapCharacterSet )
{
    return GetOposProp( DEBUGPARAM("CapCharacterSet") PIDXDisp_CapCharacterSet, pCapCharacterSet, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapDescriptors( /*[out, retval]*/ VARIANT_BOOL* pCapDescriptors )
{
    return GetOposProp( DEBUGPARAM("CapDescriptors") PIDXDisp_CapDescriptors, pCapDescriptors, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapHMarquee( /*[out, retval]*/ VARIANT_BOOL* pCapHMarquee )
{
    return GetOposProp( DEBUGPARAM("CapHMarquee") PIDXDisp_CapHMarquee, pCapHMarquee, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapICharWait( /*[out, retval]*/ VARIANT_BOOL* pCapICharWait )
{
    return GetOposProp( DEBUGPARAM("CapICharWait") PIDXDisp_CapICharWait, pCapICharWait, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapVMarquee( /*[out, retval]*/ VARIANT_BOOL* pCapVMarquee )
{
    return GetOposProp( DEBUGPARAM("CapVMarquee") PIDXDisp_CapVMarquee, pCapVMarquee, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CharacterSet( /*[out, retval]*/ LONG* pCharacterSet )
{
    return GetOposProp( DEBUGPARAM("CharacterSet") PIDXDisp_CharacterSet, pCharacterSet, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_CharacterSet( /*[in]*/ LONG CharacterSet )
{
    return SetOposProp( DEBUGPARAM("CharacterSet") PIDXDisp_CharacterSet, CharacterSet, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CharacterSetList( /*[out, retval]*/ BSTR* pCharacterSetList )
{
    return GetOposProp( DEBUGPARAM("CharacterSetList") PIDXDisp_CharacterSetList, pCharacterSetList, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_Columns( /*[out, retval]*/ LONG* pColumns )
{
    return GetOposProp( DEBUGPARAM("Columns") PIDXDisp_Columns, pColumns, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CurrentWindow( /*[out, retval]*/ LONG* pCurrentWindow )
{
    return GetOposProp( DEBUGPARAM("CurrentWindow") PIDXDisp_CurrentWindow, pCurrentWindow, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_CurrentWindow( /*[in]*/ LONG CurrentWindow )
{
    return SetOposProp( DEBUGPARAM("CurrentWindow") PIDXDisp_CurrentWindow, CurrentWindow, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CursorColumn( /*[out, retval]*/ LONG* pCursorColumn )
{
    return GetOposProp( DEBUGPARAM("CursorColumn") PIDXDisp_CursorColumn, pCursorColumn, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_CursorColumn( /*[in]*/ LONG CursorColumn )
{
    return SetOposProp( DEBUGPARAM("CursorColumn") PIDXDisp_CursorColumn, CursorColumn, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CursorRow( /*[out, retval]*/ LONG* pCursorRow )
{
    return GetOposProp( DEBUGPARAM("CursorRow") PIDXDisp_CursorRow, pCursorRow, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_CursorRow( /*[in]*/ LONG CursorRow )
{
    return SetOposProp( DEBUGPARAM("CursorRow") PIDXDisp_CursorRow, CursorRow, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CursorUpdate( /*[out, retval]*/ VARIANT_BOOL* pCursorUpdate )
{
    return GetOposProp( DEBUGPARAM("CursorUpdate") PIDXDisp_CursorUpdate, pCursorUpdate, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_CursorUpdate( /*[in]*/ VARIANT_BOOL CursorUpdate )
{
    return SetOposProp( DEBUGPARAM("CursorUpdate") PIDXDisp_CursorUpdate, CursorUpdate, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_DeviceBrightness( /*[out, retval]*/ LONG* pDeviceBrightness )
{
    return GetOposProp( DEBUGPARAM("DeviceBrightness") PIDXDisp_DeviceBrightness, pDeviceBrightness, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_DeviceBrightness( /*[in]*/ LONG DeviceBrightness )
{
    return SetOposProp( DEBUGPARAM("DeviceBrightness") PIDXDisp_DeviceBrightness, DeviceBrightness, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_DeviceColumns( /*[out, retval]*/ LONG* pDeviceColumns )
{
    return GetOposProp( DEBUGPARAM("DeviceColumns") PIDXDisp_DeviceColumns, pDeviceColumns, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_DeviceDescriptors( /*[out, retval]*/ LONG* pDeviceDescriptors )
{
    return GetOposProp( DEBUGPARAM("DeviceDescriptors") PIDXDisp_DeviceDescriptors, pDeviceDescriptors, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_DeviceRows( /*[out, retval]*/ LONG* pDeviceRows )
{
    return GetOposProp( DEBUGPARAM("DeviceRows") PIDXDisp_DeviceRows, pDeviceRows, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_DeviceWindows( /*[out, retval]*/ LONG* pDeviceWindows )
{
    return GetOposProp( DEBUGPARAM("DeviceWindows") PIDXDisp_DeviceWindows, pDeviceWindows, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_InterCharacterWait( /*[out, retval]*/ LONG* pInterCharacterWait )
{
    return GetOposProp( DEBUGPARAM("InterCharacterWait") PIDXDisp_InterCharacterWait, pInterCharacterWait, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_InterCharacterWait( /*[in]*/ LONG InterCharacterWait )
{
    return SetOposProp( DEBUGPARAM("InterCharacterWait") PIDXDisp_InterCharacterWait, InterCharacterWait, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_MarqueeFormat( /*[out, retval]*/ LONG* pMarqueeFormat )
{
    return GetOposProp( DEBUGPARAM("MarqueeFormat") PIDXDisp_MarqueeFormat, pMarqueeFormat, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_MarqueeFormat( /*[in]*/ LONG MarqueeFormat )
{
    return SetOposProp( DEBUGPARAM("MarqueeFormat") PIDXDisp_MarqueeFormat, MarqueeFormat, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_MarqueeRepeatWait( /*[out, retval]*/ LONG* pMarqueeRepeatWait )
{
    return GetOposProp( DEBUGPARAM("MarqueeRepeatWait") PIDXDisp_MarqueeRepeatWait, pMarqueeRepeatWait, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_MarqueeRepeatWait( /*[in]*/ LONG MarqueeRepeatWait )
{
    return SetOposProp( DEBUGPARAM("MarqueeRepeatWait") PIDXDisp_MarqueeRepeatWait, MarqueeRepeatWait, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_MarqueeType( /*[out, retval]*/ LONG* pMarqueeType )
{
    return GetOposProp( DEBUGPARAM("MarqueeType") PIDXDisp_MarqueeType, pMarqueeType, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_MarqueeType( /*[in]*/ LONG MarqueeType )
{
    return SetOposProp( DEBUGPARAM("MarqueeType") PIDXDisp_MarqueeType, MarqueeType, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_MarqueeUnitWait( /*[out, retval]*/ LONG* pMarqueeUnitWait )
{
    return GetOposProp( DEBUGPARAM("MarqueeUnitWait") PIDXDisp_MarqueeUnitWait, pMarqueeUnitWait, 0 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_MarqueeUnitWait( /*[in]*/ LONG MarqueeUnitWait )
{
    return SetOposProp( DEBUGPARAM("MarqueeUnitWait") PIDXDisp_MarqueeUnitWait, MarqueeUnitWait, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_Rows( /*[out, retval]*/ LONG* pRows )
{
    return GetOposProp( DEBUGPARAM("Rows") PIDXDisp_Rows, pRows, 0 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSLineDisplay::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSLineDisplay::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSLineDisplay::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSLineDisplay::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSLineDisplay::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSLineDisplay::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSLineDisplay::get_BlinkRate( /*[out, retval]*/ LONG* pBlinkRate )
{
    return GetOposProp( DEBUGPARAM("BlinkRate") PIDXDisp_BlinkRate, pBlinkRate, 6 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_BlinkRate( /*[in]*/ LONG BlinkRate )
{
    return SetOposProp( DEBUGPARAM("BlinkRate") PIDXDisp_BlinkRate, BlinkRate, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapBlinkRate( /*[out, retval]*/ VARIANT_BOOL* pCapBlinkRate )
{
    return GetOposProp( DEBUGPARAM("CapBlinkRate") PIDXDisp_CapBlinkRate, pCapBlinkRate, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapCursorType( /*[out, retval]*/ LONG* pCapCursorType )
{
    return GetOposProp( DEBUGPARAM("CapCursorType") PIDXDisp_CapCursorType, pCapCursorType, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapCustomGlyph( /*[out, retval]*/ VARIANT_BOOL* pCapCustomGlyph )
{
    return GetOposProp( DEBUGPARAM("CapCustomGlyph") PIDXDisp_CapCustomGlyph, pCapCustomGlyph, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapReadBack( /*[out, retval]*/ LONG* pCapReadBack )
{
    return GetOposProp( DEBUGPARAM("CapReadBack") PIDXDisp_CapReadBack, pCapReadBack, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapReverse( /*[out, retval]*/ LONG* pCapReverse )
{
    return GetOposProp( DEBUGPARAM("CapReverse") PIDXDisp_CapReverse, pCapReverse, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CursorType( /*[out, retval]*/ LONG* pCursorType )
{
    return GetOposProp( DEBUGPARAM("CursorType") PIDXDisp_CursorType, pCursorType, 6 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_CursorType( /*[in]*/ LONG CursorType )
{
    return SetOposProp( DEBUGPARAM("CursorType") PIDXDisp_CursorType, CursorType, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CustomGlyphList( /*[out, retval]*/ BSTR* pCustomGlyphList )
{
    return GetOposProp( DEBUGPARAM("CustomGlyphList") PIDXDisp_CustomGlyphList, pCustomGlyphList, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_GlyphHeight( /*[out, retval]*/ LONG* pGlyphHeight )
{
    return GetOposProp( DEBUGPARAM("GlyphHeight") PIDXDisp_GlyphHeight, pGlyphHeight, 6 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_GlyphWidth( /*[out, retval]*/ LONG* pGlyphWidth )
{
    return GetOposProp( DEBUGPARAM("GlyphWidth") PIDXDisp_GlyphWidth, pGlyphWidth, 6 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSLineDisplay::get_CapBitmap( /*[out, retval]*/ VARIANT_BOOL* pCapBitmap )
{
    return GetOposProp( DEBUGPARAM("CapBitmap") PIDXDisp_CapBitmap, pCapBitmap, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapMapCharacterSet( /*[out, retval]*/ VARIANT_BOOL* pCapMapCharacterSet )
{
    return GetOposProp( DEBUGPARAM("CapMapCharacterSet") PIDXDisp_CapMapCharacterSet, pCapMapCharacterSet, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_CapScreenMode( /*[out, retval]*/ VARIANT_BOOL* pCapScreenMode )
{
    return GetOposProp( DEBUGPARAM("CapScreenMode") PIDXDisp_CapScreenMode, pCapScreenMode, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_MapCharacterSet( /*[out, retval]*/ VARIANT_BOOL* pMapCharacterSet )
{
    return GetOposProp( DEBUGPARAM("MapCharacterSet") PIDXDisp_MapCharacterSet, pMapCharacterSet, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_MapCharacterSet( /*[in]*/ VARIANT_BOOL MapCharacterSet )
{
    return SetOposProp( DEBUGPARAM("MapCharacterSet") PIDXDisp_MapCharacterSet, MapCharacterSet, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_MaximumX( /*[out, retval]*/ LONG* pMaximumX )
{
    return GetOposProp( DEBUGPARAM("MaximumX") PIDXDisp_MaximumX, pMaximumX, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_MaximumY( /*[out, retval]*/ LONG* pMaximumY )
{
    return GetOposProp( DEBUGPARAM("MaximumY") PIDXDisp_MaximumY, pMaximumY, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_ScreenMode( /*[out, retval]*/ LONG* pScreenMode )
{
    return GetOposProp( DEBUGPARAM("ScreenMode") PIDXDisp_ScreenMode, pScreenMode, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSLineDisplay::put_ScreenMode( /*[in]*/ LONG ScreenMode )
{
    return SetOposProp( DEBUGPARAM("ScreenMode") PIDXDisp_ScreenMode, ScreenMode, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLineDisplay::get_ScreenModeList( /*[out, retval]*/ BSTR* pScreenModeList )
{
    return GetOposProp( DEBUGPARAM("ScreenModeList") PIDXDisp_ScreenModeList, pScreenModeList, 7 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSLineDisplay::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSLineDisplay::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSLineDisplay::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSLineDisplay::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSLineDisplay::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_LineDisplay.log");
...
#define OPOSCCOCLASS COPOSLineDisplay
#define RCSTRACENAME "OposCCO_LineDisplay"
...
void COPOSLineDisplay::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSLineDisplay::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSLineDisplay::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSLineDisplay::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
