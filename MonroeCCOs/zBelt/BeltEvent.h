/****************************************************************************
**
** BeltEvent.h -- OPOS event firing support.
**
**    This file is included into the Belt Control Object's main
...
#ifndef __BELTEVENT_H__
#define __BELTEVENT_H__
...
//===========================================================================
    ...
    STDMETHOD( SODirectIO )(long EventNumber, long* pData, BSTR* pString)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSBelt >::Fire_DirectIOEvent( EventNumber, pData, pString );
        else
        {
...
//===========================================================================
    ...
    STDMETHOD( SOStatusUpdate)(long Data)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSBelt >::Fire_StatusUpdateEvent( Data );
        else
...
/////////////////////////////////////////////////////////////////////////////
        ...
        HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
    {
        ...
        if ( uMsg == WM_CREATE )
        {
            pThis = (COPOSBelt*) ((LPCREATESTRUCT) lParam)->lpCreateParams;
        ...
        {
            pThis = (COPOSBelt*) ::GetWindowLong( hwnd, 0 );
            if ( pThis != 0 &&
        ...
        case WMU_DIRECT_IO_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSBelt >::Fire_DirectIOEvent(
        ...
        case WMU_STATUS_UPDATE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSBelt >::Fire_StatusUpdateEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
