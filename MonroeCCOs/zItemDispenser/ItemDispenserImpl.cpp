...
TCHAR g_WindowName[] = _T("HW_OPOSItemDispenser");

// Control Object description and version.
char g_ControlDescription[] = "OPOS ItemDispenser Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSItemDispenser::s_nInstances = 0;
...
// Release 1.12 methods
    ...
    "DispenseItem",
        #define nDIDispenseItem 17
    "ReadItemCount",
        #define nDIReadItemCount 18
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS ItemDispenser.
//===========================================================================
...
COPOSItemDispenser::COPOSItemDispenser()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSItemDispenser >(this) )
{
}

//===========================================================================

HRESULT COPOSItemDispenser::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSItemDispenser::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSItemDispenser::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSITEMDISPENSER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSItemDispenser::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSItemDispenser::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSItemDispenser::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSItemDispenser::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSItemDispenser::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_ITEM );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_ITEM), hRC );
...
STDMETHODIMP COPOSItemDispenser::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSItemDispenser::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSItemDispenser::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSItemDispenser::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSItemDispenser::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSItemDispenser::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSItemDispenser::ResetStatistics( 
...
STDMETHODIMP COPOSItemDispenser::RetrieveStatistics( 
...
STDMETHODIMP COPOSItemDispenser::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSItemDispenser::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSItemDispenser::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSItemDispenser::AdjustItemCount( 
    /*[in]*/ LONG ItemCount, 
    /*[in]*/ LONG SlotNumber, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    Vars[1].SetLONG( ItemCount );
    Vars[0].SetLONG( SlotNumber );
    return DoInvoke( DEBUGPARAM("AdjustItemCount") S_OK, Vars, 2, nDIAdjustItemCount, pRC );
}

//===========================================================================

STDMETHODIMP COPOSItemDispenser::DispenseItem( 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetLONG_Ptr( pNumItem, hRC );
    Vars[0].SetLONG( SlotNumber );
    return DoInvoke( DEBUGPARAM("DispenseItem") hRC, Vars, 2, nDIDispenseItem, pRC );
}

//===========================================================================

STDMETHODIMP COPOSItemDispenser::ReadItemCount( 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetLONG_Ptr( pItemCount, hRC );
    Vars[0].SetLONG( SlotNumber );
    return DoInvoke( DEBUGPARAM("ReadItemCount") hRC, Vars, 2, nDIReadItemCount, pRC );
}
...
STDMETHODIMP COPOSItemDispenser::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSItemDispenser::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSItemDispenser::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSItemDispenser::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSItemDispenser::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSItemDispenser::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSItemDispenser::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSItemDispenser::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSItemDispenser::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSItemDispenser::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSItemDispenser::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSItemDispenser::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSItemDispenser::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSItemDispenser::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSItemDispenser::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSItemDispenser::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSItemDispenser::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSItemDispenser::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSItemDispenser::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSItemDispenser::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSItemDispenser::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSItemDispenser::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSItemDispenser::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSItemDispenser::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSItemDispenser::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSItemDispenser::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSItemDispenser::get_CapEmptySensor( /*[out, retval]*/ VARIANT_BOOL* pCapEmptySensor )
{
    return GetOposProp( DEBUGPARAM("CapEmptySensor") PIDXItem_CapEmptySensor, pCapEmptySensor, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSItemDispenser::get_CapIndividualSlotStatus( /*[out, retval]*/ VARIANT_BOOL* pCapIndividualSlotStatus )
{
    return GetOposProp( DEBUGPARAM("CapIndividualSlotStatus") PIDXItem_CapIndividualSlotStatus, pCapIndividualSlotStatus, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSItemDispenser::get_CapJamSensor( /*[out, retval]*/ VARIANT_BOOL* pCapJamSensor )
{
    return GetOposProp( DEBUGPARAM("CapJamSensor") PIDXItem_CapJamSensor, pCapJamSensor, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSItemDispenser::get_CapNearEmptySensor( /*[out, retval]*/ VARIANT_BOOL* pCapNearEmptySensor )
{
    return GetOposProp( DEBUGPARAM("CapNearEmptySensor") PIDXItem_CapNearEmptySensor, pCapNearEmptySensor, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSItemDispenser::get_DispenserStatus( /*[out, retval]*/ LONG* pDispenserStatus )
{
    return GetOposProp( DEBUGPARAM("DispenserStatus") PIDXItem_DispenserStatus, pDispenserStatus, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSItemDispenser::get_MaxSlots( /*[out, retval]*/ LONG* pMaxSlots )
{
    return GetOposProp( DEBUGPARAM("MaxSlots") PIDXItem_MaxSlots, pMaxSlots, 12 /*MinorVersion*/ );
}
...
void COPOSItemDispenser::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_ItemDispenser.log");
...
#define OPOSCCOCLASS COPOSItemDispenser
#define RCSTRACENAME "OposCCO_ItemDispenser"
...
void COPOSItemDispenser::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSItemDispenser::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSItemDispenser::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSItemDispenser::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
