/****************************************************************************
**
** CheckScannerImpl.h -- Main control header file.
**
...
#ifndef __CHECKSCANNERIMPL_H__
#define __CHECKSCANNERIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_CheckScanner.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_CheckScanner.log")
...
// The class...
class ATL_NO_VTABLE COPOSCheckScanner :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSCheckScanner, &IID_IOPOSCheckScanner, &LIBID_OposCheckScanner_CCO>,
    public CComControl<COPOSCheckScanner>,
    public IPersistStreamInitImpl<COPOSCheckScanner>,
    public IOleControlImpl<COPOSCheckScanner>,
    public IOleObjectImpl<COPOSCheckScanner>,
    public IOleInPlaceActiveObjectImpl<COPOSCheckScanner>,
    public IViewObjectExImpl<COPOSCheckScanner>,
    public IOleInPlaceObjectWindowlessImpl<COPOSCheckScanner>,
    public IConnectionPointContainerImpl<COPOSCheckScanner>,
    public IPersistStorageImpl<COPOSCheckScanner>,
    public ISpecifyPropertyPagesImpl<COPOSCheckScanner>,
    public IQuickActivateImpl<COPOSCheckScanner>,
    public IDataObjectImpl<COPOSCheckScanner>,
    public IProvideClassInfo2Impl<&CLSID_OPOSCheckScanner, &DIID__IOPOSCheckScannerEvents, &LIBID_OposCheckScanner_CCO>,
    public IObjectSafetyImpl<COPOSCheckScanner, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSCheckScanner>,
    public CComCoClass<COPOSCheckScanner, &CLSID_OPOSCheckScanner>,
    public CProxy_IOPOSEvents< COPOSCheckScanner >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSCHECKSCANNER)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSCheckScanner)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSCheckScanner)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCheckScanner, IOPOSCheckScanner)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCheckScanner_1_10, IOPOSCheckScanner)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCheckScanner_1_9, IOPOSCheckScanner)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCheckScanner_1_8, IOPOSCheckScanner)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCheckScanner_1_7, IOPOSCheckScanner)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSCheckScanner)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSCheckScanner)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSCheckScannerEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSCheckScanner)
    CHAIN_MSG_MAP(CComControl<COPOSCheckScanner>)
...
// Release 1.7
    ...
    STDMETHOD(ReleaseDevice)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapAutoGenerateFileID)( /*[out, retval]*/ VARIANT_BOOL* pCapAutoGenerateFileID );
    STDMETHOD(get_CapAutoGenerateImageTagData)( /*[out, retval]*/ VARIANT_BOOL* pCapAutoGenerateImageTagData );
    STDMETHOD(get_CapAutoSize)( /*[out, retval]*/ VARIANT_BOOL* pCapAutoSize );
    STDMETHOD(get_CapColor)( /*[out, retval]*/ LONG* pCapColor );
    STDMETHOD(get_CapConcurrentMICR)( /*[out, retval]*/ VARIANT_BOOL* pCapConcurrentMICR );
    STDMETHOD(get_CapDefineCropArea)( /*[out, retval]*/ VARIANT_BOOL* pCapDefineCropArea );
    STDMETHOD(get_CapImageFormat)( /*[out, retval]*/ LONG* pCapImageFormat );
    STDMETHOD(get_CapImageTagData)( /*[out, retval]*/ VARIANT_BOOL* pCapImageTagData );
    STDMETHOD(get_CapMICRDevice)( /*[out, retval]*/ VARIANT_BOOL* pCapMICRDevice );
    STDMETHOD(get_CapStoreImageFiles)( /*[out, retval]*/ VARIANT_BOOL* pCapStoreImageFiles );
    STDMETHOD(get_CapValidationDevice)( /*[out, retval]*/ VARIANT_BOOL* pCapValidationDevice );
    STDMETHOD(get_Color)( /*[out, retval]*/ LONG* pColor );
    STDMETHOD(put_Color)( /*[in]*/ LONG Color );
    STDMETHOD(get_ConcurrentMICR)( /*[out, retval]*/ VARIANT_BOOL* pConcurrentMICR );
    STDMETHOD(put_ConcurrentMICR)( /*[in]*/ VARIANT_BOOL ConcurrentMICR );
    STDMETHOD(get_CropAreaCount)( /*[out, retval]*/ LONG* pCropAreaCount );
    STDMETHOD(get_DocumentHeight)( /*[out, retval]*/ LONG* pDocumentHeight );
    STDMETHOD(put_DocumentHeight)( /*[in]*/ LONG DocumentHeight );
    STDMETHOD(get_DocumentWidth)( /*[out, retval]*/ LONG* pDocumentWidth );
    STDMETHOD(put_DocumentWidth)( /*[in]*/ LONG DocumentWidth );
    STDMETHOD(get_FileID)( /*[out, retval]*/ BSTR* pFileID );
    STDMETHOD(put_FileID)( /*[in]*/ BSTR FileID );
    STDMETHOD(get_FileIndex)( /*[out, retval]*/ LONG* pFileIndex );
    STDMETHOD(put_FileIndex)( /*[in]*/ LONG FileIndex );
    STDMETHOD(get_ImageData)( /*[out, retval]*/ BSTR* pImageData );
    STDMETHOD(get_ImageFormat)( /*[out, retval]*/ LONG* pImageFormat );
    STDMETHOD(put_ImageFormat)( /*[in]*/ LONG ImageFormat );
    STDMETHOD(get_ImageMemoryStatus)( /*[out, retval]*/ LONG* pImageMemoryStatus );
    STDMETHOD(get_ImageTagData)( /*[out, retval]*/ BSTR* pImageTagData );
    STDMETHOD(put_ImageTagData)( /*[in]*/ BSTR ImageTagData );
    STDMETHOD(get_MapMode)( /*[out, retval]*/ LONG* pMapMode );
    STDMETHOD(put_MapMode)( /*[in]*/ LONG MapMode );
    STDMETHOD(get_MaxCropAreas)( /*[out, retval]*/ LONG* pMaxCropAreas );
    STDMETHOD(get_Quality)( /*[out, retval]*/ LONG* pQuality );
    STDMETHOD(put_Quality)( /*[in]*/ LONG Quality );
    STDMETHOD(get_QualityList)( /*[out, retval]*/ BSTR* pQualityList );
    STDMETHOD(get_RemainingImagesEstimate)( /*[out, retval]*/ LONG* pRemainingImagesEstimate );
    ...
    STDMETHOD(EndRemoval)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(RetrieveImage)( 
        /*[in]*/ LONG CropAreaID, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(RetrieveMemory)( 
        /*[in]*/ LONG By, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StoreImage)( 
        /*[in]*/ LONG CropAreaID, 
        /*[out, retval]*/ long* pRC );
// Release 1.8
...
// Release 1.9
    ...
    STDMETHOD(UpdateFirmware)( 
        /*[in]*/ BSTR FirmwareFileName, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapAutoContrast)( /*[out, retval]*/ VARIANT_BOOL* pCapAutoContrast );
...
#endif //__CHECKSCANNERIMPL_H__

// End CheckScannerImpl.h
