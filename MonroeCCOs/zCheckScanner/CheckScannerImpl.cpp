...
TCHAR g_WindowName[] = _T("HW_OPOSCheckScanner");

// Control Object description and version.
char g_ControlDescription[] = "OPOS CheckScanner Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSCheckScanner::s_nInstances = 0;
...
// Release 1.7 methods
    ...
    "ClearImage",
        #define nDIClearImage 14
    "DefineCropArea",
        #define nDIDefineCropArea 15
    "EndInsertion",
        #define nDIEndInsertion 16
    "EndRemoval",
        #define nDIEndRemoval 17
    "RetrieveImage",
        #define nDIRetrieveImage 18
    "RetrieveMemory",
        #define nDIRetrieveMemory 19
    "StoreImage",
        #define nDIStoreImage 20
// Release 1.8 methods
    "ResetStatistics",
        #define nDIResetStatistics 21
    "RetrieveStatistics",
        #define nDIRetrieveStatistics 22
    "UpdateStatistics",
        #define nDIUpdateStatistics 23
// Release 1.9 methods
    "CompareFirmwareVersion",
        #define nDICompareFirmwareVersion 24
    "UpdateFirmware",
        #define nDIUpdateFirmware 25
// Release 1.10 methods
    "ClearInputProperties",
        #define nDIClearInputProperties 26
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS CheckScanner.
//===========================================================================
...
COPOSCheckScanner::COPOSCheckScanner()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSCheckScanner >(this) )
{
}

//===========================================================================

HRESULT COPOSCheckScanner::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSCheckScanner::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSCheckScanner::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSCHECKSCANNER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSCheckScanner::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCheckScanner::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCheckScanner::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSCheckScanner::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSCheckScanner::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_CHK );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_CHK), hRC );
...
STDMETHODIMP COPOSCheckScanner::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCheckScanner::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCheckScanner::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCheckScanner::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSCheckScanner::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCheckScanner::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSCheckScanner::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSCheckScanner::BeginInsertion( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCheckScanner::BeginRemoval( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCheckScanner::ClearImage( 
    /*[in]*/ LONG By, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( By );
    return DoInvoke( DEBUGPARAM("ClearImage") S_OK, &Var, 1, nDIClearImage, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::DefineCropArea( 
    /*[in]*/ LONG CropAreaID, 
    /*[in]*/ LONG X, 
    /*[in]*/ LONG Y, 
    /*[in]*/ LONG CX, 
...
{
    OposVariant Vars[5];
    Vars[4].SetLONG( CropAreaID );
    Vars[3].SetLONG( X );
    Vars[2].SetLONG( Y );
    Vars[1].SetLONG( CX );
    Vars[0].SetLONG( CY );
    return DoInvoke( DEBUGPARAM("DefineCropArea") S_OK, Vars, 5, nDIDefineCropArea, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::EndInsertion( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSCheckScanner::EndRemoval( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSCheckScanner::RetrieveImage( 
    /*[in]*/ LONG CropAreaID, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( CropAreaID );
    return DoInvoke( DEBUGPARAM("RetrieveImage") S_OK, &Var, 1, nDIRetrieveImage, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::RetrieveMemory( 
    /*[in]*/ LONG By, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( By );
    return DoInvoke( DEBUGPARAM("RetrieveMemory") S_OK, &Var, 1, nDIRetrieveMemory, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::StoreImage( 
    /*[in]*/ LONG CropAreaID, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( CropAreaID );
    return DoInvoke( DEBUGPARAM("StoreImage") S_OK, &Var, 1, nDIStoreImage, pRC );
}
...
STDMETHODIMP COPOSCheckScanner::ResetStatistics( 
...
STDMETHODIMP COPOSCheckScanner::RetrieveStatistics( 
...
STDMETHODIMP COPOSCheckScanner::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCheckScanner::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSCheckScanner::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCheckScanner::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSCheckScanner::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSCheckScanner::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSCheckScanner::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSCheckScanner::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSCheckScanner::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSCheckScanner::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSCheckScanner::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSCheckScanner::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
    return GetOposProp( DEBUGPARAM("AutoDisable") PIDX_AutoDisable, pAutoDisable, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
    return SetOposProp( DEBUGPARAM("AutoDisable") PIDX_AutoDisable, AutoDisable, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSCheckScanner::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSCheckScanner::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSCheckScanner::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSCheckScanner::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSCheckScanner::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
    return GetOposProp( DEBUGPARAM("DataCount") PIDX_DataCount, pDataCount, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
    return GetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, pDataEventEnabled, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
    return SetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, DataEventEnabled, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSCheckScanner::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSCheckScanner::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSCheckScanner::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSCheckScanner::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSCheckScanner::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSCheckScanner::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSCheckScanner::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSCheckScanner::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSCheckScanner::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSCheckScanner::get_CapAutoGenerateFileID( /*[out, retval]*/ VARIANT_BOOL* pCapAutoGenerateFileID )
{
    return GetOposProp( DEBUGPARAM("CapAutoGenerateFileID") PIDXChk_CapAutoGenerateFileID, pCapAutoGenerateFileID, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapAutoGenerateImageTagData( /*[out, retval]*/ VARIANT_BOOL* pCapAutoGenerateImageTagData )
{
    return GetOposProp( DEBUGPARAM("CapAutoGenerateImageTagData") PIDXChk_CapAutoGenerateImageTagData, pCapAutoGenerateImageTagData, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapAutoSize( /*[out, retval]*/ VARIANT_BOOL* pCapAutoSize )
{
    return GetOposProp( DEBUGPARAM("CapAutoSize") PIDXChk_CapAutoSize, pCapAutoSize, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapColor( /*[out, retval]*/ LONG* pCapColor )
{
    return GetOposProp( DEBUGPARAM("CapColor") PIDXChk_CapColor, pCapColor, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapConcurrentMICR( /*[out, retval]*/ VARIANT_BOOL* pCapConcurrentMICR )
{
    return GetOposProp( DEBUGPARAM("CapConcurrentMICR") PIDXChk_CapConcurrentMICR, pCapConcurrentMICR, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapDefineCropArea( /*[out, retval]*/ VARIANT_BOOL* pCapDefineCropArea )
{
    return GetOposProp( DEBUGPARAM("CapDefineCropArea") PIDXChk_CapDefineCropArea, pCapDefineCropArea, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapImageFormat( /*[out, retval]*/ LONG* pCapImageFormat )
{
    return GetOposProp( DEBUGPARAM("CapImageFormat") PIDXChk_CapImageFormat, pCapImageFormat, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapImageTagData( /*[out, retval]*/ VARIANT_BOOL* pCapImageTagData )
{
    return GetOposProp( DEBUGPARAM("CapImageTagData") PIDXChk_CapImageTagData, pCapImageTagData, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapMICRDevice( /*[out, retval]*/ VARIANT_BOOL* pCapMICRDevice )
{
    return GetOposProp( DEBUGPARAM("CapMICRDevice") PIDXChk_CapMICRDevice, pCapMICRDevice, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapStoreImageFiles( /*[out, retval]*/ VARIANT_BOOL* pCapStoreImageFiles )
{
    return GetOposProp( DEBUGPARAM("CapStoreImageFiles") PIDXChk_CapStoreImageFiles, pCapStoreImageFiles, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapValidationDevice( /*[out, retval]*/ VARIANT_BOOL* pCapValidationDevice )
{
    return GetOposProp( DEBUGPARAM("CapValidationDevice") PIDXChk_CapValidationDevice, pCapValidationDevice, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_Color( /*[out, retval]*/ LONG* pColor )
{
    return GetOposProp( DEBUGPARAM("Color") PIDXChk_Color, pColor, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_Color( /*[in]*/ LONG Color )
{
    return SetOposProp( DEBUGPARAM("Color") PIDXChk_Color, Color, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_ConcurrentMICR( /*[out, retval]*/ VARIANT_BOOL* pConcurrentMICR )
{
    return GetOposProp( DEBUGPARAM("ConcurrentMICR") PIDXChk_ConcurrentMICR, pConcurrentMICR, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_ConcurrentMICR( /*[in]*/ VARIANT_BOOL ConcurrentMICR )
{
    return SetOposProp( DEBUGPARAM("ConcurrentMICR") PIDXChk_ConcurrentMICR, ConcurrentMICR, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CropAreaCount( /*[out, retval]*/ LONG* pCropAreaCount )
{
    return GetOposProp( DEBUGPARAM("CropAreaCount") PIDXChk_CropAreaCount, pCropAreaCount, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_DocumentHeight( /*[out, retval]*/ LONG* pDocumentHeight )
{
    return GetOposProp( DEBUGPARAM("DocumentHeight") PIDXChk_DocumentHeight, pDocumentHeight, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_DocumentHeight( /*[in]*/ LONG DocumentHeight )
{
    return SetOposProp( DEBUGPARAM("DocumentHeight") PIDXChk_DocumentHeight, DocumentHeight, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_DocumentWidth( /*[out, retval]*/ LONG* pDocumentWidth )
{
    return GetOposProp( DEBUGPARAM("DocumentWidth") PIDXChk_DocumentWidth, pDocumentWidth, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_DocumentWidth( /*[in]*/ LONG DocumentWidth )
{
    return SetOposProp( DEBUGPARAM("DocumentWidth") PIDXChk_DocumentWidth, DocumentWidth, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_FileID( /*[out, retval]*/ BSTR* pFileID )
{
    return GetOposProp( DEBUGPARAM("FileID") PIDXChk_FileID, pFileID, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_FileID( /*[in]*/ BSTR FileID )
{
    return SetOposProp( DEBUGPARAM("FileID") PIDXChk_FileID, FileID, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_FileIndex( /*[out, retval]*/ LONG* pFileIndex )
{
    return GetOposProp( DEBUGPARAM("FileIndex") PIDXChk_FileIndex, pFileIndex, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_FileIndex( /*[in]*/ LONG FileIndex )
{
    return SetOposProp( DEBUGPARAM("FileIndex") PIDXChk_FileIndex, FileIndex, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_ImageData( /*[out, retval]*/ BSTR* pImageData )
{
    return GetOposProp( DEBUGPARAM("ImageData") PIDXChk_ImageData, pImageData, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_ImageFormat( /*[out, retval]*/ LONG* pImageFormat )
{
    return GetOposProp( DEBUGPARAM("ImageFormat") PIDXChk_ImageFormat, pImageFormat, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_ImageFormat( /*[in]*/ LONG ImageFormat )
{
    return SetOposProp( DEBUGPARAM("ImageFormat") PIDXChk_ImageFormat, ImageFormat, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_ImageMemoryStatus( /*[out, retval]*/ LONG* pImageMemoryStatus )
{
    return GetOposProp( DEBUGPARAM("ImageMemoryStatus") PIDXChk_ImageMemoryStatus, pImageMemoryStatus, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_ImageTagData( /*[out, retval]*/ BSTR* pImageTagData )
{
    return GetOposProp( DEBUGPARAM("ImageTagData") PIDXChk_ImageTagData, pImageTagData, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_ImageTagData( /*[in]*/ BSTR ImageTagData )
{
    return SetOposProp( DEBUGPARAM("ImageTagData") PIDXChk_ImageTagData, ImageTagData, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_MapMode( /*[out, retval]*/ LONG* pMapMode )
{
    return GetOposProp( DEBUGPARAM("MapMode") PIDXChk_MapMode, pMapMode, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_MapMode( /*[in]*/ LONG MapMode )
{
    return SetOposProp( DEBUGPARAM("MapMode") PIDXChk_MapMode, MapMode, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_MaxCropAreas( /*[out, retval]*/ LONG* pMaxCropAreas )
{
    return GetOposProp( DEBUGPARAM("MaxCropAreas") PIDXChk_MaxCropAreas, pMaxCropAreas, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_Quality( /*[out, retval]*/ LONG* pQuality )
{
    return GetOposProp( DEBUGPARAM("Quality") PIDXChk_Quality, pQuality, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_Quality( /*[in]*/ LONG Quality )
{
    return SetOposProp( DEBUGPARAM("Quality") PIDXChk_Quality, Quality, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_QualityList( /*[out, retval]*/ BSTR* pQualityList )
{
    return GetOposProp( DEBUGPARAM("QualityList") PIDXChk_QualityList, pQualityList, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_RemainingImagesEstimate( /*[out, retval]*/ LONG* pRemainingImagesEstimate )
{
    return GetOposProp( DEBUGPARAM("RemainingImagesEstimate") PIDXChk_RemainingImagesEstimate, pRemainingImagesEstimate, 7 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSCheckScanner::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSCheckScanner::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSCheckScanner::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSCheckScanner::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSCheckScanner::get_CapAutoContrast( /*[out, retval]*/ VARIANT_BOOL* pCapAutoContrast )
{
    return GetOposProp( DEBUGPARAM("CapAutoContrast") PIDXChk_CapAutoContrast, pCapAutoContrast, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_CapContrast( /*[out, retval]*/ VARIANT_BOOL* pCapContrast )
{
    return GetOposProp( DEBUGPARAM("CapContrast") PIDXChk_CapContrast, pCapContrast, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCheckScanner::get_Contrast( /*[out, retval]*/ LONG* pContrast )
{
    return GetOposProp( DEBUGPARAM("Contrast") PIDXChk_Contrast, pContrast, 9 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCheckScanner::put_Contrast( /*[in]*/ LONG Contrast )
{
    return SetOposProp( DEBUGPARAM("Contrast") PIDXChk_Contrast, Contrast, 9 /*MinorVersion*/ );
}
...
void COPOSCheckScanner::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_CheckScanner.log");
...
#define OPOSCCOCLASS COPOSCheckScanner
#define RCSTRACENAME "OposCCO_CheckScanner"
...
void COPOSCheckScanner::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSCheckScanner::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSCheckScanner::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSCheckScanner::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
