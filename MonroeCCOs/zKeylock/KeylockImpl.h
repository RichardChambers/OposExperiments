/****************************************************************************
**
** KeylockImpl.h -- Main control header file.
**
...
#ifndef __KEYLOCKIMPL_H__
#define __KEYLOCKIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_Keylock.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_Keylock.log")
...
// The class...
class ATL_NO_VTABLE COPOSKeylock :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSKeylock, &IID_IOPOSKeylock, &LIBID_OposKeylock_CCO>,
    public CComControl<COPOSKeylock>,
    public IPersistStreamInitImpl<COPOSKeylock>,
    public IOleControlImpl<COPOSKeylock>,
    public IOleObjectImpl<COPOSKeylock>,
    public IOleInPlaceActiveObjectImpl<COPOSKeylock>,
    public IViewObjectExImpl<COPOSKeylock>,
    public IOleInPlaceObjectWindowlessImpl<COPOSKeylock>,
    public IConnectionPointContainerImpl<COPOSKeylock>,
    public IPersistStorageImpl<COPOSKeylock>,
    public ISpecifyPropertyPagesImpl<COPOSKeylock>,
    public IQuickActivateImpl<COPOSKeylock>,
    public IDataObjectImpl<COPOSKeylock>,
    public IProvideClassInfo2Impl<&CLSID_OPOSKeylock, &DIID__IOPOSKeylockEvents, &LIBID_OposKeylock_CCO>,
    public IObjectSafetyImpl<COPOSKeylock, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSKeylock>,
    public CComCoClass<COPOSKeylock, &CLSID_OPOSKeylock>,
    public CProxy_IOPOSEvents< COPOSKeylock >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSKEYLOCK)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSKeylock)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSKeylock)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSKeylock, IOPOSKeylock)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSKeylock_1_11, IOPOSKeylock)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSKeylock_1_9, IOPOSKeylock)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSKeylock_1_8, IOPOSKeylock)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSKeylock_1_5, IOPOSKeylock)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSKeylock)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSKeylock)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSKeylockEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSKeylock)
    CHAIN_MSG_MAP(CComControl<COPOSKeylock>)
...
// Release 1.0
    ...
    STDMETHOD(ReleaseDevice)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_KeyPosition)( /*[out, retval]*/ LONG* pKeyPosition );
    STDMETHOD(get_PositionCount)( /*[out, retval]*/ LONG* pPositionCount );
    STDMETHOD(WaitForKeylockChange)( 
        /*[in]*/ LONG KeyPosition, 
        /*[in]*/ LONG Timeout, 
        /*[out, retval]*/ long* pRC );
// Release 1.1
...
// Release 1.10
// Release 1.11
    STDMETHOD(get_CapKeylockType)( /*[out, retval]*/ LONG* pCapKeylockType );
    STDMETHOD(get_ElectronicKeyValue)( /*[out, retval]*/ BSTR* pElectronicKeyValue );
// Release 1.12
// Release 1.13
// Release 1.14
};

#endif //__KEYLOCKIMPL_H__
