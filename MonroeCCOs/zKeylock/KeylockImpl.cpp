...
TCHAR g_WindowName[] = _T("HW_OPOSKeylock");

// Control Object description and version.
char g_ControlDescription[] = "OPOS Keylock Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSKeylock::s_nInstances = 0;
...
// Release 1.0 methods
    ...
    "WaitForKeylockChange",
        #define nDIWaitForKeylockChange 11
// Release 1.1 methods
// Release 1.2 methods
// Release 1.3 methods
// Release 1.4 methods
...
//   for each release.
// Followed by the initial minor release of the OPOS Keylock.
//===========================================================================
...
COPOSKeylock::COPOSKeylock()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSKeylock >(this) )
{
}

//===========================================================================

HRESULT COPOSKeylock::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSKeylock::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSKeylock::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSKEYLOCK2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSKeylock::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSKeylock::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSKeylock::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSKeylock::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSKeylock::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_LOCK );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_LOCK), hRC );
...
STDMETHODIMP COPOSKeylock::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSKeylock::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSKeylock::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSKeylock::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSKeylock::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSKeylock::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSKeylock::WaitForKeylockChange( 
    /*[in]*/ LONG KeyPosition, 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    Vars[1].SetLONG( KeyPosition );
    Vars[0].SetLONG( Timeout );
    return DoInvoke( DEBUGPARAM("WaitForKeylockChange") S_OK, Vars, 2, nDIWaitForKeylockChange, pRC );
}
...
STDMETHODIMP COPOSKeylock::ResetStatistics( 
...
STDMETHODIMP COPOSKeylock::RetrieveStatistics( 
...
STDMETHODIMP COPOSKeylock::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSKeylock::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSKeylock::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSKeylock::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSKeylock::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSKeylock::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSKeylock::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSKeylock::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSKeylock::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSKeylock::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSKeylock::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSKeylock::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSKeylock::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSKeylock::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSKeylock::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSKeylock::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSKeylock::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSKeylock::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSKeylock::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSKeylock::get_KeyPosition( /*[out, retval]*/ LONG* pKeyPosition )
{
    return GetOposProp( DEBUGPARAM("KeyPosition") PIDXLock_KeyPosition, pKeyPosition, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSKeylock::get_PositionCount( /*[out, retval]*/ LONG* pPositionCount )
{
    return GetOposProp( DEBUGPARAM("PositionCount") PIDXLock_PositionCount, pPositionCount, 0 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSKeylock::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSKeylock::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSKeylock::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSKeylock::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSKeylock::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSKeylock::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSKeylock::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSKeylock::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSKeylock::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSKeylock::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSKeylock::get_CapKeylockType( /*[out, retval]*/ LONG* pCapKeylockType )
{
    return GetOposProp( DEBUGPARAM("CapKeylockType") PIDXLock_CapKeylockType, pCapKeylockType, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSKeylock::get_ElectronicKeyValue( /*[out, retval]*/ BSTR* pElectronicKeyValue )
{
    return GetOposProp( DEBUGPARAM("ElectronicKeyValue") PIDXLock_ElectronicKeyValue, pElectronicKeyValue, 11 /*MinorVersion*/ );
}
...
void COPOSKeylock::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_Keylock.log");
...
#define OPOSCCOCLASS COPOSKeylock
#define RCSTRACENAME "OposCCO_Keylock"
...
void COPOSKeylock::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSKeylock::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSKeylock::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSKeylock::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
