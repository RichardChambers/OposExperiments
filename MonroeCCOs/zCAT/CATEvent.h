/****************************************************************************
**
** CATEvent.h -- OPOS event firing support.
**
**    This file is included into the CAT Control Object's main
...
#ifndef __CATEVENT_H__
#define __CATEVENT_H__
...
//===========================================================================
    ...
    STDMETHOD( SODirectIO )(long EventNumber, long* pData, BSTR* pString)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSCAT >::Fire_DirectIOEvent( EventNumber, pData, pString );
        else
        {
...
//===========================================================================
                ...
                long ErrorLocus, long* pErrorResponse)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSCAT >::Fire_ErrorEvent( ResultCode, ResultCodeExtended,
...
//===========================================================================
    ...
    STDMETHOD( SOOutputComplete )(long OutputID)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSCAT >::Fire_OutputCompleteEvent( OutputID );
        else
...
//===========================================================================
    ...
    STDMETHOD( SOStatusUpdate)(long Data)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSCAT >::Fire_StatusUpdateEvent( Data );
        else
...
/////////////////////////////////////////////////////////////////////////////
        ...
        HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
    {
        ...
        if ( uMsg == WM_CREATE )
        {
            pThis = (COPOSCAT*) ((LPCREATESTRUCT) lParam)->lpCreateParams;
        ...
        {
            pThis = (COPOSCAT*) ::GetWindowLong( hwnd, 0 );
            if ( pThis != 0 &&
        ...
        case WMU_DIRECT_IO_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSCAT >::Fire_DirectIOEvent(
        ...
        case WMU_ERROR_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSCAT >::Fire_ErrorEvent (
        ...
        case WMU_OUTPUT_COMPLETE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSCAT >::Fire_OutputCompleteEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
        ...
        case WMU_STATUS_UPDATE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSCAT >::Fire_StatusUpdateEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
