/****************************************************************************
**
** POSKeyboardImpl.h -- Main control header file.
**
...
#ifndef __POSKEYBOARDIMPL_H__
#define __POSKEYBOARDIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_POSKeyboard.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_POSKeyboard.log")
...
// The class...
class ATL_NO_VTABLE COPOSPOSKeyboard :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSPOSKeyboard, &IID_IOPOSPOSKeyboard, &LIBID_OposPOSKeyboard_CCO>,
    public CComControl<COPOSPOSKeyboard>,
    public IPersistStreamInitImpl<COPOSPOSKeyboard>,
    public IOleControlImpl<COPOSPOSKeyboard>,
    public IOleObjectImpl<COPOSPOSKeyboard>,
    public IOleInPlaceActiveObjectImpl<COPOSPOSKeyboard>,
    public IViewObjectExImpl<COPOSPOSKeyboard>,
    public IOleInPlaceObjectWindowlessImpl<COPOSPOSKeyboard>,
    public IConnectionPointContainerImpl<COPOSPOSKeyboard>,
    public IPersistStorageImpl<COPOSPOSKeyboard>,
    public ISpecifyPropertyPagesImpl<COPOSPOSKeyboard>,
    public IQuickActivateImpl<COPOSPOSKeyboard>,
    public IDataObjectImpl<COPOSPOSKeyboard>,
    public IProvideClassInfo2Impl<&CLSID_OPOSPOSKeyboard, &DIID__IOPOSPOSKeyboardEvents, &LIBID_OposPOSKeyboard_CCO>,
    public IObjectSafetyImpl<COPOSPOSKeyboard, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSPOSKeyboard>,
    public CComCoClass<COPOSPOSKeyboard, &CLSID_OPOSPOSKeyboard>,
    public CProxy_IOPOSEvents< COPOSPOSKeyboard >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSPOSKEYBOARD)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSPOSKeyboard)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSPOSKeyboard)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSPOSKeyboard, IOPOSPOSKeyboard)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSPOSKeyboard_1_9, IOPOSPOSKeyboard)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSPOSKeyboard_1_8, IOPOSPOSKeyboard)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSPOSKeyboard_1_5, IOPOSPOSKeyboard)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSPOSKeyboard)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSPOSKeyboard)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSPOSKeyboardEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSPOSKeyboard)
    CHAIN_MSG_MAP(CComControl<COPOSPOSKeyboard>)
...
// Release 1.1
    ...
    STDMETHOD(ReleaseDevice)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_POSKeyData)( /*[out, retval]*/ LONG* pPOSKeyData );
// Release 1.2
    ...
    STDMETHOD(get_CapKeyUp)( /*[out, retval]*/ VARIANT_BOOL* pCapKeyUp );
    STDMETHOD(get_EventTypes)( /*[out, retval]*/ LONG* pEventTypes );
    STDMETHOD(put_EventTypes)( /*[in]*/ LONG EventTypes );
    STDMETHOD(get_POSKeyEventType)( /*[out, retval]*/ LONG* pPOSKeyEventType );
// Release 1.3
...
#endif //__POSKEYBOARDIMPL_H__

// End POSKeyboardImpl.h
