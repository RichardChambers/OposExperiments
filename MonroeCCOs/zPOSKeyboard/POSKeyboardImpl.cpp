...
TCHAR g_WindowName[] = _T("HW_OPOSPOSKeyboard");

// Control Object description and version.
char g_ControlDescription[] = "OPOS POSKeyboard Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSPOSKeyboard::s_nInstances = 0;
...
//   for each release.
// Followed by the initial minor release of the OPOS POSKeyboard.
//===========================================================================
...
const int MinorReleaseInitial = 1;
...
COPOSPOSKeyboard::COPOSPOSKeyboard()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSPOSKeyboard >(this) )
{
}

//===========================================================================

HRESULT COPOSPOSKeyboard::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSPOSKeyboard::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSPOSKeyboard::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSPOSKEYBOARD2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSPOSKeyboard::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSPOSKeyboard::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSPOSKeyboard::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSPOSKeyboard::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_KBD );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_KBD), hRC );
...
STDMETHODIMP COPOSPOSKeyboard::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPOSKeyboard::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPOSKeyboard::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPOSKeyboard::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSPOSKeyboard::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPOSKeyboard::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSPOSKeyboard::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSPOSKeyboard::ResetStatistics( 
...
STDMETHODIMP COPOSPOSKeyboard::RetrieveStatistics( 
...
STDMETHODIMP COPOSPOSKeyboard::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPOSKeyboard::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSPOSKeyboard::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPOSKeyboard::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSPOSKeyboard::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSPOSKeyboard::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSPOSKeyboard::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
    return GetOposProp( DEBUGPARAM("CheckHealthText") PIDX_CheckHealthText, pCheckHealthText, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
    return GetOposProp( DEBUGPARAM("Claimed") PIDX_Claimed, pClaimed, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
    return GetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, pDataEventEnabled, 1 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPOSKeyboard::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
    return SetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, DataEventEnabled, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
    return GetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, pDeviceEnabled, 1 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPOSKeyboard::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
    return SetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, DeviceEnabled, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
    return GetOposProp( DEBUGPARAM("ResultCodeExtended") PIDX_ResultCodeExtended, pResultCodeExtended, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectDescription") PIDX_ServiceObjectDescription, pServiceObjectDescription, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectVersion") PIDX_ServiceObjectVersion, pServiceObjectVersion, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
    return GetOposProp( DEBUGPARAM("DeviceDescription") PIDX_DeviceDescription, pDeviceDescription, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
    return GetOposProp( DEBUGPARAM("DeviceName") PIDX_DeviceName, pDeviceName, 1 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_POSKeyData( /*[out, retval]*/ LONG* pPOSKeyData )
{
    return GetOposProp( DEBUGPARAM("POSKeyData") PIDXKbd_POSKeyData, pPOSKeyData, 1 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSPOSKeyboard::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSPOSKeyboard::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSPOSKeyboard::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_CapKeyUp( /*[out, retval]*/ VARIANT_BOOL* pCapKeyUp )
{
    return GetOposProp( DEBUGPARAM("CapKeyUp") PIDXKbd_CapKeyUp, pCapKeyUp, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_EventTypes( /*[out, retval]*/ LONG* pEventTypes )
{
    return GetOposProp( DEBUGPARAM("EventTypes") PIDXKbd_EventTypes, pEventTypes, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPOSKeyboard::put_EventTypes( /*[in]*/ LONG EventTypes )
{
    return SetOposProp( DEBUGPARAM("EventTypes") PIDXKbd_EventTypes, EventTypes, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSKeyboard::get_POSKeyEventType( /*[out, retval]*/ LONG* pPOSKeyEventType )
{
    return GetOposProp( DEBUGPARAM("POSKeyEventType") PIDXKbd_POSKeyEventType, pPOSKeyEventType, 2 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSPOSKeyboard::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSPOSKeyboard::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSPOSKeyboard::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSPOSKeyboard::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_POSKeyboard.log");
...
#define OPOSCCOCLASS COPOSPOSKeyboard
#define RCSTRACENAME "OposCCO_POSKeyboard"
...
void COPOSPOSKeyboard::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSPOSKeyboard::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSPOSKeyboard::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSPOSKeyboard::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
