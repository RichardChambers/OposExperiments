/****************************************************************************
**
** POSPowerImpl.h -- Main control header file.
**
...
#ifndef __POSPOWERIMPL_H__
#define __POSPOWERIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_POSPower.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_POSPower.log")
...
// The class...
class ATL_NO_VTABLE COPOSPOSPower :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSPOSPower, &IID_IOPOSPOSPower, &LIBID_OposPOSPower_CCO>,
    public CComControl<COPOSPOSPower>,
    public IPersistStreamInitImpl<COPOSPOSPower>,
    public IOleControlImpl<COPOSPOSPower>,
    public IOleObjectImpl<COPOSPOSPower>,
    public IOleInPlaceActiveObjectImpl<COPOSPOSPower>,
    public IViewObjectExImpl<COPOSPOSPower>,
    public IOleInPlaceObjectWindowlessImpl<COPOSPOSPower>,
    public IConnectionPointContainerImpl<COPOSPOSPower>,
    public IPersistStorageImpl<COPOSPOSPower>,
    public ISpecifyPropertyPagesImpl<COPOSPOSPower>,
    public IQuickActivateImpl<COPOSPOSPower>,
    public IDataObjectImpl<COPOSPOSPower>,
    public IProvideClassInfo2Impl<&CLSID_OPOSPOSPower, &DIID__IOPOSPOSPowerEvents, &LIBID_OposPOSPower_CCO>,
    public IObjectSafetyImpl<COPOSPOSPower, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSPOSPower>,
    public CComCoClass<COPOSPOSPower, &CLSID_OPOSPOSPower>,
    public CProxy_IOPOSEvents< COPOSPOSPower >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSPOSPOWER)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSPOSPower)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSPOSPower)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSPOSPower)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSPOSPowerEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSPOSPower)
    CHAIN_MSG_MAP(CComControl<COPOSPOSPower>)
...
// Release 1.5
    ...
    STDMETHOD(ReleaseDevice)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapFanAlarm)( /*[out, retval]*/ VARIANT_BOOL* pCapFanAlarm );
    STDMETHOD(get_CapHeatAlarm)( /*[out, retval]*/ VARIANT_BOOL* pCapHeatAlarm );
    STDMETHOD(get_CapQuickCharge)( /*[out, retval]*/ VARIANT_BOOL* pCapQuickCharge );
    STDMETHOD(get_CapShutdownPOS)( /*[out, retval]*/ VARIANT_BOOL* pCapShutdownPOS );
    STDMETHOD(get_CapUPSChargeState)( /*[out, retval]*/ LONG* pCapUPSChargeState );
    STDMETHOD(get_EnforcedShutdownDelayTime)( /*[out, retval]*/ LONG* pEnforcedShutdownDelayTime );
    STDMETHOD(put_EnforcedShutdownDelayTime)( /*[in]*/ LONG EnforcedShutdownDelayTime );
    STDMETHOD(get_PowerFailDelayTime)( /*[out, retval]*/ LONG* pPowerFailDelayTime );
    STDMETHOD(get_QuickChargeMode)( /*[out, retval]*/ VARIANT_BOOL* pQuickChargeMode );
    STDMETHOD(get_QuickChargeTime)( /*[out, retval]*/ LONG* pQuickChargeTime );
    STDMETHOD(get_UPSChargeState)( /*[out, retval]*/ LONG* pUPSChargeState );
    STDMETHOD(ShutdownPOS)( 
        /*[out, retval]*/ long* pRC );
// Release 1.6
// Release 1.7
// Release 1.8
...
// Release 1.9
    ...
    STDMETHOD(UpdateFirmware)( 
        /*[in]*/ BSTR FirmwareFileName, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_BatteryCapacityRemaining)( /*[out, retval]*/ LONG* pBatteryCapacityRemaining );
    STDMETHOD(get_BatteryCriticallyLowThreshold)( /*[out, retval]*/ LONG* pBatteryCriticallyLowThreshold );
    STDMETHOD(put_BatteryCriticallyLowThreshold)( /*[in]*/ LONG BatteryCriticallyLowThreshold );
    STDMETHOD(get_BatteryLowThreshold)( /*[out, retval]*/ LONG* pBatteryLowThreshold );
    STDMETHOD(put_BatteryLowThreshold)( /*[in]*/ LONG BatteryLowThreshold );
    STDMETHOD(get_CapBatteryCapacityRemaining)( /*[out, retval]*/ VARIANT_BOOL* pCapBatteryCapacityRemaining );
    STDMETHOD(get_CapRestartPOS)( /*[out, retval]*/ VARIANT_BOOL* pCapRestartPOS );
    STDMETHOD(get_CapStandbyPOS)( /*[out, retval]*/ VARIANT_BOOL* pCapStandbyPOS );
    STDMETHOD(get_CapSuspendPOS)( /*[out, retval]*/ VARIANT_BOOL* pCapSuspendPOS );
    STDMETHOD(get_CapVariableBatteryCriticallyLowThreshold)( /*[out, retval]*/ VARIANT_BOOL* pCapVariableBatteryCriticallyLowThreshold );
    STDMETHOD(get_CapVariableBatteryLowThreshold)( /*[out, retval]*/ VARIANT_BOOL* pCapVariableBatteryLowThreshold );
    STDMETHOD(get_PowerSource)( /*[out, retval]*/ LONG* pPowerSource );
    STDMETHOD(RestartPOS)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StandbyPOS)( 
        /*[in]*/ LONG Reason, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(SuspendPOS)( 
        /*[in]*/ LONG Reason, 
        /*[out, retval]*/ long* pRC );
// Release 1.10
// Release 1.11
