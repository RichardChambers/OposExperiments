...
TCHAR g_WindowName[] = _T("HW_OPOSPOSPower");

// Control Object description and version.
char g_ControlDescription[] = "OPOS POSPower Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSPOSPower::s_nInstances = 0;
...
// Release 1.9 methods
    ...
    "RestartPOS",
        #define nDIRestartPOS 17
    "StandbyPOS",
        #define nDIStandbyPOS 18
    "SuspendPOS",
        #define nDISuspendPOS 19
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS POSPower.
//===========================================================================
...
COPOSPOSPower::COPOSPOSPower()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSPOSPower >(this) )
{
}

//===========================================================================

HRESULT COPOSPOSPower::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSPOSPower::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSPOSPower::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSPOSPOWER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSPOSPower::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSPOSPower::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSPOSPower::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSPOSPower::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSPOSPower::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_PWR );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_PWR), hRC );
...
STDMETHODIMP COPOSPOSPower::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPOSPower::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPOSPower::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPOSPower::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSPOSPower::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPOSPower::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSPOSPower::ShutdownPOS( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("ShutdownPOS") S_OK, NULL, 0, nDIShutdownPOS, pRC );
}
...
STDMETHODIMP COPOSPOSPower::ResetStatistics( 
...
STDMETHODIMP COPOSPOSPower::RetrieveStatistics( 
...
STDMETHODIMP COPOSPOSPower::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPOSPower::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSPOSPower::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPOSPower::RestartPOS( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("RestartPOS") S_OK, NULL, 0, nDIRestartPOS, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::StandbyPOS( 
    /*[in]*/ LONG Reason, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Reason );
    return DoInvoke( DEBUGPARAM("StandbyPOS") S_OK, &Var, 1, nDIStandbyPOS, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::SuspendPOS( 
    /*[in]*/ LONG Reason, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Reason );
    return DoInvoke( DEBUGPARAM("SuspendPOS") S_OK, &Var, 1, nDISuspendPOS, pRC );
}
...
STDMETHODIMP COPOSPOSPower::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSPOSPower::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSPOSPower::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSPOSPower::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSPOSPower::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSPOSPower::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSPOSPower::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSPOSPower::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSPOSPower::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSPOSPower::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSPOSPower::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSPOSPower::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSPOSPower::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSPOSPower::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSPOSPower::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSPOSPower::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSPOSPower::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSPOSPower::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSPOSPower::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSPOSPower::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSPOSPower::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSPOSPower::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSPOSPower::get_CapFanAlarm( /*[out, retval]*/ VARIANT_BOOL* pCapFanAlarm )
{
    return GetOposProp( DEBUGPARAM("CapFanAlarm") PIDXPwr_CapFanAlarm, pCapFanAlarm, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapHeatAlarm( /*[out, retval]*/ VARIANT_BOOL* pCapHeatAlarm )
{
    return GetOposProp( DEBUGPARAM("CapHeatAlarm") PIDXPwr_CapHeatAlarm, pCapHeatAlarm, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapQuickCharge( /*[out, retval]*/ VARIANT_BOOL* pCapQuickCharge )
{
    return GetOposProp( DEBUGPARAM("CapQuickCharge") PIDXPwr_CapQuickCharge, pCapQuickCharge, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapShutdownPOS( /*[out, retval]*/ VARIANT_BOOL* pCapShutdownPOS )
{
    return GetOposProp( DEBUGPARAM("CapShutdownPOS") PIDXPwr_CapShutdownPOS, pCapShutdownPOS, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapUPSChargeState( /*[out, retval]*/ LONG* pCapUPSChargeState )
{
    return GetOposProp( DEBUGPARAM("CapUPSChargeState") PIDXPwr_CapUPSChargeState, pCapUPSChargeState, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_EnforcedShutdownDelayTime( /*[out, retval]*/ LONG* pEnforcedShutdownDelayTime )
{
    return GetOposProp( DEBUGPARAM("EnforcedShutdownDelayTime") PIDXPwr_EnforcedShutdownDelayTime, pEnforcedShutdownDelayTime, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPOSPower::put_EnforcedShutdownDelayTime( /*[in]*/ LONG EnforcedShutdownDelayTime )
{
    return SetOposProp( DEBUGPARAM("EnforcedShutdownDelayTime") PIDXPwr_EnforcedShutdownDelayTime, EnforcedShutdownDelayTime, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_PowerFailDelayTime( /*[out, retval]*/ LONG* pPowerFailDelayTime )
{
    return GetOposProp( DEBUGPARAM("PowerFailDelayTime") PIDXPwr_PowerFailDelayTime, pPowerFailDelayTime, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_QuickChargeMode( /*[out, retval]*/ VARIANT_BOOL* pQuickChargeMode )
{
    return GetOposProp( DEBUGPARAM("QuickChargeMode") PIDXPwr_QuickChargeMode, pQuickChargeMode, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_QuickChargeTime( /*[out, retval]*/ LONG* pQuickChargeTime )
{
    return GetOposProp( DEBUGPARAM("QuickChargeTime") PIDXPwr_QuickChargeTime, pQuickChargeTime, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_UPSChargeState( /*[out, retval]*/ LONG* pUPSChargeState )
{
    return GetOposProp( DEBUGPARAM("UPSChargeState") PIDXPwr_UPSChargeState, pUPSChargeState, 5 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSPOSPower::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSPOSPower::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSPOSPower::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSPOSPower::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSPOSPower::get_BatteryCapacityRemaining( /*[out, retval]*/ LONG* pBatteryCapacityRemaining )
{
    return GetOposProp( DEBUGPARAM("BatteryCapacityRemaining") PIDXPwr_BatteryCapacityRemaining, pBatteryCapacityRemaining, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_BatteryCriticallyLowThreshold( /*[out, retval]*/ LONG* pBatteryCriticallyLowThreshold )
{
    return GetOposProp( DEBUGPARAM("BatteryCriticallyLowThreshold") PIDXPwr_BatteryCriticallyLowThreshold, pBatteryCriticallyLowThreshold, 9 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPOSPower::put_BatteryCriticallyLowThreshold( /*[in]*/ LONG BatteryCriticallyLowThreshold )
{
    return SetOposProp( DEBUGPARAM("BatteryCriticallyLowThreshold") PIDXPwr_BatteryCriticallyLowThreshold, BatteryCriticallyLowThreshold, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_BatteryLowThreshold( /*[out, retval]*/ LONG* pBatteryLowThreshold )
{
    return GetOposProp( DEBUGPARAM("BatteryLowThreshold") PIDXPwr_BatteryLowThreshold, pBatteryLowThreshold, 9 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPOSPower::put_BatteryLowThreshold( /*[in]*/ LONG BatteryLowThreshold )
{
    return SetOposProp( DEBUGPARAM("BatteryLowThreshold") PIDXPwr_BatteryLowThreshold, BatteryLowThreshold, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapBatteryCapacityRemaining( /*[out, retval]*/ VARIANT_BOOL* pCapBatteryCapacityRemaining )
{
    return GetOposProp( DEBUGPARAM("CapBatteryCapacityRemaining") PIDXPwr_CapBatteryCapacityRemaining, pCapBatteryCapacityRemaining, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapRestartPOS( /*[out, retval]*/ VARIANT_BOOL* pCapRestartPOS )
{
    return GetOposProp( DEBUGPARAM("CapRestartPOS") PIDXPwr_CapRestartPOS, pCapRestartPOS, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapStandbyPOS( /*[out, retval]*/ VARIANT_BOOL* pCapStandbyPOS )
{
    return GetOposProp( DEBUGPARAM("CapStandbyPOS") PIDXPwr_CapStandbyPOS, pCapStandbyPOS, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapSuspendPOS( /*[out, retval]*/ VARIANT_BOOL* pCapSuspendPOS )
{
    return GetOposProp( DEBUGPARAM("CapSuspendPOS") PIDXPwr_CapSuspendPOS, pCapSuspendPOS, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapVariableBatteryCriticallyLowThreshold( /*[out, retval]*/ VARIANT_BOOL* pCapVariableBatteryCriticallyLowThreshold )
{
    return GetOposProp( DEBUGPARAM("CapVariableBatteryCriticallyLowThreshold") PIDXPwr_CapVariableBatteryCriticallyLowThreshold, pCapVariableBatteryCriticallyLowThreshold, 9 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPOSPower::get_CapVariableBatteryLowThreshold( /*[out, retval]*/ VARIANT_BOOL* pCapVariableBatteryLowThreshold )
{
    return GetOposProp( DEBUGPARAM("CapVariableBatteryLowThreshold") PIDXPwr_CapVariableBatteryLowThreshold, pCapVariableBatteryLowThreshold, 9 /*MinorVersion*/ );
}
...
void COPOSPOSPower::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_POSPower.log");
...
#define OPOSCCOCLASS COPOSPOSPower
#define RCSTRACENAME "OposCCO_POSPower"
...
void COPOSPOSPower::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSPOSPower::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSPOSPower::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSPOSPower::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
