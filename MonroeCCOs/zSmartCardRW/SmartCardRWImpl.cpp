...
#include "SmartCardRW.h"

// Include this control's header.
#include "SmartCardRWImpl.h"
...
TCHAR g_WindowName[] = _T("HW_OPOSSmartCardRW");

// Control Object description and version.
char g_ControlDescription[] = "OPOS SmartCardRW Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSSmartCardRW::s_nInstances = 0;
...
// Release 1.8 methods
    ...
    "BeginInsertion",
        #define nDIBeginInsertion 16
    "BeginRemoval",
        #define nDIBeginRemoval 17
    "EndInsertion",
        #define nDIEndInsertion 18
    "EndRemoval",
        #define nDIEndRemoval 19
    "ReadData",
        #define nDIReadData 20
    "WriteData",
        #define nDIWriteData 21
// Release 1.9 methods
...
// Release 1.10 methods
    "ClearInputProperties",
        #define nDIClearInputProperties 24
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS SmartCardRW.
//===========================================================================
...
const int MinorReleaseInitial = 8;
...
COPOSSmartCardRW::COPOSSmartCardRW()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSSmartCardRW >(this) )
{
}

//===========================================================================

HRESULT COPOSSmartCardRW::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSSmartCardRW::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSSmartCardRW::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSSMARTCARDRW2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSSmartCardRW::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSmartCardRW::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSmartCardRW::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSSmartCardRW::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSSmartCardRW::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_SCRW );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_SCRW), hRC );
...
STDMETHODIMP COPOSSmartCardRW::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSmartCardRW::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSmartCardRW::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSmartCardRW::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSSmartCardRW::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSmartCardRW::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSmartCardRW::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSmartCardRW::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSSmartCardRW::ResetStatistics( 
...
STDMETHODIMP COPOSSmartCardRW::RetrieveStatistics( 
...
STDMETHODIMP COPOSSmartCardRW::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSmartCardRW::BeginInsertion( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSmartCardRW::BeginRemoval( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSmartCardRW::EndInsertion( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSmartCardRW::EndRemoval( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSmartCardRW::ReadData( 
    /*[in]*/ LONG Action, 
    /*[in, out]*/ LONG* pCount, 
    /*[in, out]*/ BSTR* pData, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[3];
    HRESULT hRC = S_OK;
    Vars[2].SetLONG( Action );
    Vars[1].SetLONG_Ptr( pCount, hRC );
    Vars[0].SetBSTR_InOutPtr( pData, hRC );
    return DoInvoke( DEBUGPARAM("ReadData") hRC, Vars, 3, nDIReadData, pRC );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::WriteData( 
    /*[in]*/ LONG Action, 
    /*[in]*/ LONG Count, 
    /*[in]*/ BSTR Data, 
    /*[out, retval]*/ long* pRC )
{
    ...
    HRESULT hRC = S_OK;
    Vars[2].SetLONG( Action );
    Vars[1].SetLONG( Count );
    Vars[0].SetBSTR( Data, hRC );
    return DoInvoke( DEBUGPARAM("WriteData") hRC, Vars, 3, nDIWriteData, pRC );
}
...
STDMETHODIMP COPOSSmartCardRW::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSSmartCardRW::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSmartCardRW::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSmartCardRW::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSSmartCardRW::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSSmartCardRW::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSSmartCardRW::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSSmartCardRW::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSSmartCardRW::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSSmartCardRW::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSSmartCardRW::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
    return GetOposProp( DEBUGPARAM("BinaryConversion") PIDX_BinaryConversion, pBinaryConversion, 8 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSmartCardRW::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
    IFDEBUG( _nBinaryConversion = BinaryConversion);
    return SetOposProp( DEBUGPARAM("BinaryConversion") PIDX_BinaryConversion, BinaryConversion, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
    return GetOposProp( DEBUGPARAM("CapPowerReporting") PIDX_CapPowerReporting, pCapPowerReporting, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
    return GetOposProp( DEBUGPARAM("CheckHealthText") PIDX_CheckHealthText, pCheckHealthText, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
    return GetOposProp( DEBUGPARAM("Claimed") PIDX_Claimed, pClaimed, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
    return GetOposProp( DEBUGPARAM("DataCount") PIDX_DataCount, pDataCount, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
    return GetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, pDataEventEnabled, 8 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSmartCardRW::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
    return SetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, DataEventEnabled, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
    return GetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, pDeviceEnabled, 8 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSmartCardRW::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
    return SetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, DeviceEnabled, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
    return GetOposProp( DEBUGPARAM("OutputID") PIDX_OutputID, pOutputID, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
    return GetOposProp( DEBUGPARAM("PowerNotify") PIDX_PowerNotify, pPowerNotify, 8 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSmartCardRW::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
    return SetOposProp( DEBUGPARAM("PowerNotify") PIDX_PowerNotify, PowerNotify, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
    return GetOposProp( DEBUGPARAM("PowerState") PIDX_PowerState, pPowerState, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
    return GetOposProp( DEBUGPARAM("ResultCodeExtended") PIDX_ResultCodeExtended, pResultCodeExtended, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectDescription") PIDX_ServiceObjectDescription, pServiceObjectDescription, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectVersion") PIDX_ServiceObjectVersion, pServiceObjectVersion, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
    return GetOposProp( DEBUGPARAM("DeviceDescription") PIDX_DeviceDescription, pDeviceDescription, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
    return GetOposProp( DEBUGPARAM("DeviceName") PIDX_DeviceName, pDeviceName, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSSmartCardRW::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSSmartCardRW::get_CapCardErrorDetection( /*[out, retval]*/ VARIANT_BOOL* pCapCardErrorDetection )
{
    return GetOposProp( DEBUGPARAM("CapCardErrorDetection") PIDXScrw_CapCardErrorDetection, pCapCardErrorDetection, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_CapInterfaceMode( /*[out, retval]*/ LONG* pCapInterfaceMode )
{
    return GetOposProp( DEBUGPARAM("CapInterfaceMode") PIDXScrw_CapInterfaceMode, pCapInterfaceMode, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_CapIsoEmvMode( /*[out, retval]*/ LONG* pCapIsoEmvMode )
{
    return GetOposProp( DEBUGPARAM("CapIsoEmvMode") PIDXScrw_CapIsoEmvMode, pCapIsoEmvMode, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_CapSCPresentSensor( /*[out, retval]*/ LONG* pCapSCPresentSensor )
{
    return GetOposProp( DEBUGPARAM("CapSCPresentSensor") PIDXScrw_CapSCPresentSensor, pCapSCPresentSensor, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_CapSCSlots( /*[out, retval]*/ LONG* pCapSCSlots )
{
    return GetOposProp( DEBUGPARAM("CapSCSlots") PIDXScrw_CapSCSlots, pCapSCSlots, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_CapTransmissionProtocol( /*[out, retval]*/ LONG* pCapTransmissionProtocol )
{
    return GetOposProp( DEBUGPARAM("CapTransmissionProtocol") PIDXScrw_CapTransmissionProtocol, pCapTransmissionProtocol, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_InterfaceMode( /*[out, retval]*/ LONG* pInterfaceMode )
{
    return GetOposProp( DEBUGPARAM("InterfaceMode") PIDXScrw_InterfaceMode, pInterfaceMode, 8 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSmartCardRW::put_InterfaceMode( /*[in]*/ LONG InterfaceMode )
{
    return SetOposProp( DEBUGPARAM("InterfaceMode") PIDXScrw_InterfaceMode, InterfaceMode, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_IsoEmvMode( /*[out, retval]*/ LONG* pIsoEmvMode )
{
    return GetOposProp( DEBUGPARAM("IsoEmvMode") PIDXScrw_IsoEmvMode, pIsoEmvMode, 8 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSmartCardRW::put_IsoEmvMode( /*[in]*/ LONG IsoEmvMode )
{
    return SetOposProp( DEBUGPARAM("IsoEmvMode") PIDXScrw_IsoEmvMode, IsoEmvMode, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_SCPresentSensor( /*[out, retval]*/ LONG* pSCPresentSensor )
{
    return GetOposProp( DEBUGPARAM("SCPresentSensor") PIDXScrw_SCPresentSensor, pSCPresentSensor, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_SCSlot( /*[out, retval]*/ LONG* pSCSlot )
{
    return GetOposProp( DEBUGPARAM("SCSlot") PIDXScrw_SCSlot, pSCSlot, 8 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSmartCardRW::put_SCSlot( /*[in]*/ LONG SCSlot )
{
    return SetOposProp( DEBUGPARAM("SCSlot") PIDXScrw_SCSlot, SCSlot, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_TransactionInProgress( /*[out, retval]*/ VARIANT_BOOL* pTransactionInProgress )
{
    return GetOposProp( DEBUGPARAM("TransactionInProgress") PIDXScrw_TransactionInProgress, pTransactionInProgress, 8 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSmartCardRW::get_TransmissionProtocol( /*[out, retval]*/ LONG* pTransmissionProtocol )
{
    return GetOposProp( DEBUGPARAM("TransmissionProtocol") PIDXScrw_TransmissionProtocol, pTransmissionProtocol, 8 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSSmartCardRW::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSSmartCardRW::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSSmartCardRW::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_SmartCardRW.log");
...
#define OPOSCCOCLASS COPOSSmartCardRW
#define RCSTRACENAME "OposCCO_SmartCardRW"
...
void COPOSSmartCardRW::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSSmartCardRW::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSSmartCardRW::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSSmartCardRW::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
