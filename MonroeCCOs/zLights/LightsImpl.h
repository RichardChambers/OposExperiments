/****************************************************************************
**
** LightsImpl.h -- Main control header file.
**
...
#ifndef __LIGHTSIMPL_H__
#define __LIGHTSIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_Lights.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_Lights.log")
...
// The class...
class ATL_NO_VTABLE COPOSLights :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSLights, &IID_IOPOSLights, &LIBID_OposLights_CCO>,
    public CComControl<COPOSLights>,
    public IPersistStreamInitImpl<COPOSLights>,
    public IOleControlImpl<COPOSLights>,
    public IOleObjectImpl<COPOSLights>,
    public IOleInPlaceActiveObjectImpl<COPOSLights>,
    public IViewObjectExImpl<COPOSLights>,
    public IOleInPlaceObjectWindowlessImpl<COPOSLights>,
    public IConnectionPointContainerImpl<COPOSLights>,
    public IPersistStorageImpl<COPOSLights>,
    public ISpecifyPropertyPagesImpl<COPOSLights>,
    public IQuickActivateImpl<COPOSLights>,
    public IDataObjectImpl<COPOSLights>,
    public IProvideClassInfo2Impl<&CLSID_OPOSLights, &DIID__IOPOSLightsEvents, &LIBID_OposLights_CCO>,
    public IObjectSafetyImpl<COPOSLights, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSLights>,
    public CComCoClass<COPOSLights, &CLSID_OPOSLights>,
    public CProxy_IOPOSEvents< COPOSLights >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSLIGHTS)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSLights)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSLights)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSLights)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSLightsEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSLights)
    CHAIN_MSG_MAP(CComControl<COPOSLights>)
...
// Release 1.12
    ...
    STDMETHOD(UpdateFirmware)( 
        /*[in]*/ BSTR FirmwareFileName, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapAlarm)( /*[out, retval]*/ LONG* pCapAlarm );
    STDMETHOD(get_CapBlink)( /*[out, retval]*/ VARIANT_BOOL* pCapBlink );
    STDMETHOD(get_CapColor)( /*[out, retval]*/ LONG* pCapColor );
    STDMETHOD(get_MaxLights)( /*[out, retval]*/ LONG* pMaxLights );
    STDMETHOD(SwitchOff)( 
        /*[in]*/ LONG LightNumber, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(SwitchOn)( 
