...
TCHAR g_WindowName[] = _T("HW_OPOSLights");

// Control Object description and version.
char g_ControlDescription[] = "OPOS Lights Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSLights::s_nInstances = 0;
...
//   for each release.
// Followed by the initial minor release of the OPOS Lights.
//===========================================================================
...
COPOSLights::COPOSLights()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSLights >(this) )
{
}

//===========================================================================

HRESULT COPOSLights::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSLights::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSLights::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSLIGHTS2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSLights::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSLights::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSLights::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSLights::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSLights::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_LGT );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_LGT), hRC );
...
STDMETHODIMP COPOSLights::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSLights::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSLights::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSLights::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSLights::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSLights::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSLights::ResetStatistics( 
...
STDMETHODIMP COPOSLights::RetrieveStatistics( 
...
STDMETHODIMP COPOSLights::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSLights::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSLights::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSLights::SwitchOff( 
    /*[in]*/ LONG LightNumber, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( LightNumber );
    return DoInvoke( DEBUGPARAM("SwitchOff") S_OK, &Var, 1, nDISwitchOff, pRC );
}

//===========================================================================

STDMETHODIMP COPOSLights::SwitchOn( 
    /*[in]*/ LONG LightNumber, 
...
STDMETHODIMP COPOSLights::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSLights::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSLights::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSLights::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSLights::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSLights::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSLights::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSLights::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSLights::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSLights::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSLights::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSLights::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSLights::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSLights::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSLights::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSLights::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSLights::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSLights::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSLights::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSLights::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSLights::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSLights::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSLights::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSLights::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSLights::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSLights::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSLights::get_CapAlarm( /*[out, retval]*/ LONG* pCapAlarm )
{
    return GetOposProp( DEBUGPARAM("CapAlarm") PIDXLgt_CapAlarm, pCapAlarm, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLights::get_CapBlink( /*[out, retval]*/ VARIANT_BOOL* pCapBlink )
{
    return GetOposProp( DEBUGPARAM("CapBlink") PIDXLgt_CapBlink, pCapBlink, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLights::get_CapColor( /*[out, retval]*/ LONG* pCapColor )
{
    return GetOposProp( DEBUGPARAM("CapColor") PIDXLgt_CapColor, pCapColor, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSLights::get_MaxLights( /*[out, retval]*/ LONG* pMaxLights )
{
...
void COPOSLights::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_Lights.log");
...
#define OPOSCCOCLASS COPOSLights
#define RCSTRACENAME "OposCCO_Lights"
...
void COPOSLights::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSLights::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSLights::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSLights::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
