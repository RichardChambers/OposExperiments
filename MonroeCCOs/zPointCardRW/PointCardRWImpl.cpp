...
#include "PointCardRW.h"

// Include this control's header.
#include "PointCardRWImpl.h"
...
char g_ControlDescription[] = "OPOS PointCardRW Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSPointCardRW::s_nInstances = 0;
...
// Release 1.5 methods
    ...
    "BeginInsertion",
        #define nDIBeginInsertion 13
    "BeginRemoval",
        #define nDIBeginRemoval 14
    "CleanCard",
        #define nDICleanCard 15
    "ClearPrintWrite",
        #define nDIClearPrintWrite 16
    "EndInsertion",
        #define nDIEndInsertion 17
    "EndRemoval",
        #define nDIEndRemoval 18
    "PrintWrite",
        #define nDIPrintWrite 19
    "RotatePrint",
        #define nDIRotatePrint 20
    "ValidateData",
        #define nDIValidateData 21
// Release 1.6 methods
// Release 1.7 methods
// Release 1.8 methods
    "ResetStatistics",
        #define nDIResetStatistics 22
    "RetrieveStatistics",
        #define nDIRetrieveStatistics 23
    "UpdateStatistics",
        #define nDIUpdateStatistics 24
// Release 1.9 methods
    "CompareFirmwareVersion",
        #define nDICompareFirmwareVersion 25
    "UpdateFirmware",
        #define nDIUpdateFirmware 26
// Release 1.10 methods
    "ClearInputProperties",
        #define nDIClearInputProperties 27
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS PointCardRW.
//===========================================================================
...
const int MinorReleaseInitial = 5;
...
COPOSPointCardRW::COPOSPointCardRW()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSPointCardRW >(this) )
{
}

//===========================================================================

HRESULT COPOSPointCardRW::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSPointCardRW::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSPointCardRW::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSPOINTCARDRW2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSPointCardRW::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSPointCardRW::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSPointCardRW::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSPointCardRW::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSPointCardRW::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_PCRW );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_PCRW), hRC );
...
STDMETHODIMP COPOSPointCardRW::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPointCardRW::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPointCardRW::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPointCardRW::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSPointCardRW::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPointCardRW::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSPointCardRW::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSPointCardRW::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSPointCardRW::BeginInsertion( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPointCardRW::BeginRemoval( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPointCardRW::CleanCard( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("CleanCard") S_OK, NULL, 0, nDICleanCard, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::ClearPrintWrite( 
    /*[in]*/ LONG Kind, 
    /*[in]*/ LONG Hposition, 
    /*[in]*/ LONG Vposition, 
    /*[in]*/ LONG Width, 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[5];
    Vars[4].SetLONG( Kind );
    Vars[3].SetLONG( Hposition );
    Vars[2].SetLONG( Vposition );
    Vars[1].SetLONG( Width );
    Vars[0].SetLONG( Height );
    return DoInvoke( DEBUGPARAM("ClearPrintWrite") S_OK, Vars, 5, nDIClearPrintWrite, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::EndInsertion( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSPointCardRW::EndRemoval( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSPointCardRW::PrintWrite( 
    /*[in]*/ LONG Kind, 
    /*[in]*/ LONG Hposition, 
    /*[in]*/ LONG Vposition, 
    /*[in]*/ BSTR Data, 
    /*[out, retval]*/ long* pRC )
{
    ...
    HRESULT hRC = S_OK;
    Vars[3].SetLONG( Kind );
    Vars[2].SetLONG( Hposition );
    Vars[1].SetLONG( Vposition );
    Vars[0].SetBSTR( Data, hRC );
    return DoInvoke( DEBUGPARAM("PrintWrite") hRC, Vars, 4, nDIPrintWrite, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::RotatePrint( 
    /*[in]*/ LONG Rotation, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Rotation );
    return DoInvoke( DEBUGPARAM("RotatePrint") S_OK, &Var, 1, nDIRotatePrint, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::ValidateData( 
    /*[in]*/ BSTR Data, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( Data, hRC );
    return DoInvoke( DEBUGPARAM("ValidateData") hRC, &Var, 1, nDIValidateData, pRC );
}
...
STDMETHODIMP COPOSPointCardRW::ResetStatistics( 
...
STDMETHODIMP COPOSPointCardRW::RetrieveStatistics( 
...
STDMETHODIMP COPOSPointCardRW::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPointCardRW::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSPointCardRW::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPointCardRW::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSPointCardRW::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSPointCardRW::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSPointCardRW::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSPointCardRW::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSPointCardRW::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSPointCardRW::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSPointCardRW::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSPointCardRW::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
    return GetOposProp( DEBUGPARAM("BinaryConversion") PIDX_BinaryConversion, pBinaryConversion, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
    IFDEBUG( _nBinaryConversion = BinaryConversion);
    return SetOposProp( DEBUGPARAM("BinaryConversion") PIDX_BinaryConversion, BinaryConversion, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
    return GetOposProp( DEBUGPARAM("CapPowerReporting") PIDX_CapPowerReporting, pCapPowerReporting, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
    return GetOposProp( DEBUGPARAM("CheckHealthText") PIDX_CheckHealthText, pCheckHealthText, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
    return GetOposProp( DEBUGPARAM("Claimed") PIDX_Claimed, pClaimed, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
    return GetOposProp( DEBUGPARAM("DataCount") PIDX_DataCount, pDataCount, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
    return GetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, pDataEventEnabled, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
    return SetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, DataEventEnabled, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
    return GetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, pDeviceEnabled, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
    return SetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, DeviceEnabled, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
    return GetOposProp( DEBUGPARAM("OutputID") PIDX_OutputID, pOutputID, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
    return GetOposProp( DEBUGPARAM("PowerNotify") PIDX_PowerNotify, pPowerNotify, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
    return SetOposProp( DEBUGPARAM("PowerNotify") PIDX_PowerNotify, PowerNotify, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
    return GetOposProp( DEBUGPARAM("PowerState") PIDX_PowerState, pPowerState, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
    return GetOposProp( DEBUGPARAM("ResultCodeExtended") PIDX_ResultCodeExtended, pResultCodeExtended, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectDescription") PIDX_ServiceObjectDescription, pServiceObjectDescription, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectVersion") PIDX_ServiceObjectVersion, pServiceObjectVersion, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
    return GetOposProp( DEBUGPARAM("DeviceDescription") PIDX_DeviceDescription, pDeviceDescription, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
    return GetOposProp( DEBUGPARAM("DeviceName") PIDX_DeviceName, pDeviceName, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapBold( /*[out, retval]*/ VARIANT_BOOL* pCapBold )
{
    return GetOposProp( DEBUGPARAM("CapBold") PIDXPcrw_CapBold, pCapBold, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapCardEntranceSensor( /*[out, retval]*/ VARIANT_BOOL* pCapCardEntranceSensor )
{
    return GetOposProp( DEBUGPARAM("CapCardEntranceSensor") PIDXPcrw_CapCardEntranceSensor, pCapCardEntranceSensor, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapCharacterSet( /*[out, retval]*/ LONG* pCapCharacterSet )
{
    return GetOposProp( DEBUGPARAM("CapCharacterSet") PIDXPcrw_CapCharacterSet, pCapCharacterSet, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapCleanCard( /*[out, retval]*/ VARIANT_BOOL* pCapCleanCard )
{
    return GetOposProp( DEBUGPARAM("CapCleanCard") PIDXPcrw_CapCleanCard, pCapCleanCard, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapClearPrint( /*[out, retval]*/ VARIANT_BOOL* pCapClearPrint )
{
    return GetOposProp( DEBUGPARAM("CapClearPrint") PIDXPcrw_CapClearPrint, pCapClearPrint, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapDhigh( /*[out, retval]*/ VARIANT_BOOL* pCapDhigh )
{
    return GetOposProp( DEBUGPARAM("CapDhigh") PIDXPcrw_CapDhigh, pCapDhigh, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapDwide( /*[out, retval]*/ VARIANT_BOOL* pCapDwide )
{
    return GetOposProp( DEBUGPARAM("CapDwide") PIDXPcrw_CapDwide, pCapDwide, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapDwideDhigh( /*[out, retval]*/ VARIANT_BOOL* pCapDwideDhigh )
{
    return GetOposProp( DEBUGPARAM("CapDwideDhigh") PIDXPcrw_CapDwideDhigh, pCapDwideDhigh, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapItalic( /*[out, retval]*/ VARIANT_BOOL* pCapItalic )
{
    return GetOposProp( DEBUGPARAM("CapItalic") PIDXPcrw_CapItalic, pCapItalic, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapLeft90( /*[out, retval]*/ VARIANT_BOOL* pCapLeft90 )
{
    return GetOposProp( DEBUGPARAM("CapLeft90") PIDXPcrw_CapLeft90, pCapLeft90, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapPrint( /*[out, retval]*/ VARIANT_BOOL* pCapPrint )
{
    return GetOposProp( DEBUGPARAM("CapPrint") PIDXPcrw_CapPrint, pCapPrint, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapPrintMode( /*[out, retval]*/ VARIANT_BOOL* pCapPrintMode )
{
    return GetOposProp( DEBUGPARAM("CapPrintMode") PIDXPcrw_CapPrintMode, pCapPrintMode, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapRight90( /*[out, retval]*/ VARIANT_BOOL* pCapRight90 )
{
    return GetOposProp( DEBUGPARAM("CapRight90") PIDXPcrw_CapRight90, pCapRight90, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapRotate180( /*[out, retval]*/ VARIANT_BOOL* pCapRotate180 )
{
    return GetOposProp( DEBUGPARAM("CapRotate180") PIDXPcrw_CapRotate180, pCapRotate180, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapTracksToRead( /*[out, retval]*/ LONG* pCapTracksToRead )
{
    return GetOposProp( DEBUGPARAM("CapTracksToRead") PIDXPcrw_CapTracksToRead, pCapTracksToRead, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CapTracksToWrite( /*[out, retval]*/ LONG* pCapTracksToWrite )
{
    return GetOposProp( DEBUGPARAM("CapTracksToWrite") PIDXPcrw_CapTracksToWrite, pCapTracksToWrite, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CardState( /*[out, retval]*/ LONG* pCardState )
{
    return GetOposProp( DEBUGPARAM("CardState") PIDXPcrw_CardState, pCardState, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CharacterSet( /*[out, retval]*/ LONG* pCharacterSet )
{
    return GetOposProp( DEBUGPARAM("CharacterSet") PIDXPcrw_CharacterSet, pCharacterSet, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_CharacterSet( /*[in]*/ LONG CharacterSet )
{
    return SetOposProp( DEBUGPARAM("CharacterSet") PIDXPcrw_CharacterSet, CharacterSet, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_CharacterSetList( /*[out, retval]*/ BSTR* pCharacterSetList )
{
    return GetOposProp( DEBUGPARAM("CharacterSetList") PIDXPcrw_CharacterSetList, pCharacterSetList, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_FontTypeFaceList( /*[out, retval]*/ BSTR* pFontTypeFaceList )
{
    return GetOposProp( DEBUGPARAM("FontTypeFaceList") PIDXPcrw_FontTypeFaceList, pFontTypeFaceList, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_LineChars( /*[out, retval]*/ LONG* pLineChars )
{
    return GetOposProp( DEBUGPARAM("LineChars") PIDXPcrw_LineChars, pLineChars, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_LineChars( /*[in]*/ LONG LineChars )
{
    return SetOposProp( DEBUGPARAM("LineChars") PIDXPcrw_LineChars, LineChars, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_LineCharsList( /*[out, retval]*/ BSTR* pLineCharsList )
{
    return GetOposProp( DEBUGPARAM("LineCharsList") PIDXPcrw_LineCharsList, pLineCharsList, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_LineHeight( /*[out, retval]*/ LONG* pLineHeight )
{
    return GetOposProp( DEBUGPARAM("LineHeight") PIDXPcrw_LineHeight, pLineHeight, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_LineHeight( /*[in]*/ LONG LineHeight )
{
    return SetOposProp( DEBUGPARAM("LineHeight") PIDXPcrw_LineHeight, LineHeight, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_LineSpacing( /*[out, retval]*/ LONG* pLineSpacing )
{
    return GetOposProp( DEBUGPARAM("LineSpacing") PIDXPcrw_LineSpacing, pLineSpacing, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_LineSpacing( /*[in]*/ LONG LineSpacing )
{
    return SetOposProp( DEBUGPARAM("LineSpacing") PIDXPcrw_LineSpacing, LineSpacing, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_LineWidth( /*[out, retval]*/ LONG* pLineWidth )
{
    return GetOposProp( DEBUGPARAM("LineWidth") PIDXPcrw_LineWidth, pLineWidth, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_MapMode( /*[out, retval]*/ LONG* pMapMode )
{
    return GetOposProp( DEBUGPARAM("MapMode") PIDXPcrw_MapMode, pMapMode, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_MapMode( /*[in]*/ LONG MapMode )
{
    return SetOposProp( DEBUGPARAM("MapMode") PIDXPcrw_MapMode, MapMode, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_MaxLine( /*[out, retval]*/ LONG* pMaxLine )
{
    return GetOposProp( DEBUGPARAM("MaxLine") PIDXPcrw_MaxLine, pMaxLine, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_PrintHeight( /*[out, retval]*/ LONG* pPrintHeight )
{
    return GetOposProp( DEBUGPARAM("PrintHeight") PIDXPcrw_PrintHeight, pPrintHeight, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_ReadState1( /*[out, retval]*/ LONG* pReadState1 )
{
    return GetOposProp( DEBUGPARAM("ReadState1") PIDXPcrw_ReadState1, pReadState1, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_ReadState2( /*[out, retval]*/ LONG* pReadState2 )
{
    return GetOposProp( DEBUGPARAM("ReadState2") PIDXPcrw_ReadState2, pReadState2, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_RecvLength1( /*[out, retval]*/ LONG* pRecvLength1 )
{
    return GetOposProp( DEBUGPARAM("RecvLength1") PIDXPcrw_RecvLength1, pRecvLength1, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_RecvLength2( /*[out, retval]*/ LONG* pRecvLength2 )
{
    return GetOposProp( DEBUGPARAM("RecvLength2") PIDXPcrw_RecvLength2, pRecvLength2, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_SidewaysMaxChars( /*[out, retval]*/ LONG* pSidewaysMaxChars )
{
    return GetOposProp( DEBUGPARAM("SidewaysMaxChars") PIDXPcrw_SidewaysMaxChars, pSidewaysMaxChars, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_SidewaysMaxLines( /*[out, retval]*/ LONG* pSidewaysMaxLines )
{
    return GetOposProp( DEBUGPARAM("SidewaysMaxLines") PIDXPcrw_SidewaysMaxLines, pSidewaysMaxLines, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Track1Data( /*[out, retval]*/ BSTR* pTrack1Data )
{
    return GetOposProp( DEBUGPARAM("Track1Data") PIDXPcrw_Track1Data, pTrack1Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Track2Data( /*[out, retval]*/ BSTR* pTrack2Data )
{
    return GetOposProp( DEBUGPARAM("Track2Data") PIDXPcrw_Track2Data, pTrack2Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Track3Data( /*[out, retval]*/ BSTR* pTrack3Data )
{
    return GetOposProp( DEBUGPARAM("Track3Data") PIDXPcrw_Track3Data, pTrack3Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Track4Data( /*[out, retval]*/ BSTR* pTrack4Data )
{
    return GetOposProp( DEBUGPARAM("Track4Data") PIDXPcrw_Track4Data, pTrack4Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Track5Data( /*[out, retval]*/ BSTR* pTrack5Data )
{
    return GetOposProp( DEBUGPARAM("Track5Data") PIDXPcrw_Track5Data, pTrack5Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Track6Data( /*[out, retval]*/ BSTR* pTrack6Data )
{
    return GetOposProp( DEBUGPARAM("Track6Data") PIDXPcrw_Track6Data, pTrack6Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_TracksToRead( /*[out, retval]*/ LONG* pTracksToRead )
{
    return GetOposProp( DEBUGPARAM("TracksToRead") PIDXPcrw_TracksToRead, pTracksToRead, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_TracksToRead( /*[in]*/ LONG TracksToRead )
{
    return SetOposProp( DEBUGPARAM("TracksToRead") PIDXPcrw_TracksToRead, TracksToRead, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_TracksToWrite( /*[out, retval]*/ LONG* pTracksToWrite )
{
    return GetOposProp( DEBUGPARAM("TracksToWrite") PIDXPcrw_TracksToWrite, pTracksToWrite, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_TracksToWrite( /*[in]*/ LONG TracksToWrite )
{
    return SetOposProp( DEBUGPARAM("TracksToWrite") PIDXPcrw_TracksToWrite, TracksToWrite, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Write1Data( /*[out, retval]*/ BSTR* pWrite1Data )
{
    return GetOposProp( DEBUGPARAM("Write1Data") PIDXPcrw_Write1Data, pWrite1Data, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_Write1Data( /*[in]*/ BSTR Write1Data )
{
    return SetOposProp( DEBUGPARAM("Write1Data") PIDXPcrw_Write1Data, Write1Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Write2Data( /*[out, retval]*/ BSTR* pWrite2Data )
{
    return GetOposProp( DEBUGPARAM("Write2Data") PIDXPcrw_Write2Data, pWrite2Data, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_Write2Data( /*[in]*/ BSTR Write2Data )
{
    return SetOposProp( DEBUGPARAM("Write2Data") PIDXPcrw_Write2Data, Write2Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Write3Data( /*[out, retval]*/ BSTR* pWrite3Data )
{
    return GetOposProp( DEBUGPARAM("Write3Data") PIDXPcrw_Write3Data, pWrite3Data, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_Write3Data( /*[in]*/ BSTR Write3Data )
{
    return SetOposProp( DEBUGPARAM("Write3Data") PIDXPcrw_Write3Data, Write3Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Write4Data( /*[out, retval]*/ BSTR* pWrite4Data )
{
    return GetOposProp( DEBUGPARAM("Write4Data") PIDXPcrw_Write4Data, pWrite4Data, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_Write4Data( /*[in]*/ BSTR Write4Data )
{
    return SetOposProp( DEBUGPARAM("Write4Data") PIDXPcrw_Write4Data, Write4Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Write5Data( /*[out, retval]*/ BSTR* pWrite5Data )
{
    return GetOposProp( DEBUGPARAM("Write5Data") PIDXPcrw_Write5Data, pWrite5Data, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_Write5Data( /*[in]*/ BSTR Write5Data )
{
    return SetOposProp( DEBUGPARAM("Write5Data") PIDXPcrw_Write5Data, Write5Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_Write6Data( /*[out, retval]*/ BSTR* pWrite6Data )
{
    return GetOposProp( DEBUGPARAM("Write6Data") PIDXPcrw_Write6Data, pWrite6Data, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_Write6Data( /*[in]*/ BSTR Write6Data )
{
    return SetOposProp( DEBUGPARAM("Write6Data") PIDXPcrw_Write6Data, Write6Data, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_WriteState1( /*[out, retval]*/ LONG* pWriteState1 )
{
    return GetOposProp( DEBUGPARAM("WriteState1") PIDXPcrw_WriteState1, pWriteState1, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_WriteState2( /*[out, retval]*/ LONG* pWriteState2 )
{
    return GetOposProp( DEBUGPARAM("WriteState2") PIDXPcrw_WriteState2, pWriteState2, 5 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSPointCardRW::get_CapMapCharacterSet( /*[out, retval]*/ VARIANT_BOOL* pCapMapCharacterSet )
{
    return GetOposProp( DEBUGPARAM("CapMapCharacterSet") PIDXPcrw_CapMapCharacterSet, pCapMapCharacterSet, 7 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPointCardRW::get_MapCharacterSet( /*[out, retval]*/ VARIANT_BOOL* pMapCharacterSet )
{
    return GetOposProp( DEBUGPARAM("MapCharacterSet") PIDXPcrw_MapCharacterSet, pMapCharacterSet, 7 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPointCardRW::put_MapCharacterSet( /*[in]*/ VARIANT_BOOL MapCharacterSet )
{
    return SetOposProp( DEBUGPARAM("MapCharacterSet") PIDXPcrw_MapCharacterSet, MapCharacterSet, 7 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSPointCardRW::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSPointCardRW::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSPointCardRW::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSPointCardRW::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSPointCardRW::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_PointCardRW.log");
...
#define OPOSCCOCLASS COPOSPointCardRW
#define RCSTRACENAME "OposCCO_PointCardRW"
...
void COPOSPointCardRW::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSPointCardRW::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSPointCardRW::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSPointCardRW::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
