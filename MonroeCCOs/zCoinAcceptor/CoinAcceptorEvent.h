/****************************************************************************
**
** CoinAcceptorEvent.h -- OPOS event firing support.
**
**    This file is included into the CoinAcceptor Control Object's main
...
#ifndef __COINACCEPTOREVENT_H__
#define __COINACCEPTOREVENT_H__
...
/////////////////////////////////////////////////////////////////////////////
    ...
    STDMETHOD( SOData )(long Status)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSCoinAcceptor >::Fire_DataEvent( Status );
        else
...
//===========================================================================
    ...
    STDMETHOD( SODirectIO )(long EventNumber, long* pData, BSTR* pString)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSCoinAcceptor >::Fire_DirectIOEvent( EventNumber, pData, pString );
        else
        {
...
//===========================================================================
    ...
    STDMETHOD( SOStatusUpdate)(long Data)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSCoinAcceptor >::Fire_StatusUpdateEvent( Data );
        else
...
/////////////////////////////////////////////////////////////////////////////
    ...
    {
        COPOSCoinAcceptor* pThis;

        // On window creation, save our window instance into user window space.
        if ( uMsg == WM_CREATE )
        {
            pThis = (COPOSCoinAcceptor*) ((LPCREATESTRUCT) lParam)->lpCreateParams;
        ...
        {
            pThis = (COPOSCoinAcceptor*) ::GetWindowLong( hwnd, 0 );
            if ( pThis != 0 &&
        ...
        case WMU_DATA_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSCoinAcceptor >::Fire_DataEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
        ...
        case WMU_DIRECT_IO_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSCoinAcceptor >::Fire_DirectIOEvent(
        ...
        case WMU_STATUS_UPDATE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSCoinAcceptor >::Fire_StatusUpdateEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
...
#endif //__COINACCEPTOREVENT_H__

// end CoinAcceptorEvent.h
