...
TCHAR g_WindowName[] = _T("HW_OPOSCoinAcceptor");

// Control Object description and version.
char g_ControlDescription[] = "OPOS CoinAcceptor Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSCoinAcceptor::s_nInstances = 0;
...
//   for each release.
// Followed by the initial minor release of the OPOS CoinAcceptor.
//===========================================================================
...
COPOSCoinAcceptor::COPOSCoinAcceptor()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSCoinAcceptor >(this) )
{
}

//===========================================================================

HRESULT COPOSCoinAcceptor::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSCoinAcceptor::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSCoinAcceptor::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSCOINACCEPTOR2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSCoinAcceptor::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCoinAcceptor::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCoinAcceptor::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSCoinAcceptor::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSCoinAcceptor::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_CACC );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_CACC), hRC );
...
STDMETHODIMP COPOSCoinAcceptor::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCoinAcceptor::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCoinAcceptor::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCoinAcceptor::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSCoinAcceptor::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinAcceptor::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSCoinAcceptor::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSCoinAcceptor::ResetStatistics( 
...
STDMETHODIMP COPOSCoinAcceptor::RetrieveStatistics( 
...
STDMETHODIMP COPOSCoinAcceptor::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinAcceptor::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSCoinAcceptor::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinAcceptor::AdjustCashCounts( 
    /*[in]*/ BSTR CashCounts, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinAcceptor::BeginDeposit( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSCoinAcceptor::EndDeposit( 
    /*[in]*/ LONG Success, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinAcceptor::FixDeposit( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSCoinAcceptor::PauseDeposit( 
    /*[in]*/ LONG Control, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinAcceptor::ReadCashCounts( 
...
STDMETHODIMP COPOSCoinAcceptor::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSCoinAcceptor::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSCoinAcceptor::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSCoinAcceptor::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSCoinAcceptor::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSCoinAcceptor::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSCoinAcceptor::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSCoinAcceptor::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSCoinAcceptor::get_CapDiscrepancy( /*[out, retval]*/ VARIANT_BOOL* pCapDiscrepancy )
{
    return GetOposProp( DEBUGPARAM("CapDiscrepancy") PIDXCacc_CapDiscrepancy, pCapDiscrepancy, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_CapFullSensor( /*[out, retval]*/ VARIANT_BOOL* pCapFullSensor )
{
    return GetOposProp( DEBUGPARAM("CapFullSensor") PIDXCacc_CapFullSensor, pCapFullSensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_CapJamSensor( /*[out, retval]*/ VARIANT_BOOL* pCapJamSensor )
{
    return GetOposProp( DEBUGPARAM("CapJamSensor") PIDXCacc_CapJamSensor, pCapJamSensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_CapNearFullSensor( /*[out, retval]*/ VARIANT_BOOL* pCapNearFullSensor )
{
    return GetOposProp( DEBUGPARAM("CapNearFullSensor") PIDXCacc_CapNearFullSensor, pCapNearFullSensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_CapPauseDeposit( /*[out, retval]*/ VARIANT_BOOL* pCapPauseDeposit )
{
    return GetOposProp( DEBUGPARAM("CapPauseDeposit") PIDXCacc_CapPauseDeposit, pCapPauseDeposit, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_CapRealTimeData( /*[out, retval]*/ VARIANT_BOOL* pCapRealTimeData )
{
    return GetOposProp( DEBUGPARAM("CapRealTimeData") PIDXCacc_CapRealTimeData, pCapRealTimeData, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_CurrencyCode( /*[out, retval]*/ BSTR* pCurrencyCode )
{
    return GetOposProp( DEBUGPARAM("CurrencyCode") PIDXCacc_CurrencyCode, pCurrencyCode, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCoinAcceptor::put_CurrencyCode( /*[in]*/ BSTR CurrencyCode )
{
    return SetOposProp( DEBUGPARAM("CurrencyCode") PIDXCacc_CurrencyCode, CurrencyCode, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_DepositAmount( /*[out, retval]*/ LONG* pDepositAmount )
{
    return GetOposProp( DEBUGPARAM("DepositAmount") PIDXCacc_DepositAmount, pDepositAmount, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_DepositCashList( /*[out, retval]*/ BSTR* pDepositCashList )
{
    return GetOposProp( DEBUGPARAM("DepositCashList") PIDXCacc_DepositCashList, pDepositCashList, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_DepositCodeList( /*[out, retval]*/ BSTR* pDepositCodeList )
{
    return GetOposProp( DEBUGPARAM("DepositCodeList") PIDXCacc_DepositCodeList, pDepositCodeList, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_DepositCounts( /*[out, retval]*/ BSTR* pDepositCounts )
{
    return GetOposProp( DEBUGPARAM("DepositCounts") PIDXCacc_DepositCounts, pDepositCounts, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_DepositStatus( /*[out, retval]*/ LONG* pDepositStatus )
{
    return GetOposProp( DEBUGPARAM("DepositStatus") PIDXCacc_DepositStatus, pDepositStatus, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_FullStatus( /*[out, retval]*/ LONG* pFullStatus )
{
    return GetOposProp( DEBUGPARAM("FullStatus") PIDXCacc_FullStatus, pFullStatus, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinAcceptor::get_RealTimeDataEnabled( /*[out, retval]*/ VARIANT_BOOL* pRealTimeDataEnabled )
{
    return GetOposProp( DEBUGPARAM("RealTimeDataEnabled") PIDXCacc_RealTimeDataEnabled, pRealTimeDataEnabled, 11 /*MinorVersion*/ );
}
...
void COPOSCoinAcceptor::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_CoinAcceptor.log");
...
#define OPOSCCOCLASS COPOSCoinAcceptor
#define RCSTRACENAME "OposCCO_CoinAcceptor"
...
void COPOSCoinAcceptor::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSCoinAcceptor::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSCoinAcceptor::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSCoinAcceptor::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
