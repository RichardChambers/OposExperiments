...
#include "BillDispenser.h"

// Include this control's header.
#include "BillDispenserImpl.h"
...
TCHAR g_WindowName[] = _T("HW_OPOSBillDispenser");

// Control Object description and version.
char g_ControlDescription[] = "OPOS BillDispenser Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSBillDispenser::s_nInstances = 0;
...
// Release 1.11 methods
    ...
    "AdjustCashCounts",
        #define nDIAdjustCashCounts 16
    "DispenseCash",
        #define nDIDispenseCash 17
    "ReadCashCounts",
        #define nDIReadCashCounts 18
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS BillDispenser.
//===========================================================================
...
COPOSBillDispenser::COPOSBillDispenser()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSBillDispenser >(this) )
{
}

//===========================================================================

HRESULT COPOSBillDispenser::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSBillDispenser::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSBillDispenser::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSBILLDISPENSER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSBillDispenser::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSBillDispenser::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSBillDispenser::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSBillDispenser::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSBillDispenser::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_BDSP );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_BDSP), hRC );
...
STDMETHODIMP COPOSBillDispenser::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBillDispenser::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBillDispenser::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBillDispenser::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSBillDispenser::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillDispenser::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSBillDispenser::ResetStatistics( 
...
STDMETHODIMP COPOSBillDispenser::RetrieveStatistics( 
...
STDMETHODIMP COPOSBillDispenser::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillDispenser::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSBillDispenser::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillDispenser::AdjustCashCounts( 
    /*[in]*/ BSTR CashCounts, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillDispenser::DispenseCash( 
    /*[in]*/ BSTR CashCounts, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillDispenser::ReadCashCounts( 
...
STDMETHODIMP COPOSBillDispenser::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSBillDispenser::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSBillDispenser::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSBillDispenser::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSBillDispenser::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSBillDispenser::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSBillDispenser::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSBillDispenser::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSBillDispenser::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSBillDispenser::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSBillDispenser::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSBillDispenser::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSBillDispenser::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSBillDispenser::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSBillDispenser::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSBillDispenser::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSBillDispenser::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSBillDispenser::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSBillDispenser::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSBillDispenser::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSBillDispenser::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSBillDispenser::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSBillDispenser::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSBillDispenser::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSBillDispenser::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSBillDispenser::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSBillDispenser::get_CapDiscrepancy( /*[out, retval]*/ VARIANT_BOOL* pCapDiscrepancy )
{
    return GetOposProp( DEBUGPARAM("CapDiscrepancy") PIDXBdsp_CapDiscrepancy, pCapDiscrepancy, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_CapEmptySensor( /*[out, retval]*/ VARIANT_BOOL* pCapEmptySensor )
{
    return GetOposProp( DEBUGPARAM("CapEmptySensor") PIDXBdsp_CapEmptySensor, pCapEmptySensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_CapJamSensor( /*[out, retval]*/ VARIANT_BOOL* pCapJamSensor )
{
    return GetOposProp( DEBUGPARAM("CapJamSensor") PIDXBdsp_CapJamSensor, pCapJamSensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_CapNearEmptySensor( /*[out, retval]*/ VARIANT_BOOL* pCapNearEmptySensor )
{
    return GetOposProp( DEBUGPARAM("CapNearEmptySensor") PIDXBdsp_CapNearEmptySensor, pCapNearEmptySensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_AsyncMode( /*[out, retval]*/ VARIANT_BOOL* pAsyncMode )
{
    return GetOposProp( DEBUGPARAM("AsyncMode") PIDXBdsp_AsyncMode, pAsyncMode, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBillDispenser::put_AsyncMode( /*[in]*/ VARIANT_BOOL AsyncMode )
{
    return SetOposProp( DEBUGPARAM("AsyncMode") PIDXBdsp_AsyncMode, AsyncMode, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_AsyncResultCode( /*[out, retval]*/ LONG* pAsyncResultCode )
{
    return GetOposProp( DEBUGPARAM("AsyncResultCode") PIDXBdsp_AsyncResultCode, pAsyncResultCode, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_AsyncResultCodeExtended( /*[out, retval]*/ LONG* pAsyncResultCodeExtended )
{
    return GetOposProp( DEBUGPARAM("AsyncResultCodeExtended") PIDXBdsp_AsyncResultCodeExtended, pAsyncResultCodeExtended, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_CurrencyCashList( /*[out, retval]*/ BSTR* pCurrencyCashList )
{
    return GetOposProp( DEBUGPARAM("CurrencyCashList") PIDXBdsp_CurrencyCashList, pCurrencyCashList, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_CurrencyCode( /*[out, retval]*/ BSTR* pCurrencyCode )
{
    return GetOposProp( DEBUGPARAM("CurrencyCode") PIDXBdsp_CurrencyCode, pCurrencyCode, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBillDispenser::put_CurrencyCode( /*[in]*/ BSTR CurrencyCode )
{
    return SetOposProp( DEBUGPARAM("CurrencyCode") PIDXBdsp_CurrencyCode, CurrencyCode, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_CurrencyCodeList( /*[out, retval]*/ BSTR* pCurrencyCodeList )
{
    return GetOposProp( DEBUGPARAM("CurrencyCodeList") PIDXBdsp_CurrencyCodeList, pCurrencyCodeList, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_CurrentExit( /*[out, retval]*/ LONG* pCurrentExit )
{
    return GetOposProp( DEBUGPARAM("CurrentExit") PIDXBdsp_CurrentExit, pCurrentExit, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBillDispenser::put_CurrentExit( /*[in]*/ LONG CurrentExit )
{
    return SetOposProp( DEBUGPARAM("CurrentExit") PIDXBdsp_CurrentExit, CurrentExit, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_DeviceExits( /*[out, retval]*/ LONG* pDeviceExits )
{
    return GetOposProp( DEBUGPARAM("DeviceExits") PIDXBdsp_DeviceExits, pDeviceExits, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_DeviceStatus( /*[out, retval]*/ LONG* pDeviceStatus )
{
    return GetOposProp( DEBUGPARAM("DeviceStatus") PIDXBdsp_DeviceStatus, pDeviceStatus, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillDispenser::get_ExitCashList( /*[out, retval]*/ BSTR* pExitCashList )
{
    return GetOposProp( DEBUGPARAM("ExitCashList") PIDXBdsp_ExitCashList, pExitCashList, 11 /*MinorVersion*/ );
}
...
void COPOSBillDispenser::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_BillDispenser.log");
...
#define OPOSCCOCLASS COPOSBillDispenser
#define RCSTRACENAME "OposCCO_BillDispenser"
...
void COPOSBillDispenser::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSBillDispenser::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSBillDispenser::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSBillDispenser::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
