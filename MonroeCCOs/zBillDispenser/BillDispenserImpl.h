/****************************************************************************
**
** BillDispenserImpl.h -- Main control header file.
**
...
#ifndef __BILLDISPENSERIMPL_H__
#define __BILLDISPENSERIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_BillDispenser.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_BillDispenser.log")
...
// The class...
class ATL_NO_VTABLE COPOSBillDispenser :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSBillDispenser, &IID_IOPOSBillDispenser, &LIBID_OposBillDispenser_CCO>,
    public CComControl<COPOSBillDispenser>,
    public IPersistStreamInitImpl<COPOSBillDispenser>,
    public IOleControlImpl<COPOSBillDispenser>,
    public IOleObjectImpl<COPOSBillDispenser>,
    public IOleInPlaceActiveObjectImpl<COPOSBillDispenser>,
    public IViewObjectExImpl<COPOSBillDispenser>,
    public IOleInPlaceObjectWindowlessImpl<COPOSBillDispenser>,
    public IConnectionPointContainerImpl<COPOSBillDispenser>,
    public IPersistStorageImpl<COPOSBillDispenser>,
    public ISpecifyPropertyPagesImpl<COPOSBillDispenser>,
    public IQuickActivateImpl<COPOSBillDispenser>,
    public IDataObjectImpl<COPOSBillDispenser>,
    public IProvideClassInfo2Impl<&CLSID_OPOSBillDispenser, &DIID__IOPOSBillDispenserEvents, &LIBID_OposBillDispenser_CCO>,
    public IObjectSafetyImpl<COPOSBillDispenser, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSBillDispenser>,
    public CComCoClass<COPOSBillDispenser, &CLSID_OPOSBillDispenser>,
    public CProxy_IOPOSEvents< COPOSBillDispenser >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSBILLDISPENSER)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSBillDispenser)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSBillDispenser)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSBillDispenser, IOPOSBillDispenser)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSBillDispenser_1_11, IOPOSBillDispenser)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSBillDispenser)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSBillDispenser)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSBillDispenserEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSBillDispenser)
    CHAIN_MSG_MAP(CComControl<COPOSBillDispenser>)
...
#endif //__BILLDISPENSERIMPL_H__

// End BillDispenserImpl.h
