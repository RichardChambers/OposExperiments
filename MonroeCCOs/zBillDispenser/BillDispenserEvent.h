/****************************************************************************
**
** BillDispenserEvent.h -- OPOS event firing support.
**
**    This file is included into the BillDispenser Control Object's main
...
#ifndef __BILLDISPENSEREVENT_H__
#define __BILLDISPENSEREVENT_H__
...
//===========================================================================
    ...
    STDMETHOD( SODirectIO )(long EventNumber, long* pData, BSTR* pString)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSBillDispenser >::Fire_DirectIOEvent( EventNumber, pData, pString );
        else
        {
...
//===========================================================================
    ...
    STDMETHOD( SOStatusUpdate)(long Data)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSBillDispenser >::Fire_StatusUpdateEvent( Data );
        else
...
/////////////////////////////////////////////////////////////////////////////
    ...
    {
        COPOSBillDispenser* pThis;

        // On window creation, save our window instance into user window space.
        if ( uMsg == WM_CREATE )
        {
            pThis = (COPOSBillDispenser*) ((LPCREATESTRUCT) lParam)->lpCreateParams;
        ...
        {
            pThis = (COPOSBillDispenser*) ::GetWindowLong( hwnd, 0 );
            if ( pThis != 0 &&
        ...
        case WMU_DIRECT_IO_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSBillDispenser >::Fire_DirectIOEvent(
        ...
        case WMU_STATUS_UPDATE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSBillDispenser >::Fire_StatusUpdateEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
...
#endif //__BILLDISPENSEREVENT_H__

// end BillDispenserEvent.h
