/****************************************************************************
**
** CashDrawerImpl.h -- Main control header file.
**
...
#ifndef __CASHDRAWERIMPL_H__
#define __CASHDRAWERIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_CashDrawer.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_CashDrawer.log")
...
// The class...
class ATL_NO_VTABLE COPOSCashDrawer :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSCashDrawer, &IID_IOPOSCashDrawer, &LIBID_OposCashDrawer_CCO>,
    public CComControl<COPOSCashDrawer>,
    public IPersistStreamInitImpl<COPOSCashDrawer>,
    public IOleControlImpl<COPOSCashDrawer>,
    public IOleObjectImpl<COPOSCashDrawer>,
    public IOleInPlaceActiveObjectImpl<COPOSCashDrawer>,
    public IViewObjectExImpl<COPOSCashDrawer>,
    public IOleInPlaceObjectWindowlessImpl<COPOSCashDrawer>,
    public IConnectionPointContainerImpl<COPOSCashDrawer>,
    public IPersistStorageImpl<COPOSCashDrawer>,
    public ISpecifyPropertyPagesImpl<COPOSCashDrawer>,
    public IQuickActivateImpl<COPOSCashDrawer>,
    public IDataObjectImpl<COPOSCashDrawer>,
    public IProvideClassInfo2Impl<&CLSID_OPOSCashDrawer, &DIID__IOPOSCashDrawerEvents, &LIBID_OposCashDrawer_CCO>,
    public IObjectSafetyImpl<COPOSCashDrawer, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSCashDrawer>,
    public CComCoClass<COPOSCashDrawer, &CLSID_OPOSCashDrawer>,
    public CProxy_IOPOSEvents< COPOSCashDrawer >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSCASHDRAWER)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSCashDrawer)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSCashDrawer)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCashDrawer, IOPOSCashDrawer)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCashDrawer_1_9, IOPOSCashDrawer)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCashDrawer_1_8, IOPOSCashDrawer)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCashDrawer_1_5, IOPOSCashDrawer)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSCashDrawer)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSCashDrawer)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSCashDrawerEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSCashDrawer)
    CHAIN_MSG_MAP(CComControl<COPOSCashDrawer>)
...
// Release 1.0
    ...
    STDMETHOD(ReleaseDevice)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapStatus)( /*[out, retval]*/ VARIANT_BOOL* pCapStatus );
    STDMETHOD(get_DrawerOpened)( /*[out, retval]*/ VARIANT_BOOL* pDrawerOpened );
    STDMETHOD(OpenDrawer)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(WaitForDrawerClose)( 
        /*[in]*/ LONG BeepTimeout, 
...
// Release 1.4
// Release 1.5
    STDMETHOD(get_CapStatusMultiDrawerDetect)( /*[out, retval]*/ VARIANT_BOOL* pCapStatusMultiDrawerDetect );
// Release 1.6
// Release 1.7
// Release 1.8
...
#endif //__CASHDRAWERIMPL_H__

// End CashDrawerImpl.h
