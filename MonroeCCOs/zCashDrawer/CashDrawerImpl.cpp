...
TCHAR g_WindowName[] = _T("HW_OPOSCashDrawer");

// Control Object description and version.
char g_ControlDescription[] = "OPOS CashDrawer Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSCashDrawer::s_nInstances = 0;
...
// Release 1.0 methods
    ...
    "OpenDrawer",
        #define nDIOpenDrawer 11
    "WaitForDrawerClose",
        #define nDIWaitForDrawerClose 12
// Release 1.1 methods
// Release 1.2 methods
// Release 1.3 methods
// Release 1.4 methods
...
//   for each release.
// Followed by the initial minor release of the OPOS CashDrawer.
//===========================================================================
...
COPOSCashDrawer::COPOSCashDrawer()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSCashDrawer >(this) )
{
}

//===========================================================================

HRESULT COPOSCashDrawer::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSCashDrawer::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSCashDrawer::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSCASHDRAWER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSCashDrawer::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCashDrawer::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCashDrawer::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSCashDrawer::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSCashDrawer::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_CASH );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_CASH), hRC );
...
STDMETHODIMP COPOSCashDrawer::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCashDrawer::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCashDrawer::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCashDrawer::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSCashDrawer::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCashDrawer::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSCashDrawer::OpenDrawer( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("OpenDrawer") S_OK, NULL, 0, nDIOpenDrawer, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCashDrawer::WaitForDrawerClose( 
    /*[in]*/ LONG BeepTimeout, 
...
{
    OposVariant Vars[4];
    Vars[3].SetLONG( BeepTimeout );
    Vars[2].SetLONG( BeepFrequency );
    Vars[1].SetLONG( BeepDuration );
    Vars[0].SetLONG( BeepDelay );
    return DoInvoke( DEBUGPARAM("WaitForDrawerClose") S_OK, Vars, 4, nDIWaitForDrawerClose, pRC );
}
...
STDMETHODIMP COPOSCashDrawer::ResetStatistics( 
...
STDMETHODIMP COPOSCashDrawer::RetrieveStatistics( 
...
STDMETHODIMP COPOSCashDrawer::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCashDrawer::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSCashDrawer::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCashDrawer::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSCashDrawer::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSCashDrawer::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSCashDrawer::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSCashDrawer::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSCashDrawer::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSCashDrawer::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSCashDrawer::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSCashDrawer::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSCashDrawer::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSCashDrawer::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSCashDrawer::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSCashDrawer::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSCashDrawer::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSCashDrawer::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSCashDrawer::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSCashDrawer::get_CapStatus( /*[out, retval]*/ VARIANT_BOOL* pCapStatus )
{
    return GetOposProp( DEBUGPARAM("CapStatus") PIDXCash_CapStatus, pCapStatus, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashDrawer::get_DrawerOpened( /*[out, retval]*/ VARIANT_BOOL* pDrawerOpened )
{
    return GetOposProp( DEBUGPARAM("DrawerOpened") PIDXCash_DrawerOpened, pDrawerOpened, 0 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSCashDrawer::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSCashDrawer::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSCashDrawer::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSCashDrawer::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSCashDrawer::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSCashDrawer::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSCashDrawer::get_CapStatusMultiDrawerDetect( /*[out, retval]*/ VARIANT_BOOL* pCapStatusMultiDrawerDetect )
{
    return GetOposProp( DEBUGPARAM("CapStatusMultiDrawerDetect") PIDXCash_CapStatusMultiDrawerDetect, pCapStatusMultiDrawerDetect, 5 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSCashDrawer::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSCashDrawer::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSCashDrawer::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSCashDrawer::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSCashDrawer::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_CashDrawer.log");
...
#define OPOSCCOCLASS COPOSCashDrawer
#define RCSTRACENAME "OposCCO_CashDrawer"
...
void COPOSCashDrawer::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSCashDrawer::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSCashDrawer::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSCashDrawer::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
