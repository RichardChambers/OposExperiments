/****************************************************************************
**
** ElectronicJournalImpl.h -- Main control header file.
**
...
#ifndef __ELECTRONICJOURNALIMPL_H__
#define __ELECTRONICJOURNALIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_ElectronicJournal.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_ElectronicJournal.log")
...
#include "ElectronicJournalDefs.h"
...
// The class...
class ATL_NO_VTABLE COPOSElectronicJournal :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSElectronicJournal, &IID_IOPOSElectronicJournal, &LIBID_OposElectronicJournal_CCO>,
    public CComControl<COPOSElectronicJournal>,
    public IPersistStreamInitImpl<COPOSElectronicJournal>,
    public IOleControlImpl<COPOSElectronicJournal>,
    public IOleObjectImpl<COPOSElectronicJournal>,
    public IOleInPlaceActiveObjectImpl<COPOSElectronicJournal>,
    public IViewObjectExImpl<COPOSElectronicJournal>,
    public IOleInPlaceObjectWindowlessImpl<COPOSElectronicJournal>,
    public IConnectionPointContainerImpl<COPOSElectronicJournal>,
    public IPersistStorageImpl<COPOSElectronicJournal>,
    public ISpecifyPropertyPagesImpl<COPOSElectronicJournal>,
    public IQuickActivateImpl<COPOSElectronicJournal>,
    public IDataObjectImpl<COPOSElectronicJournal>,
    public IProvideClassInfo2Impl<&CLSID_OPOSElectronicJournal, &DIID__IOPOSElectronicJournalEvents, &LIBID_OposElectronicJournal_CCO>,
    public IObjectSafetyImpl<COPOSElectronicJournal, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSElectronicJournal>,
    public CComCoClass<COPOSElectronicJournal, &CLSID_OPOSElectronicJournal>,
    public CProxy_IOPOSEvents< COPOSElectronicJournal >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSELECTRONICJOURNAL)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSElectronicJournal)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSElectronicJournal)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSElectronicJournal, IOPOSElectronicJournal)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSElectronicJournal_1_10, IOPOSElectronicJournal)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSElectronicJournal)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSElectronicJournal)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSElectronicJournalEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSElectronicJournal)
    CHAIN_MSG_MAP(CComControl<COPOSElectronicJournal>)
...
protected:
    #include "ElectronicJournalEvent.h"
...
// Release 1.10
    ...
    STDMETHOD(get_CapAddMarker)( /*[out, retval]*/ VARIANT_BOOL* pCapAddMarker );
    STDMETHOD(get_CapErasableMedium)( /*[out, retval]*/ VARIANT_BOOL* pCapErasableMedium );
    STDMETHOD(get_CapInitializeMedium)( /*[out, retval]*/ VARIANT_BOOL* pCapInitializeMedium );
    STDMETHOD(get_CapMediumIsAvailable)( /*[out, retval]*/ VARIANT_BOOL* pCapMediumIsAvailable );
    STDMETHOD(get_CapPrintContent)( /*[out, retval]*/ VARIANT_BOOL* pCapPrintContent );
    STDMETHOD(get_CapPrintContentFile)( /*[out, retval]*/ VARIANT_BOOL* pCapPrintContentFile );
    STDMETHOD(get_CapRetrieveCurrentMarker)( /*[out, retval]*/ VARIANT_BOOL* pCapRetrieveCurrentMarker );
    STDMETHOD(get_CapRetrieveMarker)( /*[out, retval]*/ VARIANT_BOOL* pCapRetrieveMarker );
    STDMETHOD(get_CapRetrieveMarkerByDateTime)( /*[out, retval]*/ VARIANT_BOOL* pCapRetrieveMarkerByDateTime );
    STDMETHOD(get_CapRetrieveMarkersDateTime)( /*[out, retval]*/ VARIANT_BOOL* pCapRetrieveMarkersDateTime );
    STDMETHOD(get_CapStation)( /*[out, retval]*/ LONG* pCapStation );
    STDMETHOD(get_CapStorageEnabled)( /*[out, retval]*/ VARIANT_BOOL* pCapStorageEnabled );
    STDMETHOD(get_CapSuspendPrintContent)( /*[out, retval]*/ VARIANT_BOOL* pCapSuspendPrintContent );
    STDMETHOD(get_CapSuspendQueryContent)( /*[out, retval]*/ VARIANT_BOOL* pCapSuspendQueryContent );
    STDMETHOD(get_CapWaterMark)( /*[out, retval]*/ VARIANT_BOOL* pCapWaterMark );
    STDMETHOD(get_FlagWhenIdle)( /*[out, retval]*/ VARIANT_BOOL* pFlagWhenIdle );
    STDMETHOD(put_FlagWhenIdle)( /*[in]*/ VARIANT_BOOL FlagWhenIdle );
    STDMETHOD(get_MediumFreeSpace)( /*[out, retval]*/ CURRENCY* pMediumFreeSpace );
    STDMETHOD(get_MediumID)( /*[out, retval]*/ BSTR* pMediumID );
    STDMETHOD(get_MediumIsAvailable)( /*[out, retval]*/ VARIANT_BOOL* pMediumIsAvailable );
    STDMETHOD(get_MediumSize)( /*[out, retval]*/ CURRENCY* pMediumSize );
    STDMETHOD(get_Station)( /*[out, retval]*/ LONG* pStation );
    STDMETHOD(put_Station)( /*[in]*/ LONG Station );
    STDMETHOD(get_StorageEnabled)( /*[out, retval]*/ VARIANT_BOOL* pStorageEnabled );
    STDMETHOD(put_StorageEnabled)( /*[in]*/ VARIANT_BOOL StorageEnabled );
    STDMETHOD(get_Suspended)( /*[out, retval]*/ VARIANT_BOOL* pSuspended );
    STDMETHOD(get_WaterMark)( /*[out, retval]*/ VARIANT_BOOL* pWaterMark );
    STDMETHOD(put_WaterMark)( /*[in]*/ VARIANT_BOOL WaterMark );
    STDMETHOD(AddMarker)( 
        /*[in]*/ BSTR Marker, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(CancelPrintContent)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(CancelQueryContent)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(EraseMedium)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(InitializeMedium)( 
        /*[in]*/ BSTR MediumID, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(PrintContent)( 
        /*[in]*/ BSTR FromMarker, 
        /*[in]*/ BSTR ToMarker, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(PrintContentFile)( 
        /*[in]*/ BSTR FileName, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(QueryContent)( 
        /*[in]*/ BSTR FileName, 
        /*[in]*/ BSTR FromMarker, 
        /*[in]*/ BSTR ToMarker, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(ResumePrintContent)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(ResumeQueryContent)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(RetrieveCurrentMarker)( 
        /*[in]*/ LONG MarkerType, 
        /*[out]*/ BSTR* pMarker, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(RetrieveMarker)( 
        /*[in]*/ LONG MarkerType, 
        /*[in]*/ LONG SessionNumber, 
        /*[in]*/ LONG DocumentNumber, 
        /*[out]*/ BSTR* pMarker, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(RetrieveMarkerByDateTime)( 
        /*[in]*/ LONG MarkerType, 
        /*[in]*/ BSTR DateTime, 
        /*[in]*/ BSTR MarkerNumber, 
        /*[out]*/ BSTR* pMarker, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(RetrieveMarkersDateTime)( 
        /*[in]*/ BSTR Marker, 
        /*[out]*/ BSTR* pDateTime, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(SuspendPrintContent)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(SuspendQueryContent)( 
        /*[out, retval]*/ long* pRC );
// Release 1.11
// Release 1.12
// Release 1.13
...
#endif //__ELECTRONICJOURNALIMPL_H__

// End ElectronicJournalImpl.h
