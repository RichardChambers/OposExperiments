...
#include "ElectronicJournalImpl.h"
...
TCHAR g_WindowName[] = _T("HW_OPOSElectronicJournal");

// Control Object description and version.
char g_ControlDescription[] = "OPOS ElectronicJournal Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSElectronicJournal::s_nInstances = 0;
...
// Release 1.10 methods
    ...
    "GetMediumFreeSpace",
        #define nDIGetMediumFreeSpace 18
    "GetMediumSize",
        #define nDIGetMediumSize 19
    "AddMarker",
        #define nDIAddMarker 20
    "CancelPrintContent",
        #define nDICancelPrintContent 21
    "CancelQueryContent",
        #define nDICancelQueryContent 22
    "EraseMedium",
        #define nDIEraseMedium 23
    "InitializeMedium",
        #define nDIInitializeMedium 24
    "PrintContent",
        #define nDIPrintContent 25
    "PrintContentFile",
        #define nDIPrintContentFile 26
    "QueryContent",
        #define nDIQueryContent 27
    "ResumePrintContent",
        #define nDIResumePrintContent 28
    "ResumeQueryContent",
        #define nDIResumeQueryContent 29
    "RetrieveCurrentMarker",
        #define nDIRetrieveCurrentMarker 30
    "RetrieveMarker",
        #define nDIRetrieveMarker 31
    "RetrieveMarkerByDateTime",
        #define nDIRetrieveMarkerByDateTime 32
    "RetrieveMarkersDateTime",
        #define nDIRetrieveMarkersDateTime 33
    "SuspendPrintContent",
        #define nDISuspendPrintContent 34
    "SuspendQueryContent",
        #define nDISuspendQueryContent 35
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS ElectronicJournal.
//===========================================================================
...
COPOSElectronicJournal::COPOSElectronicJournal()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSElectronicJournal >(this) )
{
}

//===========================================================================

HRESULT COPOSElectronicJournal::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSElectronicJournal::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSElectronicJournal::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSELECTRONICJOURNAL2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSElectronicJournal::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSElectronicJournal::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSElectronicJournal::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSElectronicJournal::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSElectronicJournal::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_EJ );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_EJ), hRC );
...
STDMETHODIMP COPOSElectronicJournal::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSElectronicJournal::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSElectronicJournal::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSElectronicJournal::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSElectronicJournal::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSElectronicJournal::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSElectronicJournal::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSElectronicJournal::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSElectronicJournal::ResetStatistics( 
...
STDMETHODIMP COPOSElectronicJournal::RetrieveStatistics( 
...
STDMETHODIMP COPOSElectronicJournal::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSElectronicJournal::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSElectronicJournal::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSElectronicJournal::AddMarker( 
    /*[in]*/ BSTR Marker, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( Marker, hRC );
    return DoInvoke( DEBUGPARAM("AddMarker") hRC, &Var, 1, nDIAddMarker, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::CancelPrintContent( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("CancelPrintContent") S_OK, NULL, 0, nDICancelPrintContent, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::CancelQueryContent( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("CancelQueryContent") S_OK, NULL, 0, nDICancelQueryContent, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::EraseMedium( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("EraseMedium") S_OK, NULL, 0, nDIEraseMedium, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::InitializeMedium( 
    /*[in]*/ BSTR MediumID, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( MediumID, hRC );
    return DoInvoke( DEBUGPARAM("InitializeMedium") hRC, &Var, 1, nDIInitializeMedium, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::PrintContent( 
    /*[in]*/ BSTR FromMarker, 
    /*[in]*/ BSTR ToMarker, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( FromMarker, hRC );
    Vars[0].SetBSTR( ToMarker, hRC );
    return DoInvoke( DEBUGPARAM("PrintContent") hRC, Vars, 2, nDIPrintContent, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::PrintContentFile( 
    /*[in]*/ BSTR FileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( FileName, hRC );
    return DoInvoke( DEBUGPARAM("PrintContentFile") hRC, &Var, 1, nDIPrintContentFile, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::QueryContent( 
    /*[in]*/ BSTR FileName, 
    /*[in]*/ BSTR FromMarker, 
    /*[in]*/ BSTR ToMarker, 
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[1].SetBSTR( FromMarker, hRC );
    Vars[0].SetBSTR( ToMarker, hRC );
    return DoInvoke( DEBUGPARAM("QueryContent") hRC, Vars, 3, nDIQueryContent, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::ResumePrintContent( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("ResumePrintContent") S_OK, NULL, 0, nDIResumePrintContent, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::ResumeQueryContent( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("ResumeQueryContent") S_OK, NULL, 0, nDIResumeQueryContent, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::RetrieveCurrentMarker( 
    /*[in]*/ LONG MarkerType, 
    /*[out]*/ BSTR* pMarker, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetLONG( MarkerType );
    Vars[0].SetBSTR_OutPtr( pMarker, hRC );
    return DoInvoke( DEBUGPARAM("RetrieveCurrentMarker") hRC, Vars, 2, nDIRetrieveCurrentMarker, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::RetrieveMarker( 
    /*[in]*/ LONG MarkerType, 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[4];
    HRESULT hRC = S_OK;
    Vars[3].SetLONG( MarkerType );
    Vars[2].SetLONG( SessionNumber );
    Vars[1].SetLONG( DocumentNumber );
    Vars[0].SetBSTR_OutPtr( pMarker, hRC );
    return DoInvoke( DEBUGPARAM("RetrieveMarker") hRC, Vars, 4, nDIRetrieveMarker, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::RetrieveMarkerByDateTime( 
    /*[in]*/ LONG MarkerType, 
    /*[in]*/ BSTR DateTime, 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    HRESULT hRC = S_OK;
    Vars[3].SetLONG( MarkerType );
    Vars[2].SetBSTR( DateTime, hRC );
    Vars[1].SetBSTR( MarkerNumber, hRC );
    Vars[0].SetBSTR_OutPtr( pMarker, hRC );
    return DoInvoke( DEBUGPARAM("RetrieveMarkerByDateTime") hRC, Vars, 4, nDIRetrieveMarkerByDateTime, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::RetrieveMarkersDateTime( 
    /*[in]*/ BSTR Marker, 
    /*[out]*/ BSTR* pDateTime, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( Marker, hRC );
    Vars[0].SetBSTR_OutPtr( pDateTime, hRC );
    return DoInvoke( DEBUGPARAM("RetrieveMarkersDateTime") hRC, Vars, 2, nDIRetrieveMarkersDateTime, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::SuspendPrintContent( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("SuspendPrintContent") S_OK, NULL, 0, nDISuspendPrintContent, pRC );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::SuspendQueryContent( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("SuspendQueryContent") S_OK, NULL, 0, nDISuspendQueryContent, pRC );
}
...
STDMETHODIMP COPOSElectronicJournal::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSElectronicJournal::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSElectronicJournal::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSElectronicJournal::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSElectronicJournal::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSElectronicJournal::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSElectronicJournal::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSElectronicJournal::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSElectronicJournal::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSElectronicJournal::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSElectronicJournal::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSElectronicJournal::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSElectronicJournal::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSElectronicJournal::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSElectronicJournal::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSElectronicJournal::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSElectronicJournal::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSElectronicJournal::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSElectronicJournal::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSElectronicJournal::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
    return GetOposProp( DEBUGPARAM("OutputID") PIDX_OutputID, pOutputID, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSElectronicJournal::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSElectronicJournal::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSElectronicJournal::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSElectronicJournal::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSElectronicJournal::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSElectronicJournal::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSElectronicJournal::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSElectronicJournal::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSElectronicJournal::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSElectronicJournal::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSElectronicJournal::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSElectronicJournal::get_AsyncMode( /*[out, retval]*/ VARIANT_BOOL* pAsyncMode )
{
    return GetOposProp( DEBUGPARAM("AsyncMode") PIDXEj_AsyncMode, pAsyncMode, 10 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSElectronicJournal::put_AsyncMode( /*[in]*/ VARIANT_BOOL AsyncMode )
{
    return SetOposProp( DEBUGPARAM("AsyncMode") PIDXEj_AsyncMode, AsyncMode, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapAddMarker( /*[out, retval]*/ VARIANT_BOOL* pCapAddMarker )
{
    return GetOposProp( DEBUGPARAM("CapAddMarker") PIDXEj_CapAddMarker, pCapAddMarker, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapErasableMedium( /*[out, retval]*/ VARIANT_BOOL* pCapErasableMedium )
{
    return GetOposProp( DEBUGPARAM("CapErasableMedium") PIDXEj_CapErasableMedium, pCapErasableMedium, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapInitializeMedium( /*[out, retval]*/ VARIANT_BOOL* pCapInitializeMedium )
{
    return GetOposProp( DEBUGPARAM("CapInitializeMedium") PIDXEj_CapInitializeMedium, pCapInitializeMedium, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapMediumIsAvailable( /*[out, retval]*/ VARIANT_BOOL* pCapMediumIsAvailable )
{
    return GetOposProp( DEBUGPARAM("CapMediumIsAvailable") PIDXEj_CapMediumIsAvailable, pCapMediumIsAvailable, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapPrintContent( /*[out, retval]*/ VARIANT_BOOL* pCapPrintContent )
{
    return GetOposProp( DEBUGPARAM("CapPrintContent") PIDXEj_CapPrintContent, pCapPrintContent, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapPrintContentFile( /*[out, retval]*/ VARIANT_BOOL* pCapPrintContentFile )
{
    return GetOposProp( DEBUGPARAM("CapPrintContentFile") PIDXEj_CapPrintContentFile, pCapPrintContentFile, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapRetrieveCurrentMarker( /*[out, retval]*/ VARIANT_BOOL* pCapRetrieveCurrentMarker )
{
    return GetOposProp( DEBUGPARAM("CapRetrieveCurrentMarker") PIDXEj_CapRetrieveCurrentMarker, pCapRetrieveCurrentMarker, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapRetrieveMarker( /*[out, retval]*/ VARIANT_BOOL* pCapRetrieveMarker )
{
    return GetOposProp( DEBUGPARAM("CapRetrieveMarker") PIDXEj_CapRetrieveMarker, pCapRetrieveMarker, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapRetrieveMarkerByDateTime( /*[out, retval]*/ VARIANT_BOOL* pCapRetrieveMarkerByDateTime )
{
    return GetOposProp( DEBUGPARAM("CapRetrieveMarkerByDateTime") PIDXEj_CapRetrieveMarkerByDateTime, pCapRetrieveMarkerByDateTime, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapRetrieveMarkersDateTime( /*[out, retval]*/ VARIANT_BOOL* pCapRetrieveMarkersDateTime )
{
    return GetOposProp( DEBUGPARAM("CapRetrieveMarkersDateTime") PIDXEj_CapRetrieveMarkersDateTime, pCapRetrieveMarkersDateTime, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapStation( /*[out, retval]*/ LONG* pCapStation )
{
    return GetOposProp( DEBUGPARAM("CapStation") PIDXEj_CapStation, pCapStation, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapStorageEnabled( /*[out, retval]*/ VARIANT_BOOL* pCapStorageEnabled )
{
    return GetOposProp( DEBUGPARAM("CapStorageEnabled") PIDXEj_CapStorageEnabled, pCapStorageEnabled, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapSuspendPrintContent( /*[out, retval]*/ VARIANT_BOOL* pCapSuspendPrintContent )
{
    return GetOposProp( DEBUGPARAM("CapSuspendPrintContent") PIDXEj_CapSuspendPrintContent, pCapSuspendPrintContent, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapSuspendQueryContent( /*[out, retval]*/ VARIANT_BOOL* pCapSuspendQueryContent )
{
    return GetOposProp( DEBUGPARAM("CapSuspendQueryContent") PIDXEj_CapSuspendQueryContent, pCapSuspendQueryContent, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_CapWaterMark( /*[out, retval]*/ VARIANT_BOOL* pCapWaterMark )
{
    return GetOposProp( DEBUGPARAM("CapWaterMark") PIDXEj_CapWaterMark, pCapWaterMark, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_FlagWhenIdle( /*[out, retval]*/ VARIANT_BOOL* pFlagWhenIdle )
{
    return GetOposProp( DEBUGPARAM("FlagWhenIdle") PIDXEj_FlagWhenIdle, pFlagWhenIdle, 10 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSElectronicJournal::put_FlagWhenIdle( /*[in]*/ VARIANT_BOOL FlagWhenIdle )
{
    return SetOposProp( DEBUGPARAM("FlagWhenIdle") PIDXEj_FlagWhenIdle, FlagWhenIdle, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_MediumFreeSpace( /*[out, retval]*/ CURRENCY* pMediumFreeSpace )
{
    DOTRACEV( ( _T("+MediumFreeSpace [Get]") ) );

    // Initialize return value.
    HRESULT hRC = 0;
    pMediumFreeSpace->int64 = 0;
    ...
    if ( _bOpened )
    {
        ...
        DISPPARAMS Disp = { NULL, NULL, 0, 0 };
        hRC = _pService->Invoke(
                _DispIDs[nDIGetMediumFreeSpace], IID_NULL, LOCALE_USER_DEFAULT,
                DISPATCH_METHOD, &Disp, &VarResult, NULL, NULL );

        // If success, then set return result.
        if ( hRC == S_OK )
            VarResult.ChangeCURRENCY( pMediumFreeSpace, hRC );
    }
    ...
    DOTRACEV( ( _T("-MediumFreeSpace [Get]: %s%s"), FormatCurrency(*pMediumFreeSpace), pInfo ) );
#endif
...
STDMETHODIMP COPOSElectronicJournal::get_MediumID( /*[out, retval]*/ BSTR* pMediumID )
{
    return GetOposProp( DEBUGPARAM("MediumID") PIDXEj_MediumID, pMediumID, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_MediumIsAvailable( /*[out, retval]*/ VARIANT_BOOL* pMediumIsAvailable )
{
    return GetOposProp( DEBUGPARAM("MediumIsAvailable") PIDXEj_MediumIsAvailable, pMediumIsAvailable, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_MediumSize( /*[out, retval]*/ CURRENCY* pMediumSize )
{
    DOTRACEV( ( _T("+MediumSize [Get]") ) );
    ...
    if ( _bOpened )
    {
        ...
        DISPPARAMS Disp = { NULL, NULL, 0, 0 };
        hRC = _pService->Invoke(
                _DispIDs[nDIGetMediumSize], IID_NULL, LOCALE_USER_DEFAULT,
                DISPATCH_METHOD, &Disp, &VarResult, NULL, NULL );

        // If success, then set return result.
        if ( hRC == S_OK )
            VarResult.ChangeCURRENCY( pMediumSize, hRC );
    }
    ...
    DOTRACEV( ( _T("-MediumSize [Get]: %s%s"), FormatCurrency(*pMediumSize), pInfo ) );
#endif
...
STDMETHODIMP COPOSElectronicJournal::get_Station( /*[out, retval]*/ LONG* pStation )
{
    return GetOposProp( DEBUGPARAM("Station") PIDXEj_Station, pStation, 10 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSElectronicJournal::put_Station( /*[in]*/ LONG Station )
{
    return SetOposProp( DEBUGPARAM("Station") PIDXEj_Station, Station, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_StorageEnabled( /*[out, retval]*/ VARIANT_BOOL* pStorageEnabled )
{
    return GetOposProp( DEBUGPARAM("StorageEnabled") PIDXEj_StorageEnabled, pStorageEnabled, 10 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSElectronicJournal::put_StorageEnabled( /*[in]*/ VARIANT_BOOL StorageEnabled )
{
    return SetOposProp( DEBUGPARAM("StorageEnabled") PIDXEj_StorageEnabled, StorageEnabled, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_Suspended( /*[out, retval]*/ VARIANT_BOOL* pSuspended )
{
    return GetOposProp( DEBUGPARAM("Suspended") PIDXEj_Suspended, pSuspended, 10 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSElectronicJournal::get_WaterMark( /*[out, retval]*/ VARIANT_BOOL* pWaterMark )
{
    return GetOposProp( DEBUGPARAM("WaterMark") PIDXEj_WaterMark, pWaterMark, 10 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSElectronicJournal::put_WaterMark( /*[in]*/ VARIANT_BOOL WaterMark )
{
    return SetOposProp( DEBUGPARAM("WaterMark") PIDXEj_WaterMark, WaterMark, 10 /*MinorVersion*/ );
}
...
void COPOSElectronicJournal::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_ElectronicJournal.log");
...
#define OPOSCCOCLASS COPOSElectronicJournal
#define RCSTRACENAME "OposCCO_ElectronicJournal"
...
void COPOSElectronicJournal::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSElectronicJournal::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSElectronicJournal::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSElectronicJournal::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
...
//              123     => "0.0123"
//              -1      => "-0.0001"
LPCTSTR COPOSElectronicJournal::FormatCurrency( CY cyCurrency )
{
