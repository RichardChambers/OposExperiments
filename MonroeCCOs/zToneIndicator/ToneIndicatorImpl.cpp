...
TCHAR g_WindowName[] = _T("HW_OPOSToneIndicator");

// Control Object description and version.
char g_ControlDescription[] = "OPOS ToneIndicator Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSToneIndicator::s_nInstances = 0;
...
// Release 1.8 methods
    "ResetStatistics",
        #define nDIResetStatistics 14
    "RetrieveStatistics",
        #define nDIRetrieveStatistics 15
    "UpdateStatistics",
        #define nDIUpdateStatistics 16
// Release 1.9 methods
    "CompareFirmwareVersion",
        #define nDICompareFirmwareVersion 17
    "UpdateFirmware",
        #define nDIUpdateFirmware 18
...
//   for each release.
// Followed by the initial minor release of the OPOS ToneIndicator.
//===========================================================================
...
COPOSToneIndicator::COPOSToneIndicator()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSToneIndicator >(this) )
{
}

//===========================================================================

HRESULT COPOSToneIndicator::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSToneIndicator::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSToneIndicator::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSTONEINDICATOR2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSToneIndicator::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSToneIndicator::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSToneIndicator::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSToneIndicator::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSToneIndicator::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_TONE );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_TONE), hRC );
...
STDMETHODIMP COPOSToneIndicator::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSToneIndicator::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSToneIndicator::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSToneIndicator::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSToneIndicator::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSToneIndicator::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSToneIndicator::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSToneIndicator::Sound( 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    return DoInvoke( DEBUGPARAM("Sound") S_OK, Vars, 2, nDISound, pRC );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::SoundImmediate( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("SoundImmediate") S_OK, NULL, 0, nDISoundImmediate, pRC );
}
...
STDMETHODIMP COPOSToneIndicator::ResetStatistics( 
...
STDMETHODIMP COPOSToneIndicator::RetrieveStatistics( 
...
STDMETHODIMP COPOSToneIndicator::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSToneIndicator::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSToneIndicator::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSToneIndicator::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSToneIndicator::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSToneIndicator::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSToneIndicator::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSToneIndicator::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSToneIndicator::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSToneIndicator::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSToneIndicator::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSToneIndicator::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSToneIndicator::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSToneIndicator::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSToneIndicator::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSToneIndicator::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSToneIndicator::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
    return GetOposProp( DEBUGPARAM("OutputID") PIDX_OutputID, pOutputID, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSToneIndicator::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSToneIndicator::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSToneIndicator::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSToneIndicator::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSToneIndicator::get_AsyncMode( /*[out, retval]*/ VARIANT_BOOL* pAsyncMode )
{
    return GetOposProp( DEBUGPARAM("AsyncMode") PIDXTone_AsyncMode, pAsyncMode, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_AsyncMode( /*[in]*/ VARIANT_BOOL AsyncMode )
{
    return SetOposProp( DEBUGPARAM("AsyncMode") PIDXTone_AsyncMode, AsyncMode, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_CapPitch( /*[out, retval]*/ VARIANT_BOOL* pCapPitch )
{
    return GetOposProp( DEBUGPARAM("CapPitch") PIDXTone_CapPitch, pCapPitch, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_CapVolume( /*[out, retval]*/ VARIANT_BOOL* pCapVolume )
{
    return GetOposProp( DEBUGPARAM("CapVolume") PIDXTone_CapVolume, pCapVolume, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_InterToneWait( /*[out, retval]*/ LONG* pInterToneWait )
{
    return GetOposProp( DEBUGPARAM("InterToneWait") PIDXTone_InterToneWait, pInterToneWait, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_InterToneWait( /*[in]*/ LONG InterToneWait )
{
    return SetOposProp( DEBUGPARAM("InterToneWait") PIDXTone_InterToneWait, InterToneWait, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_Tone1Duration( /*[out, retval]*/ LONG* pTone1Duration )
{
    return GetOposProp( DEBUGPARAM("Tone1Duration") PIDXTone_Tone1Duration, pTone1Duration, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_Tone1Duration( /*[in]*/ LONG Tone1Duration )
{
    return SetOposProp( DEBUGPARAM("Tone1Duration") PIDXTone_Tone1Duration, Tone1Duration, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_Tone1Pitch( /*[out, retval]*/ LONG* pTone1Pitch )
{
    return GetOposProp( DEBUGPARAM("Tone1Pitch") PIDXTone_Tone1Pitch, pTone1Pitch, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_Tone1Pitch( /*[in]*/ LONG Tone1Pitch )
{
    return SetOposProp( DEBUGPARAM("Tone1Pitch") PIDXTone_Tone1Pitch, Tone1Pitch, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_Tone1Volume( /*[out, retval]*/ LONG* pTone1Volume )
{
    return GetOposProp( DEBUGPARAM("Tone1Volume") PIDXTone_Tone1Volume, pTone1Volume, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_Tone1Volume( /*[in]*/ LONG Tone1Volume )
{
    return SetOposProp( DEBUGPARAM("Tone1Volume") PIDXTone_Tone1Volume, Tone1Volume, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_Tone2Duration( /*[out, retval]*/ LONG* pTone2Duration )
{
    return GetOposProp( DEBUGPARAM("Tone2Duration") PIDXTone_Tone2Duration, pTone2Duration, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_Tone2Duration( /*[in]*/ LONG Tone2Duration )
{
    return SetOposProp( DEBUGPARAM("Tone2Duration") PIDXTone_Tone2Duration, Tone2Duration, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_Tone2Pitch( /*[out, retval]*/ LONG* pTone2Pitch )
{
    return GetOposProp( DEBUGPARAM("Tone2Pitch") PIDXTone_Tone2Pitch, pTone2Pitch, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_Tone2Pitch( /*[in]*/ LONG Tone2Pitch )
{
    return SetOposProp( DEBUGPARAM("Tone2Pitch") PIDXTone_Tone2Pitch, Tone2Pitch, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_Tone2Volume( /*[out, retval]*/ LONG* pTone2Volume )
{
    return GetOposProp( DEBUGPARAM("Tone2Volume") PIDXTone_Tone2Volume, pTone2Volume, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_Tone2Volume( /*[in]*/ LONG Tone2Volume )
{
    return SetOposProp( DEBUGPARAM("Tone2Volume") PIDXTone_Tone2Volume, Tone2Volume, 2 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSToneIndicator::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSToneIndicator::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSToneIndicator::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSToneIndicator::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSToneIndicator::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSToneIndicator::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSToneIndicator::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSToneIndicator::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSToneIndicator::get_CapMelody( /*[out, retval]*/ LONG* pCapMelody )
{
    return GetOposProp( DEBUGPARAM("CapMelody") PIDXTone_CapMelody, pCapMelody, 13 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_MelodyType( /*[out, retval]*/ LONG* pMelodyType )
{
    return GetOposProp( DEBUGPARAM("MelodyType") PIDXTone_MelodyType, pMelodyType, 13 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_MelodyType( /*[in]*/ LONG MelodyType )
{
    return SetOposProp( DEBUGPARAM("MelodyType") PIDXTone_MelodyType, MelodyType, 13 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSToneIndicator::get_MelodyVolume( /*[out, retval]*/ LONG* pMelodyVolume )
{
    return GetOposProp( DEBUGPARAM("MelodyVolume") PIDXTone_MelodyVolume, pMelodyVolume, 13 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSToneIndicator::put_MelodyVolume( /*[in]*/ LONG MelodyVolume )
{
    return SetOposProp( DEBUGPARAM("MelodyVolume") PIDXTone_MelodyVolume, MelodyVolume, 13 /*MinorVersion*/ );
}
...
void COPOSToneIndicator::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_ToneIndicator.log");
...
#define OPOSCCOCLASS COPOSToneIndicator
#define RCSTRACENAME "OposCCO_ToneIndicator"
...
void COPOSToneIndicator::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSToneIndicator::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSToneIndicator::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSToneIndicator::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
