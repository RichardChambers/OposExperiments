/****************************************************************************
**
** ToneIndicatorImpl.h -- Main control header file.
**
...
#ifndef __TONEINDICATORIMPL_H__
#define __TONEINDICATORIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_ToneIndicator.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_ToneIndicator.log")
...
// The class...
class ATL_NO_VTABLE COPOSToneIndicator :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSToneIndicator, &IID_IOPOSToneIndicator, &LIBID_OposToneIndicator_CCO>,
    public CComControl<COPOSToneIndicator>,
    public IPersistStreamInitImpl<COPOSToneIndicator>,
    public IOleControlImpl<COPOSToneIndicator>,
    public IOleObjectImpl<COPOSToneIndicator>,
    public IOleInPlaceActiveObjectImpl<COPOSToneIndicator>,
    public IViewObjectExImpl<COPOSToneIndicator>,
    public IOleInPlaceObjectWindowlessImpl<COPOSToneIndicator>,
    public IConnectionPointContainerImpl<COPOSToneIndicator>,
    public IPersistStorageImpl<COPOSToneIndicator>,
    public ISpecifyPropertyPagesImpl<COPOSToneIndicator>,
    public IQuickActivateImpl<COPOSToneIndicator>,
    public IDataObjectImpl<COPOSToneIndicator>,
    public IProvideClassInfo2Impl<&CLSID_OPOSToneIndicator, &DIID__IOPOSToneIndicatorEvents, &LIBID_OposToneIndicator_CCO>,
    public IObjectSafetyImpl<COPOSToneIndicator, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSToneIndicator>,
    public CComCoClass<COPOSToneIndicator, &CLSID_OPOSToneIndicator>,
    public CProxy_IOPOSEvents< COPOSToneIndicator >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSTONEINDICATOR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSToneIndicator)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSToneIndicator)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSToneIndicator, IOPOSToneIndicator)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSToneIndicator_1_13, IOPOSToneIndicator)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSToneIndicator_1_9, IOPOSToneIndicator)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSToneIndicator_1_9_zz, IOPOSToneIndicator)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSToneIndicator_1_8, IOPOSToneIndicator)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSToneIndicator_1_5, IOPOSToneIndicator)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSToneIndicator)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSToneIndicator)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSToneIndicatorEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSToneIndicator)
    CHAIN_MSG_MAP(CComControl<COPOSToneIndicator>)
...
// Release 1.2
    ...
    STDMETHOD(get_CapPitch)( /*[out, retval]*/ VARIANT_BOOL* pCapPitch );
    STDMETHOD(get_CapVolume)( /*[out, retval]*/ VARIANT_BOOL* pCapVolume );
    STDMETHOD(get_InterToneWait)( /*[out, retval]*/ LONG* pInterToneWait );
    STDMETHOD(put_InterToneWait)( /*[in]*/ LONG InterToneWait );
    STDMETHOD(get_Tone1Duration)( /*[out, retval]*/ LONG* pTone1Duration );
    STDMETHOD(put_Tone1Duration)( /*[in]*/ LONG Tone1Duration );
    STDMETHOD(get_Tone1Pitch)( /*[out, retval]*/ LONG* pTone1Pitch );
    STDMETHOD(put_Tone1Pitch)( /*[in]*/ LONG Tone1Pitch );
    STDMETHOD(get_Tone1Volume)( /*[out, retval]*/ LONG* pTone1Volume );
    STDMETHOD(put_Tone1Volume)( /*[in]*/ LONG Tone1Volume );
    STDMETHOD(get_Tone2Duration)( /*[out, retval]*/ LONG* pTone2Duration );
    STDMETHOD(put_Tone2Duration)( /*[in]*/ LONG Tone2Duration );
    STDMETHOD(get_Tone2Pitch)( /*[out, retval]*/ LONG* pTone2Pitch );
    STDMETHOD(put_Tone2Pitch)( /*[in]*/ LONG Tone2Pitch );
    STDMETHOD(get_Tone2Volume)( /*[out, retval]*/ LONG* pTone2Volume );
    STDMETHOD(put_Tone2Volume)( /*[in]*/ LONG Tone2Volume );
    STDMETHOD(Sound)( 
        /*[in]*/ LONG NumberOfCycles, 
        /*[in]*/ LONG InterSoundWait, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(SoundImmediate)( 
        /*[out, retval]*/ long* pRC );
// Release 1.3
...
// Release 1.12
// Release 1.13
    STDMETHOD(get_CapMelody)( /*[out, retval]*/ LONG* pCapMelody );
    STDMETHOD(get_MelodyType)( /*[out, retval]*/ LONG* pMelodyType );
    STDMETHOD(put_MelodyType)( /*[in]*/ LONG MelodyType );
    STDMETHOD(get_MelodyVolume)( /*[out, retval]*/ LONG* pMelodyVolume );
    STDMETHOD(put_MelodyVolume)( /*[in]*/ LONG MelodyVolume );
// Release 1.14
};

#endif //__TONEINDICATORIMPL_H__

// End ToneIndicatorImpl.h
