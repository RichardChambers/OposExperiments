/****************************************************************************
**
** ToneIndicatorEvent.h -- OPOS event firing support.
**
**    This file is included into the ToneIndicator Control Object's main
...
#ifndef __TONEINDICATOREVENT_H__
#define __TONEINDICATOREVENT_H__
...
//===========================================================================
    ...
    STDMETHOD( SODirectIO )(long EventNumber, long* pData, BSTR* pString)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSToneIndicator >::Fire_DirectIOEvent( EventNumber, pData, pString );
        else
        {
...
//===========================================================================
                ...
                long ErrorLocus, long* pErrorResponse)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSToneIndicator >::Fire_ErrorEvent( ResultCode, ResultCodeExtended,
...
//===========================================================================
    ...
    STDMETHOD( SOOutputComplete )(long OutputID)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSToneIndicator >::Fire_OutputCompleteEvent( OutputID );
        else
...
//===========================================================================
    ...
    STDMETHOD( SOStatusUpdate)(long Data)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSToneIndicator >::Fire_StatusUpdateEvent( Data );
        else
...
/////////////////////////////////////////////////////////////////////////////
    ...
    {
        COPOSToneIndicator* pThis;

        // On window creation, save our window instance into user window space.
        if ( uMsg == WM_CREATE )
        {
            pThis = (COPOSToneIndicator*) ((LPCREATESTRUCT) lParam)->lpCreateParams;
        ...
        {
            pThis = (COPOSToneIndicator*) ::GetWindowLong( hwnd, 0 );
            if ( pThis != 0 &&
        ...
        case WMU_DIRECT_IO_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSToneIndicator >::Fire_DirectIOEvent(
        ...
        case WMU_ERROR_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSToneIndicator >::Fire_ErrorEvent (
        ...
        case WMU_OUTPUT_COMPLETE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSToneIndicator >::Fire_OutputCompleteEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
        ...
        case WMU_STATUS_UPDATE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSToneIndicator >::Fire_StatusUpdateEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
...
#endif //__TONEINDICATOREVENT_H__

// end ToneIndicatorEvent.h
