/****************************************************************************
**
** MotionSensorImpl.h -- Main control header file.
**
...
#ifndef __MOTIONSENSORIMPL_H__
#define __MOTIONSENSORIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_MotionSensor.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_MotionSensor.log")
...
// The class...
class ATL_NO_VTABLE COPOSMotionSensor :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSMotionSensor, &IID_IOPOSMotionSensor, &LIBID_OposMotionSensor_CCO>,
    public CComControl<COPOSMotionSensor>,
    public IPersistStreamInitImpl<COPOSMotionSensor>,
    public IOleControlImpl<COPOSMotionSensor>,
    public IOleObjectImpl<COPOSMotionSensor>,
    public IOleInPlaceActiveObjectImpl<COPOSMotionSensor>,
    public IViewObjectExImpl<COPOSMotionSensor>,
    public IOleInPlaceObjectWindowlessImpl<COPOSMotionSensor>,
    public IConnectionPointContainerImpl<COPOSMotionSensor>,
    public IPersistStorageImpl<COPOSMotionSensor>,
    public ISpecifyPropertyPagesImpl<COPOSMotionSensor>,
    public IQuickActivateImpl<COPOSMotionSensor>,
    public IDataObjectImpl<COPOSMotionSensor>,
    public IProvideClassInfo2Impl<&CLSID_OPOSMotionSensor, &DIID__IOPOSMotionSensorEvents, &LIBID_OposMotionSensor_CCO>,
    public IObjectSafetyImpl<COPOSMotionSensor, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSMotionSensor>,
    public CComCoClass<COPOSMotionSensor, &CLSID_OPOSMotionSensor>,
    public CProxy_IOPOSEvents< COPOSMotionSensor >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSMOTIONSENSOR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSMotionSensor)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSMotionSensor)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMotionSensor, IOPOSMotionSensor)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMotionSensor_1_9, IOPOSMotionSensor)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMotionSensor_1_8, IOPOSMotionSensor)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMotionSensor_1_7, IOPOSMotionSensor)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSMotionSensor)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSMotionSensor)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSMotionSensorEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSMotionSensor)
    CHAIN_MSG_MAP(CComControl<COPOSMotionSensor>)
...
// Release 1.7
    ...
    STDMETHOD(get_Motion)( /*[out, retval]*/ VARIANT_BOOL* pMotion );
    STDMETHOD(WaitForMotion)( 
        /*[in]*/ LONG Timeout, 
        /*[out, retval]*/ long* pRC );
// Release 1.8
...
#endif //__MOTIONSENSORIMPL_H__

// End MotionSensorImpl.h
