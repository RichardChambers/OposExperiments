...
TCHAR g_WindowName[] = _T("HW_OPOSSigCap");

// Control Object description and version.
char g_ControlDescription[] = "OPOS SigCap Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSSigCap::s_nInstances = 0;
...
// Release 1.0 methods
    ...
    "BeginCapture",
        #define nDIBeginCapture 12
    "EndCapture",
        #define nDIEndCapture 13
// Release 1.1 methods
// Release 1.2 methods
// Release 1.3 methods
// Release 1.4 methods
...
// Release 1.10 methods
    "ClearInputProperties",
        #define nDIClearInputProperties 19
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS SigCap.
//===========================================================================
...
COPOSSigCap::COPOSSigCap()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSSigCap >(this) )
{
}

//===========================================================================

HRESULT COPOSSigCap::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSSigCap::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSSigCap::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSSIGCAP2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSSigCap::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSigCap::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSigCap::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSSigCap::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSSigCap::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_SIG );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_SIG), hRC );
...
STDMETHODIMP COPOSSigCap::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSigCap::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSigCap::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSigCap::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSSigCap::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSigCap::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSigCap::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSSigCap::BeginCapture( 
    /*[in]*/ BSTR FormName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( FormName, hRC );
    return DoInvoke( DEBUGPARAM("BeginCapture") hRC, &Var, 1, nDIBeginCapture, pRC );
}

//===========================================================================

STDMETHODIMP COPOSSigCap::EndCapture( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSigCap::ResetStatistics( 
...
STDMETHODIMP COPOSSigCap::RetrieveStatistics( 
...
STDMETHODIMP COPOSSigCap::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSigCap::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSSigCap::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSigCap::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSigCap::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSSigCap::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSSigCap::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSSigCap::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSSigCap::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSSigCap::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSSigCap::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSSigCap::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSSigCap::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSSigCap::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSSigCap::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSSigCap::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSSigCap::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSSigCap::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSSigCap::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSSigCap::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSSigCap::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSSigCap::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSSigCap::get_CapDisplay( /*[out, retval]*/ VARIANT_BOOL* pCapDisplay )
{
    return GetOposProp( DEBUGPARAM("CapDisplay") PIDXSig_CapDisplay, pCapDisplay, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSigCap::get_CapUserTerminated( /*[out, retval]*/ VARIANT_BOOL* pCapUserTerminated )
{
    return GetOposProp( DEBUGPARAM("CapUserTerminated") PIDXSig_CapUserTerminated, pCapUserTerminated, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSigCap::get_MaximumX( /*[out, retval]*/ LONG* pMaximumX )
{
    return GetOposProp( DEBUGPARAM("MaximumX") PIDXSig_MaximumX, pMaximumX, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSigCap::get_MaximumY( /*[out, retval]*/ LONG* pMaximumY )
{
    return GetOposProp( DEBUGPARAM("MaximumY") PIDXSig_MaximumY, pMaximumY, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSigCap::get_PointArray( /*[out, retval]*/ BSTR* pPointArray )
{
    return GetOposProp( DEBUGPARAM("PointArray") PIDXSig_PointArray, pPointArray, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSigCap::get_RawData( /*[out, retval]*/ BSTR* pRawData )
{
    return GetOposProp( DEBUGPARAM("RawData") PIDXSig_RawData, pRawData, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSigCap::get_TotalPoints( /*[out, retval]*/ LONG* pTotalPoints )
{
    return GetOposProp( DEBUGPARAM("TotalPoints") PIDXSig_TotalPoints, pTotalPoints, 0 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSSigCap::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSSigCap::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSSigCap::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSSigCap::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSSigCap::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSSigCap::get_CapRealTimeData( /*[out, retval]*/ VARIANT_BOOL* pCapRealTimeData )
{
    return GetOposProp( DEBUGPARAM("CapRealTimeData") PIDXSig_CapRealTimeData, pCapRealTimeData, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSigCap::get_RealTimeDataEnabled( /*[out, retval]*/ VARIANT_BOOL* pRealTimeDataEnabled )
{
    return GetOposProp( DEBUGPARAM("RealTimeDataEnabled") PIDXSig_RealTimeDataEnabled, pRealTimeDataEnabled, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSigCap::put_RealTimeDataEnabled( /*[in]*/ VARIANT_BOOL RealTimeDataEnabled )
{
    return SetOposProp( DEBUGPARAM("RealTimeDataEnabled") PIDXSig_RealTimeDataEnabled, RealTimeDataEnabled, 2 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSSigCap::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSSigCap::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSSigCap::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSSigCap::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSSigCap::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSSigCap::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSSigCap::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSSigCap::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSSigCap::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_SigCap.log");
...
#define OPOSCCOCLASS COPOSSigCap
#define RCSTRACENAME "OposCCO_SigCap"
...
void COPOSSigCap::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSSigCap::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSSigCap::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSSigCap::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
