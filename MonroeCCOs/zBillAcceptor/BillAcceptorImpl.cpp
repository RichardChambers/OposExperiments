...
TCHAR g_WindowName[] = _T("HW_OPOSBillAcceptor");

// Control Object description and version.
char g_ControlDescription[] = "OPOS BillAcceptor Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSBillAcceptor::s_nInstances = 0;
...
// Release 1.11 methods
    ...
    "AdjustCashCounts",
        #define nDIAdjustCashCounts 17
    "BeginDeposit",
        #define nDIBeginDeposit 18
    "EndDeposit",
        #define nDIEndDeposit 19
    "FixDeposit",
        #define nDIFixDeposit 20
    "PauseDeposit",
        #define nDIPauseDeposit 21
    "ReadCashCounts",
        #define nDIReadCashCounts 22
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS BillAcceptor.
//===========================================================================
...
COPOSBillAcceptor::COPOSBillAcceptor()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSBillAcceptor >(this) )
{
}

//===========================================================================

HRESULT COPOSBillAcceptor::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSBillAcceptor::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSBillAcceptor::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSBILLACCEPTOR2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSBillAcceptor::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSBillAcceptor::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSBillAcceptor::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSBillAcceptor::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_BACC );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_BACC), hRC );
...
STDMETHODIMP COPOSBillAcceptor::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBillAcceptor::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBillAcceptor::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSBillAcceptor::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSBillAcceptor::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillAcceptor::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSBillAcceptor::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSBillAcceptor::ResetStatistics( 
...
STDMETHODIMP COPOSBillAcceptor::RetrieveStatistics( 
...
STDMETHODIMP COPOSBillAcceptor::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillAcceptor::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSBillAcceptor::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillAcceptor::AdjustCashCounts( 
    /*[in]*/ BSTR CashCounts, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillAcceptor::BeginDeposit( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSBillAcceptor::EndDeposit( 
    /*[in]*/ LONG Success, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillAcceptor::FixDeposit( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSBillAcceptor::PauseDeposit( 
    /*[in]*/ LONG Control, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSBillAcceptor::ReadCashCounts( 
...
STDMETHODIMP COPOSBillAcceptor::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSBillAcceptor::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSBillAcceptor::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSBillAcceptor::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSBillAcceptor::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSBillAcceptor::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSBillAcceptor::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSBillAcceptor::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSBillAcceptor::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSBillAcceptor::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSBillAcceptor::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSBillAcceptor::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSBillAcceptor::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSBillAcceptor::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSBillAcceptor::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSBillAcceptor::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSBillAcceptor::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSBillAcceptor::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSBillAcceptor::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSBillAcceptor::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSBillAcceptor::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSBillAcceptor::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSBillAcceptor::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSBillAcceptor::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSBillAcceptor::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSBillAcceptor::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSBillAcceptor::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSBillAcceptor::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSBillAcceptor::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSBillAcceptor::get_CapDiscrepancy( /*[out, retval]*/ VARIANT_BOOL* pCapDiscrepancy )
{
    return GetOposProp( DEBUGPARAM("CapDiscrepancy") PIDXBacc_CapDiscrepancy, pCapDiscrepancy, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_CapFullSensor( /*[out, retval]*/ VARIANT_BOOL* pCapFullSensor )
{
    return GetOposProp( DEBUGPARAM("CapFullSensor") PIDXBacc_CapFullSensor, pCapFullSensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_CapJamSensor( /*[out, retval]*/ VARIANT_BOOL* pCapJamSensor )
{
    return GetOposProp( DEBUGPARAM("CapJamSensor") PIDXBacc_CapJamSensor, pCapJamSensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_CapNearFullSensor( /*[out, retval]*/ VARIANT_BOOL* pCapNearFullSensor )
{
    return GetOposProp( DEBUGPARAM("CapNearFullSensor") PIDXBacc_CapNearFullSensor, pCapNearFullSensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_CapPauseDeposit( /*[out, retval]*/ VARIANT_BOOL* pCapPauseDeposit )
{
    return GetOposProp( DEBUGPARAM("CapPauseDeposit") PIDXBacc_CapPauseDeposit, pCapPauseDeposit, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_CapRealTimeData( /*[out, retval]*/ VARIANT_BOOL* pCapRealTimeData )
{
    return GetOposProp( DEBUGPARAM("CapRealTimeData") PIDXBacc_CapRealTimeData, pCapRealTimeData, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_CurrencyCode( /*[out, retval]*/ BSTR* pCurrencyCode )
{
    return GetOposProp( DEBUGPARAM("CurrencyCode") PIDXBacc_CurrencyCode, pCurrencyCode, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBillAcceptor::put_CurrencyCode( /*[in]*/ BSTR CurrencyCode )
{
    return SetOposProp( DEBUGPARAM("CurrencyCode") PIDXBacc_CurrencyCode, CurrencyCode, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_DepositAmount( /*[out, retval]*/ LONG* pDepositAmount )
{
    return GetOposProp( DEBUGPARAM("DepositAmount") PIDXBacc_DepositAmount, pDepositAmount, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_DepositCashList( /*[out, retval]*/ BSTR* pDepositCashList )
{
    return GetOposProp( DEBUGPARAM("DepositCashList") PIDXBacc_DepositCashList, pDepositCashList, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_DepositCodeList( /*[out, retval]*/ BSTR* pDepositCodeList )
{
    return GetOposProp( DEBUGPARAM("DepositCodeList") PIDXBacc_DepositCodeList, pDepositCodeList, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_DepositCounts( /*[out, retval]*/ BSTR* pDepositCounts )
{
    return GetOposProp( DEBUGPARAM("DepositCounts") PIDXBacc_DepositCounts, pDepositCounts, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_DepositStatus( /*[out, retval]*/ LONG* pDepositStatus )
{
    return GetOposProp( DEBUGPARAM("DepositStatus") PIDXBacc_DepositStatus, pDepositStatus, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_FullStatus( /*[out, retval]*/ LONG* pFullStatus )
{
    return GetOposProp( DEBUGPARAM("FullStatus") PIDXBacc_FullStatus, pFullStatus, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSBillAcceptor::get_RealTimeDataEnabled( /*[out, retval]*/ VARIANT_BOOL* pRealTimeDataEnabled )
{
    return GetOposProp( DEBUGPARAM("RealTimeDataEnabled") PIDXBacc_RealTimeDataEnabled, pRealTimeDataEnabled, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSBillAcceptor::put_RealTimeDataEnabled( /*[in]*/ VARIANT_BOOL RealTimeDataEnabled )
{
    return SetOposProp( DEBUGPARAM("RealTimeDataEnabled") PIDXBacc_RealTimeDataEnabled, RealTimeDataEnabled, 11 /*MinorVersion*/ );
}
...
void COPOSBillAcceptor::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_BillAcceptor.log");
...
#define OPOSCCOCLASS COPOSBillAcceptor
#define RCSTRACENAME "OposCCO_BillAcceptor"
...
void COPOSBillAcceptor::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSBillAcceptor::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSBillAcceptor::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSBillAcceptor::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
