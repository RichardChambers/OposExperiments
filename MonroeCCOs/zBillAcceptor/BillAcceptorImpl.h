/****************************************************************************
**
** BillAcceptorImpl.h -- Main control header file.
**
...
#ifndef __BILLACCEPTORIMPL_H__
#define __BILLACCEPTORIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_BillAcceptor.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_BillAcceptor.log")
...
// The class...
class ATL_NO_VTABLE COPOSBillAcceptor :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSBillAcceptor, &IID_IOPOSBillAcceptor, &LIBID_OposBillAcceptor_CCO>,
    public CComControl<COPOSBillAcceptor>,
    public IPersistStreamInitImpl<COPOSBillAcceptor>,
    public IOleControlImpl<COPOSBillAcceptor>,
    public IOleObjectImpl<COPOSBillAcceptor>,
    public IOleInPlaceActiveObjectImpl<COPOSBillAcceptor>,
    public IViewObjectExImpl<COPOSBillAcceptor>,
    public IOleInPlaceObjectWindowlessImpl<COPOSBillAcceptor>,
    public IConnectionPointContainerImpl<COPOSBillAcceptor>,
    public IPersistStorageImpl<COPOSBillAcceptor>,
    public ISpecifyPropertyPagesImpl<COPOSBillAcceptor>,
    public IQuickActivateImpl<COPOSBillAcceptor>,
    public IDataObjectImpl<COPOSBillAcceptor>,
    public IProvideClassInfo2Impl<&CLSID_OPOSBillAcceptor, &DIID__IOPOSBillAcceptorEvents, &LIBID_OposBillAcceptor_CCO>,
    public IObjectSafetyImpl<COPOSBillAcceptor, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSBillAcceptor>,
    public CComCoClass<COPOSBillAcceptor, &CLSID_OPOSBillAcceptor>,
    public CProxy_IOPOSEvents< COPOSBillAcceptor >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSBILLACCEPTOR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSBillAcceptor)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSBillAcceptor)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSBillAcceptor, IOPOSBillAcceptor)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSBillAcceptor_1_11, IOPOSBillAcceptor)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSBillAcceptor)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSBillAcceptor)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSBillAcceptorEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSBillAcceptor)
    CHAIN_MSG_MAP(CComControl<COPOSBillAcceptor>)
...
#endif //__BILLACCEPTORIMPL_H__

// End BillAcceptorImpl.h
