...
TCHAR g_WindowName[] = _T("HW_OPOSPINPad");

// Control Object description and version.
char g_ControlDescription[] = "OPOS PINPad Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSPINPad::s_nInstances = 0;
...
// Release 1.3 methods
    ...
    "GetAmount",
        #define nDIGetAmount 12
    "SetAmount",
        #define nDISetAmount 13
    "BeginEFTTransaction",
        #define nDIBeginEFTTransaction 14
    "ComputeMAC",
        #define nDIComputeMAC 15
    "EnablePINEntry",
        #define nDIEnablePINEntry 16
    "EndEFTTransaction",
        #define nDIEndEFTTransaction 17
    "UpdateKey",
        #define nDIUpdateKey 18
    "VerifyMAC",
        #define nDIVerifyMAC 19
// Release 1.4 methods
// Release 1.5 methods
// Release 1.6 methods
// Release 1.7 methods
...
// Release 1.10 methods
    "ClearInputProperties",
        #define nDIClearInputProperties 25
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS PINPad.
//===========================================================================
...
COPOSPINPad::COPOSPINPad()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSPINPad >(this) )
{
}

//===========================================================================

HRESULT COPOSPINPad::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSPINPad::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSPINPad::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSPINPAD2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSPINPad::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSPINPad::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSPINPad::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSPINPad::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSPINPad::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_PPAD );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_PPAD), hRC );
...
STDMETHODIMP COPOSPINPad::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPINPad::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPINPad::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSPINPad::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSPINPad::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPINPad::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSPINPad::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSPINPad::BeginEFTTransaction( 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( PINPadSystem, hRC );
    Vars[0].SetLONG( TransactionHost );
    return DoInvoke( DEBUGPARAM("BeginEFTTransaction") hRC, Vars, 2, nDIBeginEFTTransaction, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::ComputeMAC( 
    /*[in]*/ BSTR InMsg, 
    /*[out]*/ BSTR* pOutMsg, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( InMsg, hRC );
    Vars[0].SetBSTR_OutPtr( pOutMsg, hRC );
    return DoInvoke( DEBUGPARAM("ComputeMAC") hRC, Vars, 2, nDIComputeMAC, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::EnablePINEntry( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("EnablePINEntry") S_OK, NULL, 0, nDIEnablePINEntry, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::EndEFTTransaction( 
    /*[in]*/ LONG CompletionCode, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( CompletionCode );
    return DoInvoke( DEBUGPARAM("EndEFTTransaction") S_OK, &Var, 1, nDIEndEFTTransaction, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::UpdateKey( 
    /*[in]*/ LONG KeyNum, 
    /*[in]*/ BSTR Key, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetLONG( KeyNum );
    Vars[0].SetBSTR( Key, hRC );
    return DoInvoke( DEBUGPARAM("UpdateKey") hRC, Vars, 2, nDIUpdateKey, pRC );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::VerifyMAC( 
    /*[in]*/ BSTR Message, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    ...
    return DoInvoke( DEBUGPARAM("VerifyMAC") hRC, &Var, 1, nDIVerifyMAC, pRC );
}
...
STDMETHODIMP COPOSPINPad::ResetStatistics( 
...
STDMETHODIMP COPOSPINPad::RetrieveStatistics( 
...
STDMETHODIMP COPOSPINPad::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPINPad::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSPINPad::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSPINPad::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSPINPad::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSPINPad::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSPINPad::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSPINPad::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSPINPad::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSPINPad::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSPINPad::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSPINPad::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSPINPad::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSPINPad::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSPINPad::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSPINPad::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSPINPad::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSPINPad::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSPINPad::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSPINPad::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSPINPad::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSPINPad::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSPINPad::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSPINPad::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSPINPad::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSPINPad::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSPINPad::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSPINPad::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSPINPad::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSPINPad::get_AccountNumber( /*[out, retval]*/ BSTR* pAccountNumber )
{
    return GetOposProp( DEBUGPARAM("AccountNumber") PIDXPpad_AccountNumber, pAccountNumber, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_AccountNumber( /*[in]*/ BSTR AccountNumber )
{
    return SetOposProp( DEBUGPARAM("AccountNumber") PIDXPpad_AccountNumber, AccountNumber, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_AdditionalSecurityInformation( /*[out, retval]*/ BSTR* pAdditionalSecurityInformation )
{
    return GetOposProp( DEBUGPARAM("AdditionalSecurityInformation") PIDXPpad_AdditionalSecurityInformation, pAdditionalSecurityInformation, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_Amount( /*[out, retval]*/ CURRENCY* pAmount )
{
...
STDMETHODIMP COPOSPINPad::put_Amount( /*[in]*/ CURRENCY Amount )
{
...
STDMETHODIMP COPOSPINPad::get_AvailableLanguagesList( /*[out, retval]*/ BSTR* pAvailableLanguagesList )
{
    return GetOposProp( DEBUGPARAM("AvailableLanguagesList") PIDXPpad_AvailableLanguagesList, pAvailableLanguagesList, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_AvailablePromptsList( /*[out, retval]*/ BSTR* pAvailablePromptsList )
{
    return GetOposProp( DEBUGPARAM("AvailablePromptsList") PIDXPpad_AvailablePromptsList, pAvailablePromptsList, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_CapDisplay( /*[out, retval]*/ LONG* pCapDisplay )
{
    return GetOposProp( DEBUGPARAM("CapDisplay") PIDXPpad_CapDisplay, pCapDisplay, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_CapKeyboard( /*[out, retval]*/ VARIANT_BOOL* pCapKeyboard )
{
    return GetOposProp( DEBUGPARAM("CapKeyboard") PIDXPpad_CapKeyboard, pCapKeyboard, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_CapLanguage( /*[out, retval]*/ LONG* pCapLanguage )
{
    return GetOposProp( DEBUGPARAM("CapLanguage") PIDXPpad_CapLanguage, pCapLanguage, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_CapMACCalculation( /*[out, retval]*/ VARIANT_BOOL* pCapMACCalculation )
{
    return GetOposProp( DEBUGPARAM("CapMACCalculation") PIDXPpad_CapMACCalculation, pCapMACCalculation, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_CapTone( /*[out, retval]*/ VARIANT_BOOL* pCapTone )
{
    return GetOposProp( DEBUGPARAM("CapTone") PIDXPpad_CapTone, pCapTone, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_EncryptedPIN( /*[out, retval]*/ BSTR* pEncryptedPIN )
{
    return GetOposProp( DEBUGPARAM("EncryptedPIN") PIDXPpad_EncryptedPIN, pEncryptedPIN, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_MaximumPINLength( /*[out, retval]*/ LONG* pMaximumPINLength )
{
    return GetOposProp( DEBUGPARAM("MaximumPINLength") PIDXPpad_MaximumPINLength, pMaximumPINLength, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_MaximumPINLength( /*[in]*/ LONG MaximumPINLength )
{
    return SetOposProp( DEBUGPARAM("MaximumPINLength") PIDXPpad_MaximumPINLength, MaximumPINLength, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_MerchantID( /*[out, retval]*/ BSTR* pMerchantID )
{
    return GetOposProp( DEBUGPARAM("MerchantID") PIDXPpad_MerchantID, pMerchantID, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_MerchantID( /*[in]*/ BSTR MerchantID )
{
    return SetOposProp( DEBUGPARAM("MerchantID") PIDXPpad_MerchantID, MerchantID, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_MinimumPINLength( /*[out, retval]*/ LONG* pMinimumPINLength )
{
    return GetOposProp( DEBUGPARAM("MinimumPINLength") PIDXPpad_MinimumPINLength, pMinimumPINLength, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_MinimumPINLength( /*[in]*/ LONG MinimumPINLength )
{
    return SetOposProp( DEBUGPARAM("MinimumPINLength") PIDXPpad_MinimumPINLength, MinimumPINLength, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_PINEntryEnabled( /*[out, retval]*/ VARIANT_BOOL* pPINEntryEnabled )
{
    return GetOposProp( DEBUGPARAM("PINEntryEnabled") PIDXPpad_PINEntryEnabled, pPINEntryEnabled, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_Prompt( /*[out, retval]*/ LONG* pPrompt )
{
    return GetOposProp( DEBUGPARAM("Prompt") PIDXPpad_Prompt, pPrompt, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_Prompt( /*[in]*/ LONG Prompt )
{
    return SetOposProp( DEBUGPARAM("Prompt") PIDXPpad_Prompt, Prompt, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_PromptLanguage( /*[out, retval]*/ LONG* pPromptLanguage )
{
    return GetOposProp( DEBUGPARAM("PromptLanguage") PIDXPpad_PromptLanguage, pPromptLanguage, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_PromptLanguage( /*[in]*/ LONG PromptLanguage )
{
    return SetOposProp( DEBUGPARAM("PromptLanguage") PIDXPpad_PromptLanguage, PromptLanguage, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_TerminalID( /*[out, retval]*/ BSTR* pTerminalID )
{
    return GetOposProp( DEBUGPARAM("TerminalID") PIDXPpad_TerminalID, pTerminalID, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_TerminalID( /*[in]*/ BSTR TerminalID )
{
    return SetOposProp( DEBUGPARAM("TerminalID") PIDXPpad_TerminalID, TerminalID, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_Track1Data( /*[out, retval]*/ BSTR* pTrack1Data )
{
    return GetOposProp( DEBUGPARAM("Track1Data") PIDXPpad_Track1Data, pTrack1Data, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_Track1Data( /*[in]*/ BSTR Track1Data )
{
    return SetOposProp( DEBUGPARAM("Track1Data") PIDXPpad_Track1Data, Track1Data, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_Track2Data( /*[out, retval]*/ BSTR* pTrack2Data )
{
    return GetOposProp( DEBUGPARAM("Track2Data") PIDXPpad_Track2Data, pTrack2Data, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_Track2Data( /*[in]*/ BSTR Track2Data )
{
    return SetOposProp( DEBUGPARAM("Track2Data") PIDXPpad_Track2Data, Track2Data, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_Track3Data( /*[out, retval]*/ BSTR* pTrack3Data )
{
    return GetOposProp( DEBUGPARAM("Track3Data") PIDXPpad_Track3Data, pTrack3Data, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_Track3Data( /*[in]*/ BSTR Track3Data )
{
    return SetOposProp( DEBUGPARAM("Track3Data") PIDXPpad_Track3Data, Track3Data, 3 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSPINPad::get_TransactionType( /*[out, retval]*/ LONG* pTransactionType )
{
    return GetOposProp( DEBUGPARAM("TransactionType") PIDXPpad_TransactionType, pTransactionType, 3 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_TransactionType( /*[in]*/ LONG TransactionType )
{
    return SetOposProp( DEBUGPARAM("TransactionType") PIDXPpad_TransactionType, TransactionType, 3 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSPINPad::get_Track4Data( /*[out, retval]*/ BSTR* pTrack4Data )
{
    return GetOposProp( DEBUGPARAM("Track4Data") PIDXPpad_Track4Data, pTrack4Data, 5 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSPINPad::put_Track4Data( /*[in]*/ BSTR Track4Data )
{
    return SetOposProp( DEBUGPARAM("Track4Data") PIDXPpad_Track4Data, Track4Data, 5 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSPINPad::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSPINPad::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSPINPad::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSPINPad::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSPINPad::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_PINPad.log");
...
#define OPOSCCOCLASS COPOSPINPad
#define RCSTRACENAME "OposCCO_PINPad"
...
void COPOSPINPad::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSPINPad::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSPINPad::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSPINPad::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
...
//              123     => "0.0123"
//              -1      => "-0.0001"
LPCTSTR COPOSPINPad::FormatCurrency( CY cyCurrency )
{
