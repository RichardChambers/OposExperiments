...
TCHAR g_WindowName[] = _T("HW_OPOSRFIDScanner");

// Control Object description and version.
char g_ControlDescription[] = "OPOS RFIDScanner Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSRFIDScanner::s_nInstances = 0;
...
// Release 1.12 methods
    ...
    "DisableTag",
        #define nDIDisableTag 19
    "FirstTag",
        #define nDIFirstTag 20
    "LockTag",
        #define nDILockTag 21
    "NextTag",
        #define nDINextTag 22
    "PreviousTag",
        #define nDIPreviousTag 23
    "ReadTags",
        #define nDIReadTags 24
    "StartReadTags",
        #define nDIStartReadTags 25
    "StopReadTags",
        #define nDIStopReadTags 26
    "WriteTagData",
        #define nDIWriteTagData 27
    "WriteTagID",
        #define nDIWriteTagID 28
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS RFIDScanner.
//===========================================================================
...
COPOSRFIDScanner::COPOSRFIDScanner()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSRFIDScanner >(this) )
{
}

//===========================================================================

HRESULT COPOSRFIDScanner::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSRFIDScanner::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSRFIDScanner::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSRFIDSCANNER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSRFIDScanner::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSRFIDScanner::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSRFIDScanner::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSRFIDScanner::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSRFIDScanner::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_RFID );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_RFID), hRC );
...
STDMETHODIMP COPOSRFIDScanner::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSRFIDScanner::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSRFIDScanner::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSRFIDScanner::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSRFIDScanner::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSRFIDScanner::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSRFIDScanner::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSRFIDScanner::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSRFIDScanner::ResetStatistics( 
...
STDMETHODIMP COPOSRFIDScanner::RetrieveStatistics( 
...
STDMETHODIMP COPOSRFIDScanner::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSRFIDScanner::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSRFIDScanner::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSRFIDScanner::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSRFIDScanner::DisableTag( 
    /*[in]*/ BSTR TagID, 
    /*[in]*/ LONG Timeout, 
    /*[in]*/ BSTR Password, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[3];
    HRESULT hRC = S_OK;
    Vars[2].SetBSTR( TagID, hRC );
    Vars[1].SetLONG( Timeout );
    Vars[0].SetBSTR( Password, hRC );
    return DoInvoke( DEBUGPARAM("DisableTag") hRC, Vars, 3, nDIDisableTag, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::FirstTag( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("FirstTag") S_OK, NULL, 0, nDIFirstTag, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::LockTag( 
    /*[in]*/ BSTR TagID, 
    /*[in]*/ LONG Timeout, 
    /*[in]*/ BSTR Password, 
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[1].SetLONG( Timeout );
    Vars[0].SetBSTR( Password, hRC );
    return DoInvoke( DEBUGPARAM("LockTag") hRC, Vars, 3, nDILockTag, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::NextTag( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("NextTag") S_OK, NULL, 0, nDINextTag, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::PreviousTag( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("PreviousTag") S_OK, NULL, 0, nDIPreviousTag, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::ReadTags( 
    /*[in]*/ LONG Cmd, 
    /*[in]*/ BSTR FilterID, 
    /*[in]*/ BSTR Filtermask, 
    /*[in]*/ LONG Start, 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    HRESULT hRC = S_OK;
    Vars[6].SetLONG( Cmd );
    Vars[5].SetBSTR( FilterID, hRC );
    Vars[4].SetBSTR( Filtermask, hRC );
    Vars[3].SetLONG( Start );
    Vars[2].SetLONG( Length );
    Vars[1].SetLONG( Timeout );
    Vars[0].SetBSTR( Password, hRC );
    return DoInvoke( DEBUGPARAM("ReadTags") hRC, Vars, 7, nDIReadTags, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::StartReadTags( 
    /*[in]*/ LONG Cmd, 
    /*[in]*/ BSTR FilterID, 
    /*[in]*/ BSTR Filtermask, 
    /*[in]*/ LONG Start, 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    HRESULT hRC = S_OK;
    Vars[5].SetLONG( Cmd );
    Vars[4].SetBSTR( FilterID, hRC );
    Vars[3].SetBSTR( Filtermask, hRC );
    Vars[2].SetLONG( Start );
    Vars[1].SetLONG( Length );
    Vars[0].SetBSTR( Password, hRC );
    return DoInvoke( DEBUGPARAM("StartReadTags") hRC, Vars, 6, nDIStartReadTags, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::StopReadTags( 
    /*[in]*/ BSTR Password, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( Password, hRC );
    return DoInvoke( DEBUGPARAM("StopReadTags") hRC, &Var, 1, nDIStopReadTags, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::WriteTagData( 
    /*[in]*/ BSTR TagID, 
    /*[in]*/ BSTR Userdata, 
    /*[in]*/ LONG Start, 
    /*[in]*/ LONG Timeout, 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[5];
    HRESULT hRC = S_OK;
    Vars[4].SetBSTR( TagID, hRC );
    Vars[3].SetBSTR( Userdata, hRC );
    Vars[2].SetLONG( Start );
    Vars[1].SetLONG( Timeout );
    Vars[0].SetBSTR( Password, hRC );
    return DoInvoke( DEBUGPARAM("WriteTagData") hRC, Vars, 5, nDIWriteTagData, pRC );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::WriteTagID( 
    /*[in]*/ BSTR SourceID, 
    /*[in]*/ BSTR DestID, 
    /*[in]*/ LONG Timeout, 
    /*[in]*/ BSTR Password, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[4];
    HRESULT hRC = S_OK;
    Vars[3].SetBSTR( SourceID, hRC );
    Vars[2].SetBSTR( DestID, hRC );
    Vars[1].SetLONG( Timeout );
    Vars[0].SetBSTR( Password, hRC );
    return DoInvoke( DEBUGPARAM("WriteTagID") hRC, Vars, 4, nDIWriteTagID, pRC );
}
...
STDMETHODIMP COPOSRFIDScanner::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSRFIDScanner::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSRFIDScanner::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSRFIDScanner::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSRFIDScanner::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSRFIDScanner::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSRFIDScanner::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSRFIDScanner::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSRFIDScanner::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSRFIDScanner::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSRFIDScanner::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSRFIDScanner::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSRFIDScanner::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSRFIDScanner::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSRFIDScanner::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSRFIDScanner::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSRFIDScanner::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSRFIDScanner::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSRFIDScanner::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSRFIDScanner::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
...
STDMETHODIMP COPOSRFIDScanner::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSRFIDScanner::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSRFIDScanner::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSRFIDScanner::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSRFIDScanner::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSRFIDScanner::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSRFIDScanner::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSRFIDScanner::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSRFIDScanner::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSRFIDScanner::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSRFIDScanner::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSRFIDScanner::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSRFIDScanner::get_CapContinuousRead( /*[out, retval]*/ VARIANT_BOOL* pCapContinuousRead )
{
    return GetOposProp( DEBUGPARAM("CapContinuousRead") PIDXRfid_CapContinuousRead, pCapContinuousRead, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_CapDisableTag( /*[out, retval]*/ VARIANT_BOOL* pCapDisableTag )
{
    return GetOposProp( DEBUGPARAM("CapDisableTag") PIDXRfid_CapDisableTag, pCapDisableTag, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_CapLockTag( /*[out, retval]*/ VARIANT_BOOL* pCapLockTag )
{
    return GetOposProp( DEBUGPARAM("CapLockTag") PIDXRfid_CapLockTag, pCapLockTag, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_CapMultipleProtocols( /*[out, retval]*/ LONG* pCapMultipleProtocols )
{
    return GetOposProp( DEBUGPARAM("CapMultipleProtocols") PIDXRfid_CapMultipleProtocols, pCapMultipleProtocols, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_CapReadTimer( /*[out, retval]*/ VARIANT_BOOL* pCapReadTimer )
{
    return GetOposProp( DEBUGPARAM("CapReadTimer") PIDXRfid_CapReadTimer, pCapReadTimer, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_CapWriteTag( /*[out, retval]*/ LONG* pCapWriteTag )
{
    return GetOposProp( DEBUGPARAM("CapWriteTag") PIDXRfid_CapWriteTag, pCapWriteTag, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_ContinuousReadMode( /*[out, retval]*/ VARIANT_BOOL* pContinuousReadMode )
{
    return GetOposProp( DEBUGPARAM("ContinuousReadMode") PIDXRfid_ContinuousReadMode, pContinuousReadMode, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_CurrentTagID( /*[out, retval]*/ BSTR* pCurrentTagID )
{
    return GetOposProp( DEBUGPARAM("CurrentTagID") PIDXRfid_CurrentTagID, pCurrentTagID, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_CurrentTagProtocol( /*[out, retval]*/ LONG* pCurrentTagProtocol )
{
    return GetOposProp( DEBUGPARAM("CurrentTagProtocol") PIDXRfid_CurrentTagProtocol, pCurrentTagProtocol, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_CurrentTagUserData( /*[out, retval]*/ BSTR* pCurrentTagUserData )
{
    return GetOposProp( DEBUGPARAM("CurrentTagUserData") PIDXRfid_CurrentTagUserData, pCurrentTagUserData, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_ProtocolMask( /*[out, retval]*/ LONG* pProtocolMask )
{
    return GetOposProp( DEBUGPARAM("ProtocolMask") PIDXRfid_ProtocolMask, pProtocolMask, 12 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSRFIDScanner::put_ProtocolMask( /*[in]*/ LONG ProtocolMask )
{
    return SetOposProp( DEBUGPARAM("ProtocolMask") PIDXRfid_ProtocolMask, ProtocolMask, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_ReadTimerInterval( /*[out, retval]*/ LONG* pReadTimerInterval )
{
    return GetOposProp( DEBUGPARAM("ReadTimerInterval") PIDXRfid_ReadTimerInterval, pReadTimerInterval, 12 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSRFIDScanner::put_ReadTimerInterval( /*[in]*/ LONG ReadTimerInterval )
{
    return SetOposProp( DEBUGPARAM("ReadTimerInterval") PIDXRfid_ReadTimerInterval, ReadTimerInterval, 12 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSRFIDScanner::get_TagCount( /*[out, retval]*/ LONG* pTagCount )
{
    return GetOposProp( DEBUGPARAM("TagCount") PIDXRfid_TagCount, pTagCount, 12 /*MinorVersion*/ );
}
...
void COPOSRFIDScanner::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_RFIDScanner.log");
...
#define OPOSCCOCLASS COPOSRFIDScanner
#define RCSTRACENAME "OposCCO_RFIDScanner"
...
void COPOSRFIDScanner::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSRFIDScanner::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSRFIDScanner::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSRFIDScanner::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
