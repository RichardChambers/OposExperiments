/****************************************************************************
**
** RFIDScannerEvent.h -- OPOS event firing support.
**
**    This file is included into the RFIDScanner Control Object's main
...
#ifndef __RFIDSCANNEREVENT_H__
#define __RFIDSCANNEREVENT_H__
...
/////////////////////////////////////////////////////////////////////////////
    ...
    STDMETHOD( SOData )(long Status)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_DataEvent( Status );
        else
...
//===========================================================================
    ...
    STDMETHOD( SODirectIO )(long EventNumber, long* pData, BSTR* pString)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_DirectIOEvent( EventNumber, pData, pString );
        else
        {
...
//===========================================================================
                ...
                long ErrorLocus, long* pErrorResponse)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_ErrorEvent( ResultCode, ResultCodeExtended,
...
//===========================================================================
    ...
    STDMETHOD( SOOutputComplete )(long OutputID)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_OutputCompleteEvent( OutputID );
        else
...
//===========================================================================
    ...
    STDMETHOD( SOStatusUpdate)(long Data)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_StatusUpdateEvent( Data );
        else
...
/////////////////////////////////////////////////////////////////////////////
    ...
    {
        COPOSRFIDScanner* pThis;

        // On window creation, save our window instance into user window space.
        if ( uMsg == WM_CREATE )
        {
            pThis = (COPOSRFIDScanner*) ((LPCREATESTRUCT) lParam)->lpCreateParams;
        ...
        {
            pThis = (COPOSRFIDScanner*) ::GetWindowLong( hwnd, 0 );
            if ( pThis != 0 &&
        ...
        case WMU_DATA_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_DataEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
        ...
        case WMU_DIRECT_IO_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_DirectIOEvent(
        ...
        case WMU_ERROR_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_ErrorEvent (
        ...
        case WMU_OUTPUT_COMPLETE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_OutputCompleteEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
        ...
        case WMU_STATUS_UPDATE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSRFIDScanner >::Fire_StatusUpdateEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
...
#endif //__RFIDSCANNEREVENT_H__

// end RFIDScannerEvent.h
