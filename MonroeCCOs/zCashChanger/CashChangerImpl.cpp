...
#include "CashChanger.h"

// Include this control's header.
#include "CashChangerImpl.h"
...
TCHAR g_WindowName[] = _T("HW_OPOSCashChanger");

// Control Object description and version.
char g_ControlDescription[] = "OPOS CashChanger Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSCashChanger::s_nInstances = 0;
...
// Release 1.2 methods
    ...
    "DispenseCash",
        #define nDIDispenseCash 11
    "DispenseChange",
        #define nDIDispenseChange 12
    "ReadCashCounts",
        #define nDIReadCashCounts 13
// Release 1.3 methods
// Release 1.4 methods
// Release 1.5 methods
    "ClearInput",
        #define nDIClearInput 14
    "BeginDeposit",
        #define nDIBeginDeposit 15
    "EndDeposit",
        #define nDIEndDeposit 16
    "FixDeposit",
        #define nDIFixDeposit 17
    "PauseDeposit",
        #define nDIPauseDeposit 18
// Release 1.6 methods
// Release 1.7 methods
// Release 1.8 methods
    "ResetStatistics",
        #define nDIResetStatistics 19
    "RetrieveStatistics",
        #define nDIRetrieveStatistics 20
    "UpdateStatistics",
        #define nDIUpdateStatistics 21
// Release 1.9 methods
    "CompareFirmwareVersion",
        #define nDICompareFirmwareVersion 22
    "UpdateFirmware",
        #define nDIUpdateFirmware 23
// Release 1.10 methods
// Release 1.11 methods
    "AdjustCashCounts",
        #define nDIAdjustCashCounts 24
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS CashChanger.
//===========================================================================
...
const int MinorReleaseInitial = 2;
...
COPOSCashChanger::COPOSCashChanger()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSCashChanger >(this) )
{
}

//===========================================================================

HRESULT COPOSCashChanger::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSCashChanger::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSCashChanger::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSCASHCHANGER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSCashChanger::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCashChanger::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCashChanger::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSCashChanger::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSCashChanger::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_CHAN );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_CHAN), hRC );
...
STDMETHODIMP COPOSCashChanger::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCashChanger::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCashChanger::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCashChanger::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSCashChanger::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCashChanger::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSCashChanger::DispenseCash( 
    /*[in]*/ BSTR CashCounts, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( CashCounts, hRC );
    return DoInvoke( DEBUGPARAM("DispenseCash") hRC, &Var, 1, nDIDispenseCash, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::DispenseChange( 
    /*[in]*/ LONG Amount, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Amount );
    return DoInvoke( DEBUGPARAM("DispenseChange") S_OK, &Var, 1, nDIDispenseChange, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::ReadCashCounts( 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR_OutPtr( pCashCounts, hRC );
    Vars[0].SetVARIANT_BOOL_Ptr( pDiscrepancy, hRC );
    return DoInvoke( DEBUGPARAM("ReadCashCounts") hRC, Vars, 2, nDIReadCashCounts, pRC );
}
...
STDMETHODIMP COPOSCashChanger::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSCashChanger::BeginDeposit( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("BeginDeposit") S_OK, NULL, 0, nDIBeginDeposit, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::EndDeposit( 
    /*[in]*/ LONG Success, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Success );
    return DoInvoke( DEBUGPARAM("EndDeposit") S_OK, &Var, 1, nDIEndDeposit, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::FixDeposit( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("FixDeposit") S_OK, NULL, 0, nDIFixDeposit, pRC );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::PauseDeposit( 
    /*[in]*/ LONG Control, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( Control );
    return DoInvoke( DEBUGPARAM("PauseDeposit") S_OK, &Var, 1, nDIPauseDeposit, pRC );
}
...
STDMETHODIMP COPOSCashChanger::ResetStatistics( 
...
STDMETHODIMP COPOSCashChanger::RetrieveStatistics( 
...
STDMETHODIMP COPOSCashChanger::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCashChanger::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSCashChanger::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCashChanger::AdjustCashCounts( 
    /*[in]*/ BSTR CashCounts, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( CashCounts, hRC );
    return DoInvoke( DEBUGPARAM("AdjustCashCounts") hRC, &Var, 1, nDIAdjustCashCounts, pRC );
}
...
STDMETHODIMP COPOSCashChanger::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSCashChanger::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSCashChanger::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSCashChanger::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSCashChanger::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSCashChanger::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSCashChanger::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSCashChanger::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSCashChanger::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSCashChanger::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
    return GetOposProp( DEBUGPARAM("CheckHealthText") PIDX_CheckHealthText, pCheckHealthText, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
    return GetOposProp( DEBUGPARAM("Claimed") PIDX_Claimed, pClaimed, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
    return GetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, pDeviceEnabled, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCashChanger::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
    return SetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, DeviceEnabled, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
    return GetOposProp( DEBUGPARAM("ResultCodeExtended") PIDX_ResultCodeExtended, pResultCodeExtended, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectDescription") PIDX_ServiceObjectDescription, pServiceObjectDescription, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectVersion") PIDX_ServiceObjectVersion, pServiceObjectVersion, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
    return GetOposProp( DEBUGPARAM("DeviceDescription") PIDX_DeviceDescription, pDeviceDescription, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
    return GetOposProp( DEBUGPARAM("DeviceName") PIDX_DeviceName, pDeviceName, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_AsyncMode( /*[out, retval]*/ VARIANT_BOOL* pAsyncMode )
{
    return GetOposProp( DEBUGPARAM("AsyncMode") PIDXChan_AsyncMode, pAsyncMode, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCashChanger::put_AsyncMode( /*[in]*/ VARIANT_BOOL AsyncMode )
{
    return SetOposProp( DEBUGPARAM("AsyncMode") PIDXChan_AsyncMode, AsyncMode, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_AsyncResultCode( /*[out, retval]*/ LONG* pAsyncResultCode )
{
    return GetOposProp( DEBUGPARAM("AsyncResultCode") PIDXChan_AsyncResultCode, pAsyncResultCode, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_AsyncResultCodeExtended( /*[out, retval]*/ LONG* pAsyncResultCodeExtended )
{
    return GetOposProp( DEBUGPARAM("AsyncResultCodeExtended") PIDXChan_AsyncResultCodeExtended, pAsyncResultCodeExtended, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapDiscrepancy( /*[out, retval]*/ VARIANT_BOOL* pCapDiscrepancy )
{
    return GetOposProp( DEBUGPARAM("CapDiscrepancy") PIDXChan_CapDiscrepancy, pCapDiscrepancy, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapEmptySensor( /*[out, retval]*/ VARIANT_BOOL* pCapEmptySensor )
{
    return GetOposProp( DEBUGPARAM("CapEmptySensor") PIDXChan_CapEmptySensor, pCapEmptySensor, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapFullSensor( /*[out, retval]*/ VARIANT_BOOL* pCapFullSensor )
{
    return GetOposProp( DEBUGPARAM("CapFullSensor") PIDXChan_CapFullSensor, pCapFullSensor, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapNearEmptySensor( /*[out, retval]*/ VARIANT_BOOL* pCapNearEmptySensor )
{
    return GetOposProp( DEBUGPARAM("CapNearEmptySensor") PIDXChan_CapNearEmptySensor, pCapNearEmptySensor, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapNearFullSensor( /*[out, retval]*/ VARIANT_BOOL* pCapNearFullSensor )
{
    return GetOposProp( DEBUGPARAM("CapNearFullSensor") PIDXChan_CapNearFullSensor, pCapNearFullSensor, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CurrencyCashList( /*[out, retval]*/ BSTR* pCurrencyCashList )
{
    return GetOposProp( DEBUGPARAM("CurrencyCashList") PIDXChan_CurrencyCashList, pCurrencyCashList, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CurrencyCode( /*[out, retval]*/ BSTR* pCurrencyCode )
{
    return GetOposProp( DEBUGPARAM("CurrencyCode") PIDXChan_CurrencyCode, pCurrencyCode, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCashChanger::put_CurrencyCode( /*[in]*/ BSTR CurrencyCode )
{
    return SetOposProp( DEBUGPARAM("CurrencyCode") PIDXChan_CurrencyCode, CurrencyCode, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CurrencyCodeList( /*[out, retval]*/ BSTR* pCurrencyCodeList )
{
    return GetOposProp( DEBUGPARAM("CurrencyCodeList") PIDXChan_CurrencyCodeList, pCurrencyCodeList, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CurrentExit( /*[out, retval]*/ LONG* pCurrentExit )
{
    return GetOposProp( DEBUGPARAM("CurrentExit") PIDXChan_CurrentExit, pCurrentExit, 2 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCashChanger::put_CurrentExit( /*[in]*/ LONG CurrentExit )
{
    return SetOposProp( DEBUGPARAM("CurrentExit") PIDXChan_CurrentExit, CurrentExit, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DeviceExits( /*[out, retval]*/ LONG* pDeviceExits )
{
    return GetOposProp( DEBUGPARAM("DeviceExits") PIDXChan_DeviceExits, pDeviceExits, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DeviceStatus( /*[out, retval]*/ LONG* pDeviceStatus )
{
    return GetOposProp( DEBUGPARAM("DeviceStatus") PIDXChan_DeviceStatus, pDeviceStatus, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_ExitCashList( /*[out, retval]*/ BSTR* pExitCashList )
{
    return GetOposProp( DEBUGPARAM("ExitCashList") PIDXChan_ExitCashList, pExitCashList, 2 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_FullStatus( /*[out, retval]*/ LONG* pFullStatus )
{
    return GetOposProp( DEBUGPARAM("FullStatus") PIDXChan_FullStatus, pFullStatus, 2 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSCashChanger::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSCashChanger::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSCashChanger::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSCashChanger::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSCashChanger::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSCashChanger::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSCashChanger::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSCashChanger::get_CapDeposit( /*[out, retval]*/ VARIANT_BOOL* pCapDeposit )
{
    return GetOposProp( DEBUGPARAM("CapDeposit") PIDXChan_CapDeposit, pCapDeposit, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapDepositDataEvent( /*[out, retval]*/ VARIANT_BOOL* pCapDepositDataEvent )
{
    return GetOposProp( DEBUGPARAM("CapDepositDataEvent") PIDXChan_CapDepositDataEvent, pCapDepositDataEvent, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapPauseDeposit( /*[out, retval]*/ VARIANT_BOOL* pCapPauseDeposit )
{
    return GetOposProp( DEBUGPARAM("CapPauseDeposit") PIDXChan_CapPauseDeposit, pCapPauseDeposit, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapRepayDeposit( /*[out, retval]*/ VARIANT_BOOL* pCapRepayDeposit )
{
    return GetOposProp( DEBUGPARAM("CapRepayDeposit") PIDXChan_CapRepayDeposit, pCapRepayDeposit, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DepositAmount( /*[out, retval]*/ LONG* pDepositAmount )
{
    return GetOposProp( DEBUGPARAM("DepositAmount") PIDXChan_DepositAmount, pDepositAmount, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DepositCashList( /*[out, retval]*/ BSTR* pDepositCashList )
{
    return GetOposProp( DEBUGPARAM("DepositCashList") PIDXChan_DepositCashList, pDepositCashList, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DepositCodeList( /*[out, retval]*/ BSTR* pDepositCodeList )
{
    return GetOposProp( DEBUGPARAM("DepositCodeList") PIDXChan_DepositCodeList, pDepositCodeList, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DepositCounts( /*[out, retval]*/ BSTR* pDepositCounts )
{
    return GetOposProp( DEBUGPARAM("DepositCounts") PIDXChan_DepositCounts, pDepositCounts, 5 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_DepositStatus( /*[out, retval]*/ LONG* pDepositStatus )
{
    return GetOposProp( DEBUGPARAM("DepositStatus") PIDXChan_DepositStatus, pDepositStatus, 5 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSCashChanger::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSCashChanger::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSCashChanger::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSCashChanger::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSCashChanger::get_CapJamSensor( /*[out, retval]*/ VARIANT_BOOL* pCapJamSensor )
{
    return GetOposProp( DEBUGPARAM("CapJamSensor") PIDXChan_CapJamSensor, pCapJamSensor, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CapRealTimeData( /*[out, retval]*/ VARIANT_BOOL* pCapRealTimeData )
{
    return GetOposProp( DEBUGPARAM("CapRealTimeData") PIDXChan_CapRealTimeData, pCapRealTimeData, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_CurrentService( /*[out, retval]*/ LONG* pCurrentService )
{
    return GetOposProp( DEBUGPARAM("CurrentService") PIDXChan_CurrentService, pCurrentService, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCashChanger::put_CurrentService( /*[in]*/ LONG CurrentService )
{
    return SetOposProp( DEBUGPARAM("CurrentService") PIDXChan_CurrentService, CurrentService, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_RealTimeDataEnabled( /*[out, retval]*/ VARIANT_BOOL* pRealTimeDataEnabled )
{
    return GetOposProp( DEBUGPARAM("RealTimeDataEnabled") PIDXChan_RealTimeDataEnabled, pRealTimeDataEnabled, 11 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSCashChanger::put_RealTimeDataEnabled( /*[in]*/ VARIANT_BOOL RealTimeDataEnabled )
{
    return SetOposProp( DEBUGPARAM("RealTimeDataEnabled") PIDXChan_RealTimeDataEnabled, RealTimeDataEnabled, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_ServiceCount( /*[out, retval]*/ LONG* pServiceCount )
{
    return GetOposProp( DEBUGPARAM("ServiceCount") PIDXChan_ServiceCount, pServiceCount, 11 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCashChanger::get_ServiceIndex( /*[out, retval]*/ LONG* pServiceIndex )
{
    return GetOposProp( DEBUGPARAM("ServiceIndex") PIDXChan_ServiceIndex, pServiceIndex, 11 /*MinorVersion*/ );
}
...
void COPOSCashChanger::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_CashChanger.log");
...
#define OPOSCCOCLASS COPOSCashChanger
#define RCSTRACENAME "OposCCO_CashChanger"
...
void COPOSCashChanger::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSCashChanger::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSCashChanger::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSCashChanger::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
