/****************************************************************************
**
** MICRImpl.h -- Main control header file.
**
...
#ifndef __MICRIMPL_H__
#define __MICRIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_MICR.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_MICR.log")
...
// The class...
class ATL_NO_VTABLE COPOSMICR :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSMICR, &IID_IOPOSMICR, &LIBID_OposMICR_CCO>,
    public CComControl<COPOSMICR>,
    public IPersistStreamInitImpl<COPOSMICR>,
    public IOleControlImpl<COPOSMICR>,
    public IOleObjectImpl<COPOSMICR>,
    public IOleInPlaceActiveObjectImpl<COPOSMICR>,
    public IViewObjectExImpl<COPOSMICR>,
    public IOleInPlaceObjectWindowlessImpl<COPOSMICR>,
    public IConnectionPointContainerImpl<COPOSMICR>,
    public IPersistStorageImpl<COPOSMICR>,
    public ISpecifyPropertyPagesImpl<COPOSMICR>,
    public IQuickActivateImpl<COPOSMICR>,
    public IDataObjectImpl<COPOSMICR>,
    public IProvideClassInfo2Impl<&CLSID_OPOSMICR, &DIID__IOPOSMICREvents, &LIBID_OposMICR_CCO>,
    public IObjectSafetyImpl<COPOSMICR, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSMICR>,
    public CComCoClass<COPOSMICR, &CLSID_OPOSMICR>,
    public CProxy_IOPOSEvents< COPOSMICR >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSMICR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSMICR)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSMICR)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMICR, IOPOSMICR)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMICR_1_10, IOPOSMICR)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMICR_1_9, IOPOSMICR)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMICR_1_8, IOPOSMICR)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSMICR_1_5, IOPOSMICR)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSMICR)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSMICR)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSMICREvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSMICR)
    CHAIN_MSG_MAP(CComControl<COPOSMICR>)
...
// Release 1.0
    ...
    STDMETHOD(get_Amount)( /*[out, retval]*/ BSTR* pAmount );
    STDMETHOD(get_BankNumber)( /*[out, retval]*/ BSTR* pBankNumber );
    STDMETHOD(get_CapValidationDevice)( /*[out, retval]*/ VARIANT_BOOL* pCapValidationDevice );
    STDMETHOD(get_CheckType)( /*[out, retval]*/ LONG* pCheckType );
    STDMETHOD(get_CountryCode)( /*[out, retval]*/ LONG* pCountryCode );
    STDMETHOD(get_EPC)( /*[out, retval]*/ BSTR* pEPC );
    STDMETHOD(get_RawData)( /*[out, retval]*/ BSTR* pRawData );
    STDMETHOD(get_SerialNumber)( /*[out, retval]*/ BSTR* pSerialNumber );
    STDMETHOD(get_TransitNumber)( /*[out, retval]*/ BSTR* pTransitNumber );
