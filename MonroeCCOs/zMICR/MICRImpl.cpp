/****************************************************************************
**
** MICRImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSMICR");

// Control Object description and version.
char g_ControlDescription[] = "OPOS MICR Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
// Release 1.0 methods
    ...
    "EndInsertion",
        #define nDIEndInsertion 14
    "EndRemoval",
        #define nDIEndRemoval 15
// Release 1.1 methods
// Release 1.2 methods
// Release 1.3 methods
// Release 1.4 methods
...
// Release 1.8 methods
    "ResetStatistics",
        #define nDIResetStatistics 16
    "RetrieveStatistics",
        #define nDIRetrieveStatistics 17
    "UpdateStatistics",
        #define nDIUpdateStatistics 18
// Release 1.9 methods
    "CompareFirmwareVersion",
        #define nDICompareFirmwareVersion 19
    "UpdateFirmware",
        #define nDIUpdateFirmware 20
// Release 1.10 methods
    "ClearInputProperties",
        #define nDIClearInputProperties 21
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS MICR.
//===========================================================================
...
COPOSMICR::COPOSMICR()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSMICR >(this) )
{
}

//===========================================================================

HRESULT COPOSMICR::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSMICR::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSMICR::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSMICR2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSMICR::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSMICR::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSMICR::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSMICR::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSMICR::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_MICR );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_MICR), hRC );
...
STDMETHODIMP COPOSMICR::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSMICR::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSMICR::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSMICR::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSMICR::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSMICR::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSMICR::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSMICR::BeginInsertion( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSMICR::BeginRemoval( 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSMICR::EndInsertion( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSMICR::EndRemoval( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSMICR::ResetStatistics( 
...
STDMETHODIMP COPOSMICR::RetrieveStatistics( 
...
STDMETHODIMP COPOSMICR::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSMICR::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSMICR::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSMICR::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSMICR::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSMICR::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSMICR::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSMICR::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSMICR::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSMICR::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSMICR::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSMICR::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSMICR::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSMICR::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSMICR::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSMICR::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSMICR::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSMICR::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSMICR::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSMICR::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSMICR::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSMICR::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSMICR::get_AccountNumber( /*[out, retval]*/ BSTR* pAccountNumber )
{
    return GetOposProp( DEBUGPARAM("AccountNumber") PIDXMicr_AccountNumber, pAccountNumber, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_Amount( /*[out, retval]*/ BSTR* pAmount )
{
    return GetOposProp( DEBUGPARAM("Amount") PIDXMicr_Amount, pAmount, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_BankNumber( /*[out, retval]*/ BSTR* pBankNumber )
{
    return GetOposProp( DEBUGPARAM("BankNumber") PIDXMicr_BankNumber, pBankNumber, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_CapValidationDevice( /*[out, retval]*/ VARIANT_BOOL* pCapValidationDevice )
{
    return GetOposProp( DEBUGPARAM("CapValidationDevice") PIDXMicr_CapValidationDevice, pCapValidationDevice, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_CheckType( /*[out, retval]*/ LONG* pCheckType )
{
    return GetOposProp( DEBUGPARAM("CheckType") PIDXMicr_CheckType, pCheckType, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_CountryCode( /*[out, retval]*/ LONG* pCountryCode )
{
    return GetOposProp( DEBUGPARAM("CountryCode") PIDXMicr_CountryCode, pCountryCode, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_EPC( /*[out, retval]*/ BSTR* pEPC )
{
    return GetOposProp( DEBUGPARAM("EPC") PIDXMicr_EPC, pEPC, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_RawData( /*[out, retval]*/ BSTR* pRawData )
{
    return GetOposProp( DEBUGPARAM("RawData") PIDXMicr_RawData, pRawData, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_SerialNumber( /*[out, retval]*/ BSTR* pSerialNumber )
{
    return GetOposProp( DEBUGPARAM("SerialNumber") PIDXMicr_SerialNumber, pSerialNumber, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSMICR::get_TransitNumber( /*[out, retval]*/ BSTR* pTransitNumber )
{
    return GetOposProp( DEBUGPARAM("TransitNumber") PIDXMicr_TransitNumber, pTransitNumber, 0 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSMICR::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSMICR::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSMICR::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSMICR::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSMICR::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSMICR::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSMICR::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSMICR::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSMICR::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSMICR::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSMICR::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSMICR::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSMICR::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSMICR::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_MICR.log");
...
#define OPOSCCOCLASS COPOSMICR
#define RCSTRACENAME "OposCCO_MICR"
...
void COPOSMICR::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSMICR::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSMICR::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSMICR::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
