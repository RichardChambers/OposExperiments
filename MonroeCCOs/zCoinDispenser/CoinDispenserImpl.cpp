...
TCHAR g_WindowName[] = _T("HW_OPOSCoinDispenser");

// Control Object description and version.
char g_ControlDescription[] = "OPOS CoinDispenser Control 1.14.001 [Public, by CRM/MCS]" IFDEBUG(" [With Tracing]");
...
int COPOSCoinDispenser::s_nInstances = 0;
...
//   for each release.
// Followed by the initial minor release of the OPOS CoinDispenser.
//===========================================================================
...
COPOSCoinDispenser::COPOSCoinDispenser()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSCoinDispenser >(this) )
{
}

//===========================================================================

HRESULT COPOSCoinDispenser::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSCoinDispenser::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSCoinDispenser::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSCOINDISPENSER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSCoinDispenser::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSCoinDispenser::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSCoinDispenser::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSCoinDispenser::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_COIN );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_COIN), hRC );
...
STDMETHODIMP COPOSCoinDispenser::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCoinDispenser::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCoinDispenser::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSCoinDispenser::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSCoinDispenser::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinDispenser::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSCoinDispenser::DispenseChange( 
    /*[in]*/ LONG Amount, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinDispenser::ResetStatistics( 
...
STDMETHODIMP COPOSCoinDispenser::RetrieveStatistics( 
...
STDMETHODIMP COPOSCoinDispenser::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinDispenser::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSCoinDispenser::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinDispenser::AdjustCashCounts( 
    /*[in]*/ BSTR CashCounts, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSCoinDispenser::ReadCashCounts( 
...
STDMETHODIMP COPOSCoinDispenser::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSCoinDispenser::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSCoinDispenser::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSCoinDispenser::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSCoinDispenser::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSCoinDispenser::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSCoinDispenser::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSCoinDispenser::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSCoinDispenser::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSCoinDispenser::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSCoinDispenser::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSCoinDispenser::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSCoinDispenser::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSCoinDispenser::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSCoinDispenser::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSCoinDispenser::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSCoinDispenser::get_CapEmptySensor( /*[out, retval]*/ VARIANT_BOOL* pCapEmptySensor )
{
    return GetOposProp( DEBUGPARAM("CapEmptySensor") PIDXCoin_CapEmptySensor, pCapEmptySensor, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinDispenser::get_CapJamSensor( /*[out, retval]*/ VARIANT_BOOL* pCapJamSensor )
{
    return GetOposProp( DEBUGPARAM("CapJamSensor") PIDXCoin_CapJamSensor, pCapJamSensor, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinDispenser::get_CapNearEmptySensor( /*[out, retval]*/ VARIANT_BOOL* pCapNearEmptySensor )
{
    return GetOposProp( DEBUGPARAM("CapNearEmptySensor") PIDXCoin_CapNearEmptySensor, pCapNearEmptySensor, 0 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSCoinDispenser::get_DispenserStatus( /*[out, retval]*/ LONG* pDispenserStatus )
{
    return GetOposProp( DEBUGPARAM("DispenserStatus") PIDXCoin_DispenserStatus, pDispenserStatus, 0 /*MinorVersion*/ );
}
...
STDMETHODIMP COPOSCoinDispenser::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSCoinDispenser::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSCoinDispenser::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSCoinDispenser::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSCoinDispenser::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSCoinDispenser::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSCoinDispenser::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSCoinDispenser::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSCoinDispenser::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSCoinDispenser::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSCoinDispenser::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_CoinDispenser.log");
...
#define OPOSCCOCLASS COPOSCoinDispenser
#define RCSTRACENAME "OposCCO_CoinDispenser"
...
void COPOSCoinDispenser::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSCoinDispenser::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSCoinDispenser::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSCoinDispenser::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
