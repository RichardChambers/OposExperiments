/****************************************************************************
**
** CoinDispenserImpl.h -- Main control header file.
**
...
#ifndef __COINDISPENSERIMPL_H__
#define __COINDISPENSERIMPL_H__
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_CoinDispenser.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_CoinDispenser.log")
...
// The class...
class ATL_NO_VTABLE COPOSCoinDispenser :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSCoinDispenser, &IID_IOPOSCoinDispenser, &LIBID_OposCoinDispenser_CCO>,
    public CComControl<COPOSCoinDispenser>,
    public IPersistStreamInitImpl<COPOSCoinDispenser>,
    public IOleControlImpl<COPOSCoinDispenser>,
    public IOleObjectImpl<COPOSCoinDispenser>,
    public IOleInPlaceActiveObjectImpl<COPOSCoinDispenser>,
    public IViewObjectExImpl<COPOSCoinDispenser>,
    public IOleInPlaceObjectWindowlessImpl<COPOSCoinDispenser>,
    public IConnectionPointContainerImpl<COPOSCoinDispenser>,
    public IPersistStorageImpl<COPOSCoinDispenser>,
    public ISpecifyPropertyPagesImpl<COPOSCoinDispenser>,
    public IQuickActivateImpl<COPOSCoinDispenser>,
    public IDataObjectImpl<COPOSCoinDispenser>,
    public IProvideClassInfo2Impl<&CLSID_OPOSCoinDispenser, &DIID__IOPOSCoinDispenserEvents, &LIBID_OposCoinDispenser_CCO>,
    public IObjectSafetyImpl<COPOSCoinDispenser, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSCoinDispenser>,
    public CComCoClass<COPOSCoinDispenser, &CLSID_OPOSCoinDispenser>,
    public CProxy_IOPOSEvents< COPOSCoinDispenser >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSCOINDISPENSER)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSCoinDispenser)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSCoinDispenser)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCoinDispenser, IOPOSCoinDispenser)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCoinDispenser_1_11, IOPOSCoinDispenser)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCoinDispenser_1_9, IOPOSCoinDispenser)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCoinDispenser_1_8, IOPOSCoinDispenser)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSCoinDispenser_1_5, IOPOSCoinDispenser)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSCoinDispenser)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSCoinDispenser)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSCoinDispenserEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSCoinDispenser)
    CHAIN_MSG_MAP(CComControl<COPOSCoinDispenser>)
...
#endif //__COINDISPENSERIMPL_H__

// End CoinDispenserImpl.h
